...
import com.clear_street.api.client.okhttp.OkHttpClient
import com.clear_street.api.core.RequestOptions
import com.clear_street.api.core.Sleeper
import com.clear_street.api.errors.ClearStreetRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw ClearStreetRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            ClearStreetRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
