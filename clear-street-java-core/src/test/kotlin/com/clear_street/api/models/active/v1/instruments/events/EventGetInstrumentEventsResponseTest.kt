...
internal class EventGetInstrumentEventsResponseTest {

    @Test
    fun create() {
        val eventGetInstrumentEventsResponse =
            EventGetInstrumentEventsResponse.builder()
                .metadata(
                ...
                .data(
                    InstrumentEventsData.builder()
                        ...
                        .securityId("AAPL")
                        .securityIdSource(SecurityIdSource.FMP)
                        .addSplit(
        ...
        assertThat(eventGetInstrumentEventsResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(eventGetInstrumentEventsResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(eventGetInstrumentEventsResponse.data())
            .isEqualTo(
                InstrumentEventsData.builder()
                    .addDividend(
                        InstrumentDividendEvent.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedEventGetInstrumentEventsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(eventGetInstrumentEventsResponse),
                jacksonTypeRef<EventGetInstrumentEventsResponse>(),
            )

        assertThat(roundtrippedEventGetInstrumentEventsResponse)
            .isEqualTo(eventGetInstrumentEventsResponse)
    }
}
