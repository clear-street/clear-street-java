...
internal class SavedScreenerGetScreenerByIdResponseTest {

    @Test
    fun create() {
        val savedScreenerGetScreenerByIdResponse =
            SavedScreenerGetScreenerByIdResponse.builder()
                .metadata(
        ...
        assertThat(savedScreenerGetScreenerByIdResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(savedScreenerGetScreenerByIdResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(savedScreenerGetScreenerByIdResponse.data())
            .isEqualTo(
                ScreenerEntry.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedSavedScreenerGetScreenerByIdResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(savedScreenerGetScreenerByIdResponse),
                jacksonTypeRef<SavedScreenerGetScreenerByIdResponse>(),
            )

        assertThat(roundtrippedSavedScreenerGetScreenerByIdResponse)
            .isEqualTo(savedScreenerGetScreenerByIdResponse)
    }
}
