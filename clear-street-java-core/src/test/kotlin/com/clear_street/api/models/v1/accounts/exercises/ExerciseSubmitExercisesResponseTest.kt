...
internal class ExerciseSubmitExercisesResponseTest {

    @Test
    fun create() {
        val exerciseSubmitExercisesResponse =
            ExerciseSubmitExercisesResponse.builder()
                .metadata(
        ...
        assertThat(exerciseSubmitExercisesResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(exerciseSubmitExercisesResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(exerciseSubmitExercisesResponse.data())
            .containsExactly(
                ExerciseInstruction.builder()
                    .id("0195f6d0-a1b2-7c3d-8e4f-5a6b7c8d9e02")
                    .accountId(122503L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedExerciseSubmitExercisesResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(exerciseSubmitExercisesResponse),
                jacksonTypeRef<ExerciseSubmitExercisesResponse>(),
            )

        assertThat(roundtrippedExerciseSubmitExercisesResponse)
            .isEqualTo(exerciseSubmitExercisesResponse)
    }
}
