...
internal class LocateCreateLocateRequestResponseTest {

    @Test
    fun create() {
        val locateCreateLocateRequestResponse =
            LocateCreateLocateRequestResponse.builder()
                .metadata(
        ...
        assertThat(locateCreateLocateRequestResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(locateCreateLocateRequestResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(locateCreateLocateRequestResponse.data())
            .containsExactly(
                LocateOrder.builder()
                    .locateOrderId("loc_2af0305ffa5b4c91ba4e7ab45e2d8e4e")
                    .locatedQuantity(1000L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedLocateCreateLocateRequestResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(locateCreateLocateRequestResponse),
                jacksonTypeRef<LocateCreateLocateRequestResponse>(),
            )

        assertThat(roundtrippedLocateCreateLocateRequestResponse)
            .isEqualTo(locateCreateLocateRequestResponse)
    }
}
