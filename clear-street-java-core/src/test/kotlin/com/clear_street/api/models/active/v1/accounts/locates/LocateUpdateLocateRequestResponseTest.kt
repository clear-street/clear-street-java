...
internal class LocateUpdateLocateRequestResponseTest {

    @Test
    fun create() {
        val locateUpdateLocateRequestResponse =
            LocateUpdateLocateRequestResponse.builder()
                .metadata(
        ...
        assertThat(locateUpdateLocateRequestResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(locateUpdateLocateRequestResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(locateUpdateLocateRequestResponse.data())
            .isEqualTo(
                LocateOrder.builder()
                    .locateOrderId("loc_2af0305ffa5b4c91ba4e7ab45e2d8e4e")
                    .locatedQuantity(1000L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedLocateUpdateLocateRequestResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(locateUpdateLocateRequestResponse),
                jacksonTypeRef<LocateUpdateLocateRequestResponse>(),
            )

        assertThat(roundtrippedLocateUpdateLocateRequestResponse)
            .isEqualTo(locateUpdateLocateRequestResponse)
    }
}
