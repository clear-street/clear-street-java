...
internal class InstructionGetPositionInstructionsResponseTest {

    @Test
    fun create() {
        val instructionGetPositionInstructionsResponse =
            InstructionGetPositionInstructionsResponse.builder()
                .metadata(
        ...
        assertThat(instructionGetPositionInstructionsResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(instructionGetPositionInstructionsResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(instructionGetPositionInstructionsResponse.data())
            .containsExactly(
                PositionInstruction.builder()
                    .id("0195f6d0-a1b2-7c3d-8e4f-5a6b7c8d9e02")
                    .accountId(122503L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedInstructionGetPositionInstructionsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(instructionGetPositionInstructionsResponse),
                jacksonTypeRef<InstructionGetPositionInstructionsResponse>(),
            )

        assertThat(roundtrippedInstructionGetPositionInstructionsResponse)
