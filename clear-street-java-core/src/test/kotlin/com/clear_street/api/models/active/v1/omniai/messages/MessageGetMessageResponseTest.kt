...
internal class MessageGetMessageResponseTest {

    @Test
    fun create() {
        val messageGetMessageResponse =
            MessageGetMessageResponse.builder()
                .metadata(
        ...
        assertThat(messageGetMessageResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(messageGetMessageResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(messageGetMessageResponse.data())
            .isEqualTo(
                Message.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .content(
    ...
    fun roundtrip() {
        ...
        val roundtrippedMessageGetMessageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(messageGetMessageResponse),
                jacksonTypeRef<MessageGetMessageResponse>(),
            )

        assertThat(roundtrippedMessageGetMessageResponse).isEqualTo(messageGetMessageResponse)
    }
}
