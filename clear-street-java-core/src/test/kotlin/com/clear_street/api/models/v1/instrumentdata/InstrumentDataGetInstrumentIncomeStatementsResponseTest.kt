...
internal class InstrumentDataGetInstrumentIncomeStatementsResponseTest {

    @Test
    fun create() {
        val instrumentDataGetInstrumentIncomeStatementsResponse =
            InstrumentDataGetInstrumentIncomeStatementsResponse.builder()
                .metadata(
        ...
        assertThat(instrumentDataGetInstrumentIncomeStatementsResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(instrumentDataGetInstrumentIncomeStatementsResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(instrumentDataGetInstrumentIncomeStatementsResponse.data())
            .containsExactly(
                InstrumentIncomeStatement.builder()
                    .acceptedDate(OffsetDateTime.parse("2025-05-02T14:30:00Z"))
                    .filingDate(LocalDate.parse("2025-05-01"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedInstrumentDataGetInstrumentIncomeStatementsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(instrumentDataGetInstrumentIncomeStatementsResponse),
                jacksonTypeRef<InstrumentDataGetInstrumentIncomeStatementsResponse>(),
            )

        assertThat(roundtrippedInstrumentDataGetInstrumentIncomeStatementsResponse)
            .isEqualTo(instrumentDataGetInstrumentIncomeStatementsResponse)
    }
}
