...
internal class OrderGetOrdersResponseTest {

    @Test
    fun create() {
        val orderGetOrdersResponse =
            OrderGetOrdersResponse.builder()
                .metadata(
        ...
        assertThat(orderGetOrdersResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(orderGetOrdersResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
    ...
    fun roundtrip() {
        ...
        val roundtrippedOrderGetOrdersResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(orderGetOrdersResponse),
                jacksonTypeRef<OrderGetOrdersResponse>(),
            )

        assertThat(roundtrippedOrderGetOrdersResponse).isEqualTo(orderGetOrdersResponse)
    }
}
