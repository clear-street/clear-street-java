...
internal class InstrumentDataGetInstrumentBalanceSheetStatementsResponseTest {

    @Test
    fun create() {
        val instrumentDataGetInstrumentBalanceSheetStatementsResponse =
            InstrumentDataGetInstrumentBalanceSheetStatementsResponse.builder()
                .metadata(
        ...
        assertThat(instrumentDataGetInstrumentBalanceSheetStatementsResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(instrumentDataGetInstrumentBalanceSheetStatementsResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(instrumentDataGetInstrumentBalanceSheetStatementsResponse.data())
            .containsExactly(
                InstrumentBalanceSheetStatement.builder()
                    .acceptedDate(OffsetDateTime.parse("2025-05-02T14:30:00Z"))
                    .filingDate(LocalDate.parse("2025-05-01"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedInstrumentDataGetInstrumentBalanceSheetStatementsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(
                    instrumentDataGetInstrumentBalanceSheetStatementsResponse
                ),
                jacksonTypeRef<InstrumentDataGetInstrumentBalanceSheetStatementsResponse>(),
            )

        assertThat(roundtrippedInstrumentDataGetInstrumentBalanceSheetStatementsResponse)
            .isEqualTo(instrumentDataGetInstrumentBalanceSheetStatementsResponse)
    }
}
