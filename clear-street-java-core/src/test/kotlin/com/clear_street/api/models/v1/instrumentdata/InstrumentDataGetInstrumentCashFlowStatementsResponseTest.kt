...
internal class InstrumentDataGetInstrumentCashFlowStatementsResponseTest {

    @Test
    fun create() {
        val instrumentDataGetInstrumentCashFlowStatementsResponse =
            InstrumentDataGetInstrumentCashFlowStatementsResponse.builder()
                .metadata(
        ...
        assertThat(instrumentDataGetInstrumentCashFlowStatementsResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(instrumentDataGetInstrumentCashFlowStatementsResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(instrumentDataGetInstrumentCashFlowStatementsResponse.data())
            .containsExactly(
                InstrumentCashFlowStatement.builder()
                    .acceptedDate(OffsetDateTime.parse("2025-05-02T14:30:00Z"))
                    .filingDate(LocalDate.parse("2025-05-01"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedInstrumentDataGetInstrumentCashFlowStatementsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(
                    instrumentDataGetInstrumentCashFlowStatementsResponse
                ),
                jacksonTypeRef<InstrumentDataGetInstrumentCashFlowStatementsResponse>(),
            )

        assertThat(roundtrippedInstrumentDataGetInstrumentCashFlowStatementsResponse)
            .isEqualTo(instrumentDataGetInstrumentCashFlowStatementsResponse)
    }
}
