...
internal class ExerciseGetExercisesResponseTest {

    @Test
    fun create() {
        val exerciseGetExercisesResponse =
            ExerciseGetExercisesResponse.builder()
                .metadata(
        ...
        assertThat(exerciseGetExercisesResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(exerciseGetExercisesResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(exerciseGetExercisesResponse.data())
            .containsExactly(
                ExerciseInstruction.builder()
                    .id("0195f6d0-a1b2-7c3d-8e4f-5a6b7c8d9e02")
                    .accountId(122503L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedExerciseGetExercisesResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(exerciseGetExercisesResponse),
                jacksonTypeRef<ExerciseGetExercisesResponse>(),
            )

        assertThat(roundtrippedExerciseGetExercisesResponse).isEqualTo(exerciseGetExercisesResponse)
    }
}
