...
internal class InstrumentEventEnvelopeTest {

    @Test
    fun create() {
        val instrumentEventEnvelope =
        ...
        assertThat(instrumentEventEnvelope.securityId()).isEqualTo("security_id")
        assertThat(instrumentEventEnvelope.securityIdSource()).isEqualTo(SecurityIdSource.CMS)
        assertThat(instrumentEventEnvelope.symbol()).isEqualTo("symbol")
        assertThat(instrumentEventEnvelope.type()).isEqualTo(AllEventsEventType.EARNINGS)
        assertThat(instrumentEventEnvelope.dividendEventData())
            .contains(
                InstrumentDividendEvent.builder()
                    .adjustedDividendAmount("0.88")
                    .exDate(LocalDate.parse("2025-08-15"))
        ...
        assertThat(instrumentEventEnvelope.earningsEventData())
            .contains(
                InstrumentEarnings.builder()
                    .date(LocalDate.parse("2025-07-25"))
                    .epsActual("1.35")
        ...
        assertThat(instrumentEventEnvelope.instrumentId())
            .contains("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        assertThat(instrumentEventEnvelope.ipoEventData())
            .contains(
                InstrumentEventIpoItem.builder()
                    .actions("actions")
                    .announcedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedInstrumentEventEnvelope =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(instrumentEventEnvelope),
                jacksonTypeRef<InstrumentEventEnvelope>(),
            )

        assertThat(roundtrippedInstrumentEventEnvelope).isEqualTo(instrumentEventEnvelope)
    }
}
