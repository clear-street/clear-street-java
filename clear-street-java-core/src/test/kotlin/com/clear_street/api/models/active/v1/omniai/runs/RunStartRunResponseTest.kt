...
internal class RunStartRunResponseTest {

    @Test
    fun create() {
        val runStartRunResponse =
            RunStartRunResponse.builder()
                .metadata(
        ...
        assertThat(runStartRunResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(runStartRunResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(runStartRunResponse.data())
            .isEqualTo(
                StartRunResponse.builder()
                    .run(
                        Run.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedRunStartRunResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(runStartRunResponse),
                jacksonTypeRef<RunStartRunResponse>(),
            )

        assertThat(roundtrippedRunStartRunResponse).isEqualTo(runStartRunResponse)
    }
}
