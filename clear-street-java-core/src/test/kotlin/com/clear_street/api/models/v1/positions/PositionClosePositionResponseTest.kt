...
internal class PositionClosePositionResponseTest {

    @Test
    fun create() {
        val positionClosePositionResponse =
            PositionClosePositionResponse.builder()
                .metadata(
        ...
        assertThat(positionClosePositionResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(positionClosePositionResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(positionClosePositionResponse.data())
            .containsExactly(
                Order.builder()
                    .id("0195f6c7-4f64-7e3c-8b0a-1d8e4f5e6a7b")
                    .accountId(19816L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedPositionClosePositionResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(positionClosePositionResponse),
                jacksonTypeRef<PositionClosePositionResponse>(),
            )

        assertThat(roundtrippedPositionClosePositionResponse)
            .isEqualTo(positionClosePositionResponse)
    }
}
