...
import com.clear_street.api.models.v1.orders.Order
import com.clear_street.api.models.v1.orders.OrderStatus
import com.clear_street.api.models.v1.orders.OrderType
import com.clear_street.api.models.v1.orders.QueueState
import com.clear_street.api.models.v1.orders.Side
import com.clear_street.api.models.v1.orders.TimeInForce
...
internal class PositionClosePositionsResponseTest {

    @Test
    fun create() {
        val positionClosePositionsResponse =
            PositionClosePositionsResponse.builder()
                .metadata(
        ...
        assertThat(positionClosePositionsResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(positionClosePositionsResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(positionClosePositionsResponse.data())
            .containsExactly(
                Order.builder()
                    .id("0195f6c7-4f64-7e3c-8b0a-1d8e4f5e6a7b")
                    .accountId(19816L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedPositionClosePositionsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(positionClosePositionsResponse),
                jacksonTypeRef<PositionClosePositionsResponse>(),
            )

        assertThat(roundtrippedPositionClosePositionsResponse)
            .isEqualTo(positionClosePositionsResponse)
    }
}
