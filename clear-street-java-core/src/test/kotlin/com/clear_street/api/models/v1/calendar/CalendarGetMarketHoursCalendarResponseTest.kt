...
internal class CalendarGetMarketHoursCalendarResponseTest {

    @Test
    fun create() {
        val calendarGetMarketHoursCalendarResponse =
            CalendarGetMarketHoursCalendarResponse.builder()
                .metadata(
        ...
        assertThat(calendarGetMarketHoursCalendarResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(calendarGetMarketHoursCalendarResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(calendarGetMarketHoursCalendarResponse.data())
            .containsExactly(
                MarketHoursDetail.builder()
                    .currentTime(OffsetDateTime.parse("2025-10-15T14:30:00-04:00"))
                    .date(LocalDate.parse("2025-10-15"))
    ...
    fun roundtrip() {
        ...
        val roundtrippedCalendarGetMarketHoursCalendarResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(calendarGetMarketHoursCalendarResponse),
                jacksonTypeRef<CalendarGetMarketHoursCalendarResponse>(),
            )

        assertThat(roundtrippedCalendarGetMarketHoursCalendarResponse)
            .isEqualTo(calendarGetMarketHoursCalendarResponse)
    }
}
