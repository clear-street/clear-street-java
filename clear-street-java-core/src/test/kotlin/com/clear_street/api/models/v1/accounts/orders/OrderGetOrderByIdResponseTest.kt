...
internal class OrderGetOrderByIdResponseTest {

    @Test
    fun create() {
        val orderGetOrderByIdResponse =
            OrderGetOrderByIdResponse.builder()
                .metadata(
        ...
        assertThat(orderGetOrderByIdResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(orderGetOrderByIdResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(orderGetOrderByIdResponse.data())
            .isEqualTo(
                Order.builder()
                    .id("0195f6c7-4f64-7e3c-8b0a-1d8e4f5e6a7b")
                    .accountId(19816L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedOrderGetOrderByIdResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(orderGetOrderByIdResponse),
                jacksonTypeRef<OrderGetOrderByIdResponse>(),
            )

        assertThat(roundtrippedOrderGetOrderByIdResponse).isEqualTo(orderGetOrderByIdResponse)
    }
}
