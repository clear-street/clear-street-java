...
internal class OfferingServiceAsyncTest {
    ...
    fun getOfferingById() {
        val client =
            ClearStreetOkHttpClientAsync.builder()
                ...
                .apiKey("My API Key")
                .build()
        val offeringServiceAsync = client.v1().privateMarkets().offerings()

        val responseFuture =
            offeringServiceAsync.getOfferingById(
    ...
    fun getOfferings() {
        ...
        val responseFuture =
            offeringServiceAsync.getOfferings(
