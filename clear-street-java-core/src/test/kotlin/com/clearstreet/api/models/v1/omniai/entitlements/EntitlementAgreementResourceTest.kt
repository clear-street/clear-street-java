...
import com.clearstreet.api.models.v1.omniai.EntitlementAgreementKey
...
internal class EntitlementAgreementResourceTest {
    ...
    fun create() {
        ...
        assertThat(entitlementAgreementResource.agreementKey())
        ...
        assertThat(entitlementAgreementResource.entitlementCodes())
