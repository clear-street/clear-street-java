...
internal class InstrumentDataGetAllInstrumentEventsResponseTest {

    @Test
    fun create() {
        val instrumentDataGetAllInstrumentEventsResponse =
            InstrumentDataGetAllInstrumentEventsResponse.builder()
                .metadata(
        ...
        assertThat(instrumentDataGetAllInstrumentEventsResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(instrumentDataGetAllInstrumentEventsResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(instrumentDataGetAllInstrumentEventsResponse.data())
            .isEqualTo(
                InstrumentAllEventsData.builder()
                    .addEventDate(
                        InstrumentEventsByDate.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedInstrumentDataGetAllInstrumentEventsResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(instrumentDataGetAllInstrumentEventsResponse),
                jacksonTypeRef<InstrumentDataGetAllInstrumentEventsResponse>(),
            )

        assertThat(roundtrippedInstrumentDataGetAllInstrumentEventsResponse)
            .isEqualTo(instrumentDataGetAllInstrumentEventsResponse)
    }
}
