...
internal class PositionCancelPositionInstructionResponseTest {

    @Test
    fun create() {
        val positionCancelPositionInstructionResponse =
            PositionCancelPositionInstructionResponse.builder()
                .metadata(
                    ...
                    PositionInstruction.builder()
                        ...
                        .rejection(
                            PositionInstructionRejection.builder()
                                ...
                                .metadata(
                                    JsonValue.from(mapOf("available" to "3", "requested" to "5"))
                                )
        ...
        assertThat(positionCancelPositionInstructionResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(positionCancelPositionInstructionResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(positionCancelPositionInstructionResponse.data())
            .isEqualTo(
                PositionInstruction.builder()
                    .id("0195f6d0-a1b2-7c3d-8e4f-5a6b7c8d9e02")
                    .accountId(122503L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedPositionCancelPositionInstructionResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(positionCancelPositionInstructionResponse),
                jacksonTypeRef<PositionCancelPositionInstructionResponse>(),
            )

        assertThat(roundtrippedPositionCancelPositionInstructionResponse)
            .isEqualTo(positionCancelPositionInstructionResponse)
    }
}
