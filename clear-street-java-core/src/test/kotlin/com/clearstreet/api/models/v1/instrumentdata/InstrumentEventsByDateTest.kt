...
internal class InstrumentEventsByDateTest {

    @Test
    fun create() {
        val instrumentEventsByDate =
        ...
        assertThat(instrumentEventsByDate.date()).isEqualTo(LocalDate.parse("2019-12-27"))
        assertThat(instrumentEventsByDate.events())
            .containsExactly(
                InstrumentEventEnvelope.builder()
                    .symbol("symbol")
                    .type(AllEventsEventType.EARNINGS)
    ...
    fun roundtrip() {
        ...
        val roundtrippedInstrumentEventsByDate =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(instrumentEventsByDate),
                jacksonTypeRef<InstrumentEventsByDate>(),
            )

        assertThat(roundtrippedInstrumentEventsByDate).isEqualTo(instrumentEventsByDate)
    }
}
