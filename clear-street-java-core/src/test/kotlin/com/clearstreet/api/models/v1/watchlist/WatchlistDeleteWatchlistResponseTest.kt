...
internal class WatchlistDeleteWatchlistResponseTest {
    ...
    @Test
    fun create() {
        val watchlistDeleteWatchlistResponse =
            WatchlistDeleteWatchlistResponse.builder()
                .metadata(
        ...
        assertThat(watchlistDeleteWatchlistResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(watchlistDeleteWatchlistResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
