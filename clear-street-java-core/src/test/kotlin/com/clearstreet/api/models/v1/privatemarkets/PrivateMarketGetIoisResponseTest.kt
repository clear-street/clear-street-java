...
internal class PrivateMarketGetIoisResponseTest {

    @Test
    fun create() {
        val privateMarketGetIoisResponse =
            PrivateMarketGetIoisResponse.builder()
                .metadata(
        ...
        assertThat(privateMarketGetIoisResponse.metadata())
            .isEqualTo(
                ResponseMetadata.builder()
                    .requestId("request_id")
                    .nextPageToken("U3RhaW5sZXNzIHJvY2tz")
        ...
        assertThat(privateMarketGetIoisResponse.error())
            .contains(
                ApiError.builder()
                    .code(400)
                    .message("Order quantity must be greater than zero")
        ...
        assertThat(privateMarketGetIoisResponse.data())
            .containsExactly(
                IoiListingResource.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .accountId(0L)
    ...
    fun roundtrip() {
        ...
        val roundtrippedPrivateMarketGetIoisResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(privateMarketGetIoisResponse),
                jacksonTypeRef<PrivateMarketGetIoisResponse>(),
            )

        assertThat(roundtrippedPrivateMarketGetIoisResponse).isEqualTo(privateMarketGetIoisResponse)
    }
}
