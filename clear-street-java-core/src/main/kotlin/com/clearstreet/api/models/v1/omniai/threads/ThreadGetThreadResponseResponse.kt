...
private constructor(
    ...
    /** A builder for [ThreadGetThreadResponseResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(threadGetThreadResponseResponse: ThreadGetThreadResponseResponse) =
            apply {
                metadata = threadGetThreadResponseResponse.metadata
                error = threadGetThreadResponseResponse.error
                data = threadGetThreadResponseResponse.data
                additionalProperties =
                    threadGetThreadResponseResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ThreadGetThreadResponseResponse].
         *
         ...
         */
        fun build(): ThreadGetThreadResponseResponse =
            ThreadGetThreadResponseResponse(
     ...
     *   expected type.
     */
    fun validate(): ThreadGetThreadResponseResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadGetThreadResponseResponse &&
    ...
    override fun toString() =
        "ThreadGetThreadResponseResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
