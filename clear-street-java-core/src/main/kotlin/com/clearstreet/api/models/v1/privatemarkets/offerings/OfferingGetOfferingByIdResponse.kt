...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<OfferingDetail> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): OfferingDetail = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<OfferingDetail> = data
    ...
    /** A builder for [OfferingGetOfferingByIdResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<OfferingDetail>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(offeringGetOfferingByIdResponse: OfferingGetOfferingByIdResponse) =
            apply {
                metadata = offeringGetOfferingByIdResponse.metadata
                error = offeringGetOfferingByIdResponse.error
                data = offeringGetOfferingByIdResponse.data
                additionalProperties =
                    offeringGetOfferingByIdResponse.additionalProperties.toMutableMap()
            }
        ...
        /** One offering with everything needed to render its detail payload. */
        fun data(data: OfferingDetail) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [OfferingDetail] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<OfferingDetail>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [OfferingGetOfferingByIdResponse].
         *
         ...
         */
        fun build(): OfferingGetOfferingByIdResponse =
            OfferingGetOfferingByIdResponse(
     ...
     *   expected type.
     */
    fun validate(): OfferingGetOfferingByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OfferingGetOfferingByIdResponse &&
    ...
    override fun toString() =
        "OfferingGetOfferingByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
