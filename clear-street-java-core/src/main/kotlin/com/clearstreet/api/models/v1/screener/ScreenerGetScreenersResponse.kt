...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ScreenerGetScreenersResponse].
         *
    ...
    /** A builder for [ScreenerGetScreenersResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(screenerGetScreenersResponse: ScreenerGetScreenersResponse) = apply {
            metadata = screenerGetScreenersResponse.metadata
            error = screenerGetScreenersResponse.error
            data = screenerGetScreenersResponse.data.map { it.toMutableList() }
            additionalProperties = screenerGetScreenersResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ScreenerGetScreenersResponse].
         *
         ...
         */
        fun build(): ScreenerGetScreenersResponse =
     ...
     *   expected type.
     */
    fun validate(): ScreenerGetScreenersResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScreenerGetScreenersResponse &&
    ...
    override fun toString() =
        "ScreenerGetScreenersResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
