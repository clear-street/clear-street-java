...
package com.clearstreet.api.models.v1.apiversion
...
private constructor(
    ...
    private val data: JsonField<Version>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<Version> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): Version = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<Version> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ApiVersionGetVersionResponse].
         *
    ...
    /** A builder for [ApiVersionGetVersionResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<Version>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(apiVersionGetVersionResponse: ApiVersionGetVersionResponse) = apply {
            metadata = apiVersionGetVersionResponse.metadata
            error = apiVersionGetVersionResponse.error
            data = apiVersionGetVersionResponse.data
            additionalProperties = apiVersionGetVersionResponse.additionalProperties.toMutableMap()
        }
        ...
        /** API version information */
        fun data(data: Version) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [Version] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<Version>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [ApiVersionGetVersionResponse].
         *
         ...
         */
        fun build(): ApiVersionGetVersionResponse =
     ...
     *   expected type.
     */
    fun validate(): ApiVersionGetVersionResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiVersionGetVersionResponse &&
    ...
    override fun toString() =
        "ApiVersionGetVersionResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
