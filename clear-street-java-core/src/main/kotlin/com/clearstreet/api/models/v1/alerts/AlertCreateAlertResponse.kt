...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<CreateAlertResponse> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): CreateAlertResponse = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CreateAlertResponse> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AlertCreateAlertResponse].
         *
    ...
    /** A builder for [AlertCreateAlertResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<CreateAlertResponse>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(alertCreateAlertResponse: AlertCreateAlertResponse) = apply {
            metadata = alertCreateAlertResponse.metadata
            error = alertCreateAlertResponse.error
            data = alertCreateAlertResponse.data
            additionalProperties = alertCreateAlertResponse.additionalProperties.toMutableMap()
        }
        ...
        /** Response payload for alert creation. */
        fun data(data: CreateAlertResponse) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [CreateAlertResponse] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<CreateAlertResponse>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [AlertCreateAlertResponse].
         *
         ...
         */
        fun build(): AlertCreateAlertResponse =
     ...
     *   expected type.
     */
    fun validate(): AlertCreateAlertResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AlertCreateAlertResponse &&
    ...
    override fun toString() =
        "AlertCreateAlertResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
