 ...
 */
class ScreenerCreateScreenerParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ScreenerCreateScreenerParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [ScreenerCreateScreenerParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ScreenerCreateScreenerParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(screenerCreateScreenerParams: ScreenerCreateScreenerParams) = apply {
            body = screenerCreateScreenerParams.body.toBuilder()
            additionalHeaders = screenerCreateScreenerParams.additionalHeaders.toBuilder()
            additionalQueryParams = screenerCreateScreenerParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ScreenerCreateScreenerParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ScreenerCreateScreenerParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScreenerCreateScreenerParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ScreenerCreateScreenerParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
