...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(watchlistDeleteWatchlistResponse: WatchlistDeleteWatchlistResponse) =
            apply {
                metadata = watchlistDeleteWatchlistResponse.metadata
                error = watchlistDeleteWatchlistResponse.error
                data = watchlistDeleteWatchlistResponse.data
    ...
    override fun toString() =
        "WatchlistDeleteWatchlistResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
