...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<IoiListingResource>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<IoiListingResource> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<IoiListingResource>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PrivateMarketGetIoisResponse].
         *
    ...
    /** A builder for [PrivateMarketGetIoisResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<IoiListingResource>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(privateMarketGetIoisResponse: PrivateMarketGetIoisResponse) = apply {
            metadata = privateMarketGetIoisResponse.metadata
            error = privateMarketGetIoisResponse.error
            data = privateMarketGetIoisResponse.data.map { it.toMutableList() }
            additionalProperties = privateMarketGetIoisResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<IoiListingResource>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<IoiListingResource>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<IoiListingResource>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [IoiListingResource] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: IoiListingResource) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [PrivateMarketGetIoisResponse].
         *
         ...
         */
        fun build(): PrivateMarketGetIoisResponse =
     ...
     *   expected type.
     */
    fun validate(): PrivateMarketGetIoisResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PrivateMarketGetIoisResponse &&
    ...
    override fun toString() =
        "PrivateMarketGetIoisResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
