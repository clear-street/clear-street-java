...
/** Kind of SPV fee. */
class FeeType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmField val MANAGEMENT = of("MANAGEMENT")

        @JvmField val CARRY = of("CARRY")
    ...
    fun known(): Known =
        when (this) {
            ...
            OTHER -> Known.OTHER
            else -> throw ClearStreetInvalidDataException("Unknown FeeType: $value")
        }
