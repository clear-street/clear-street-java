 ...
 * first-seen request order. Resolvable ids with no available data come back with `symbol` populated
...
private constructor(
    ...
    /** A builder for [MarketDataGetDailySummariesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(marketDataGetDailySummariesParams: MarketDataGetDailySummariesParams) =
            apply {
                instrumentIds = marketDataGetDailySummariesParams.instrumentIds
                additionalHeaders = marketDataGetDailySummariesParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [MarketDataGetDailySummariesParams].
         *
         ...
         */
        fun build(): MarketDataGetDailySummariesParams =
            MarketDataGetDailySummariesParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MarketDataGetDailySummariesParams &&
    ...
    override fun toString() =
        "MarketDataGetDailySummariesParams{instrumentIds=$instrumentIds, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
