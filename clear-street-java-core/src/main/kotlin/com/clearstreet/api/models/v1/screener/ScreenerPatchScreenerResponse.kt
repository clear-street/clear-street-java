...
private constructor(
    ...
    /** A builder for [ScreenerPatchScreenerResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(screenerPatchScreenerResponse: ScreenerPatchScreenerResponse) = apply {
            metadata = screenerPatchScreenerResponse.metadata
            error = screenerPatchScreenerResponse.error
            data = screenerPatchScreenerResponse.data
            additionalProperties = screenerPatchScreenerResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ScreenerPatchScreenerResponse].
         *
         ...
         */
        fun build(): ScreenerPatchScreenerResponse =
            ScreenerPatchScreenerResponse(
     ...
     *   expected type.
     */
    fun validate(): ScreenerPatchScreenerResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScreenerPatchScreenerResponse &&
    ...
    override fun toString() =
        "ScreenerPatchScreenerResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
