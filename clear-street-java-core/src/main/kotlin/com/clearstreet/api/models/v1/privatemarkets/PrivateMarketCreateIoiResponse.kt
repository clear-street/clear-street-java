...
class PrivateMarketCreateIoiResponse
...
private constructor(
    ...
    /** A builder for [PrivateMarketCreateIoiResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(privateMarketCreateIoiResponse: PrivateMarketCreateIoiResponse) = apply {
            metadata = privateMarketCreateIoiResponse.metadata
            error = privateMarketCreateIoiResponse.error
            data = privateMarketCreateIoiResponse.data
            additionalProperties =
                privateMarketCreateIoiResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PrivateMarketCreateIoiResponse].
         *
         ...
         */
        fun build(): PrivateMarketCreateIoiResponse =
            PrivateMarketCreateIoiResponse(
     ...
     *   expected type.
     */
    fun validate(): PrivateMarketCreateIoiResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PrivateMarketCreateIoiResponse &&
    ...
    override fun toString() =
        "PrivateMarketCreateIoiResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
