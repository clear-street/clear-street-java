...
private constructor(
    ...
    private val replaceOrderRequest: ReplaceOrderRequest,
     ...
     */
    fun replaceOrderRequest(): ReplaceOrderRequest = replaceOrderRequest

    fun _additionalBodyProperties(): Map<String, JsonValue> =
        replaceOrderRequest._additionalProperties()
    ...
    class Builder internal constructor() {
        ...
        private var replaceOrderRequest: ReplaceOrderRequest? = null
        ...
        internal fun from(orderReplaceOrderParams: OrderReplaceOrderParams) = apply {
            ...
            replaceOrderRequest = orderReplaceOrderParams.replaceOrderRequest
         ...
         * At least one field must be provided.
         */
        fun replaceOrderRequest(replaceOrderRequest: ReplaceOrderRequest) = apply {
        ...
        fun build(): OrderReplaceOrderParams =
            OrderReplaceOrderParams(
                ...
                orderId,
                checkRequired("replaceOrderRequest", replaceOrderRequest),
                additionalHeaders.build(),
                additionalQueryParams.build(),
            )
    }

    fun _body(): ReplaceOrderRequest = replaceOrderRequest
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrderReplaceOrderParams &&
            ...
            replaceOrderRequest == other.replaceOrderRequest &&
    ...
    override fun toString() =
        "OrderReplaceOrderParams{accountId=$accountId, orderId=$orderId, replaceOrderRequest=$replaceOrderRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
