...
private constructor(
    ...
    private val data: JsonField<Catalog>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<Catalog> = JsonMissing.of(),
    ...
    /**
     * The complete screener field catalog, serialized as the `data` payload of `GET
     * /screener/catalog`.
     *
     * @throws ClearStreetInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): Catalog = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<Catalog> = data
    ...
    /** A builder for [ScreenerGetScreenerCatalogResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<Catalog>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(screenerGetScreenerCatalogResponse: ScreenerGetScreenerCatalogResponse) =
            apply {
                metadata = screenerGetScreenerCatalogResponse.metadata
                error = screenerGetScreenerCatalogResponse.error
                data = screenerGetScreenerCatalogResponse.data
                additionalProperties =
                    screenerGetScreenerCatalogResponse.additionalProperties.toMutableMap()
            }
         ...
         * /screener/catalog`.
         */
        fun data(data: Catalog) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [Catalog] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<Catalog>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [ScreenerGetScreenerCatalogResponse].
         *
         ...
         */
        fun build(): ScreenerGetScreenerCatalogResponse =
            ScreenerGetScreenerCatalogResponse(
     ...
     *   expected type.
     */
    fun validate(): ScreenerGetScreenerCatalogResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScreenerGetScreenerCatalogResponse &&
    ...
    override fun toString() =
        "ScreenerGetScreenerCatalogResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
