 ...
 * `deleted` value.
 */
class AlertStatus @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw ClearStreetInvalidDataException("Unknown AlertStatus: $value")
        }
