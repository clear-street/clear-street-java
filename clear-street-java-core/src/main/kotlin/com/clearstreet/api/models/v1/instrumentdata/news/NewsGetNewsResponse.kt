...
package com.clearstreet.api.models.v1.instrumentdata.news
...
private constructor(
    ...
    private val data: JsonField<List<NewsItem>>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<NewsItem>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<NewsItem> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<NewsItem>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NewsGetNewsResponse].
         *
    ...
    /** A builder for [NewsGetNewsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<NewsItem>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(newsGetNewsResponse: NewsGetNewsResponse) = apply {
            metadata = newsGetNewsResponse.metadata
            error = newsGetNewsResponse.error
            data = newsGetNewsResponse.data.map { it.toMutableList() }
            additionalProperties = newsGetNewsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<NewsItem>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<NewsItem>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<NewsItem>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [NewsItem] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: NewsItem) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [NewsGetNewsResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): NewsGetNewsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NewsGetNewsResponse &&
    ...
    override fun toString() =
        "NewsGetNewsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
