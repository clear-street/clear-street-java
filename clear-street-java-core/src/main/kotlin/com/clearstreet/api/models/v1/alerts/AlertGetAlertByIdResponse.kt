...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<Alert> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): Alert = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<Alert> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AlertGetAlertByIdResponse].
         *
    ...
    /** A builder for [AlertGetAlertByIdResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<Alert>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(alertGetAlertByIdResponse: AlertGetAlertByIdResponse) = apply {
            metadata = alertGetAlertByIdResponse.metadata
            error = alertGetAlertByIdResponse.error
            data = alertGetAlertByIdResponse.data
            additionalProperties = alertGetAlertByIdResponse.additionalProperties.toMutableMap()
        }
        ...
        /** A stored alert: the spec it was created with plus its lifecycle facts. */
        fun data(data: Alert) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [Alert] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<Alert>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [AlertGetAlertByIdResponse].
         *
         ...
         */
        fun build(): AlertGetAlertByIdResponse =
     ...
     *   expected type.
     */
    fun validate(): AlertGetAlertByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AlertGetAlertByIdResponse &&
    ...
    override fun toString() =
        "AlertGetAlertByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
