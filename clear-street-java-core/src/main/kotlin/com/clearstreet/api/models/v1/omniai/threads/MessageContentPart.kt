...
private constructor(
    ...
    override fun toString(): String =
        when {
            contentPartText != null -> "MessageContentPart{contentPartText=$contentPartText}"
            contentPartStructuredAction != null ->
                "MessageContentPart{contentPartStructuredAction=$contentPartStructuredAction}"
            contentPartChart != null -> "MessageContentPart{contentPartChart=$contentPartChart}"
            contentPartSuggestedActions != null ->
                "MessageContentPart{contentPartSuggestedActions=$contentPartSuggestedActions}"
            contentPartCustom != null -> "MessageContentPart{contentPartCustom=$contentPartCustom}"
    ...
    companion object {
        ...
        fun ofContentPartText(contentPartText: ContentPartText) =
            MessageContentPart(contentPartText = contentPartText)
        ...
        fun ofContentPartChart(contentPartChart: ContentPartChart) =
            MessageContentPart(contentPartChart = contentPartChart)
        ...
        fun ofContentPartCustom(contentPartCustom: ContentPartCustom) =
            MessageContentPart(contentPartCustom = contentPartCustom)
    }
            ...
            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<ContentPartText>())?.let {
                            MessageContentPart(contentPartText = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<ContentPartStructuredAction>())?.let {
                            MessageContentPart(contentPartStructuredAction = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<ContentPartChart>())?.let {
                            MessageContentPart(contentPartChart = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<ContentPartSuggestedActions>())?.let {
                            MessageContentPart(contentPartSuggestedActions = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<ContentPartCustom>())?.let {
                            MessageContentPart(contentPartCustom = it, _json = json)
                        },
                    )
                    .filterNotNull()
