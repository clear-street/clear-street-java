...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         * `List<PrefillModifyOrderRequest>` value instead. This method is primarily for setting the
    ...
    override fun toString() =
        "PrefillModifyOrderAction{orders=$orders, additionalProperties=$additionalProperties}"
}
