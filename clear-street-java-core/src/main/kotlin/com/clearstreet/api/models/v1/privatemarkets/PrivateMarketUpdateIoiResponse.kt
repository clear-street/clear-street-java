...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<IoiListingResource> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): IoiListingResource = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<IoiListingResource> = data
    ...
    /** A builder for [PrivateMarketUpdateIoiResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<IoiListingResource>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(privateMarketUpdateIoiResponse: PrivateMarketUpdateIoiResponse) = apply {
            metadata = privateMarketUpdateIoiResponse.metadata
            error = privateMarketUpdateIoiResponse.error
            data = privateMarketUpdateIoiResponse.data
            additionalProperties =
                privateMarketUpdateIoiResponse.additionalProperties.toMutableMap()
        }
        ...
        /** IOI list item with the campaign identity needed to render it. */
        fun data(data: IoiListingResource) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [IoiListingResource] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<IoiListingResource>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [PrivateMarketUpdateIoiResponse].
         *
         ...
         */
        fun build(): PrivateMarketUpdateIoiResponse =
            PrivateMarketUpdateIoiResponse(
     ...
     *   expected type.
     */
    fun validate(): PrivateMarketUpdateIoiResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PrivateMarketUpdateIoiResponse &&
    ...
    override fun toString() =
        "PrivateMarketUpdateIoiResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
