...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<OfferingCard>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<OfferingCard> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<OfferingCard>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OfferingGetOfferingsResponse].
         *
    ...
    /** A builder for [OfferingGetOfferingsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<OfferingCard>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(offeringGetOfferingsResponse: OfferingGetOfferingsResponse) = apply {
            metadata = offeringGetOfferingsResponse.metadata
            error = offeringGetOfferingsResponse.error
            data = offeringGetOfferingsResponse.data.map { it.toMutableList() }
            additionalProperties = offeringGetOfferingsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<OfferingCard>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<OfferingCard>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<OfferingCard>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [OfferingCard] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: OfferingCard) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [OfferingGetOfferingsResponse].
         *
         ...
         */
        fun build(): OfferingGetOfferingsResponse =
     ...
     *   expected type.
     */
    fun validate(): OfferingGetOfferingsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OfferingGetOfferingsResponse &&
    ...
    override fun toString() =
        "OfferingGetOfferingsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
