...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AlertGetAlertsResponse].
         *
    ...
    /** A builder for [AlertGetAlertsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(alertGetAlertsResponse: AlertGetAlertsResponse) = apply {
            metadata = alertGetAlertsResponse.metadata
            error = alertGetAlertsResponse.error
            data = alertGetAlertsResponse.data.map { it.toMutableList() }
            additionalProperties = alertGetAlertsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AlertGetAlertsResponse].
         *
         ...
         */
        fun build(): AlertGetAlertsResponse =
     ...
     *   expected type.
     */
    fun validate(): AlertGetAlertsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AlertGetAlertsResponse &&
    ...
    override fun toString() =
        "AlertGetAlertsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
