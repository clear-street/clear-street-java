...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<FeedPage> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): FeedPage = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<FeedPage> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OmniFeedGetFeedResponse].
         *
    ...
    /** A builder for [OmniFeedGetFeedResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<FeedPage>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(omniFeedGetFeedResponse: OmniFeedGetFeedResponse) = apply {
            metadata = omniFeedGetFeedResponse.metadata
            error = omniFeedGetFeedResponse.error
            data = omniFeedGetFeedResponse.data
            additionalProperties = omniFeedGetFeedResponse.additionalProperties.toMutableMap()
        }
        ...
        /** One page of the caller's feed. */
        fun data(data: FeedPage) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [FeedPage] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<FeedPage>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [OmniFeedGetFeedResponse].
         *
         ...
         */
        fun build(): OmniFeedGetFeedResponse =
     ...
     *   expected type.
     */
    fun validate(): OmniFeedGetFeedResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OmniFeedGetFeedResponse &&
    ...
    override fun toString() =
        "OmniFeedGetFeedResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
