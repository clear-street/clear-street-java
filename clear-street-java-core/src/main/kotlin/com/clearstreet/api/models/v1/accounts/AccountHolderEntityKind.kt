...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmStatic fun of(value: String) = AccountHolderEntityKind(JsonField.of(value))
    }

    /** An enum containing [AccountHolderEntityKind]'s known values. */
    enum class Known {
        NATURAL_PERSON,
        LEGAL_ENTITY,
        OTHER,
    ...
    /**
     * An enum containing [AccountHolderEntityKind]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [AccountHolderEntityKind] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        OTHER,
        /**
         * An enum member indicating that [AccountHolderEntityKind] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            OTHER -> Known.OTHER
            else -> throw ClearStreetInvalidDataException("Unknown AccountHolderEntityKind: $value")
        }
     ...
     *   expected type.
     */
    fun validate(): AccountHolderEntityKind = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountHolderEntityKind && value == other.value
    }
