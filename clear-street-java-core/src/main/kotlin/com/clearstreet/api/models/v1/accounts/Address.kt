...
private constructor(
    ...
    /**
     * Second street address line When a null/undefined value is observed, it indicates it does not
     * apply.
     *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Second street address line When a null/undefined value is observed, it indicates it does
         * not apply.
         */
        ...
        /**
         * State or province When a null/undefined value is observed, it indicates it does not
         * apply.
         */
    ...
    override fun toString() =
        "Address{city=$city, country=$country, line1=$line1, postalCode=$postalCode, line2=$line2, state=$state, additionalProperties=$additionalProperties}"
}
