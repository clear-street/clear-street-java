...
private constructor(
    ...
    private val data: JsonField<CompanyDetail>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<CompanyDetail> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): CompanyDetail = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CompanyDetail> = data
    ...
    /** A builder for [PrivateMarketGetCompanyByIdResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<CompanyDetail>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            privateMarketGetCompanyByIdResponse: PrivateMarketGetCompanyByIdResponse
        ) = apply {
            metadata = privateMarketGetCompanyByIdResponse.metadata
            error = privateMarketGetCompanyByIdResponse.error
            data = privateMarketGetCompanyByIdResponse.data
            additionalProperties =
                privateMarketGetCompanyByIdResponse.additionalProperties.toMutableMap()
        }
        ...
        /** A company's identity and its complete published profile. */
        fun data(data: CompanyDetail) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [CompanyDetail] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<CompanyDetail>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [PrivateMarketGetCompanyByIdResponse].
         *
         ...
         */
        fun build(): PrivateMarketGetCompanyByIdResponse =
            PrivateMarketGetCompanyByIdResponse(
     ...
     *   expected type.
     */
    fun validate(): PrivateMarketGetCompanyByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PrivateMarketGetCompanyByIdResponse &&
    ...
    override fun toString() =
        "PrivateMarketGetCompanyByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
