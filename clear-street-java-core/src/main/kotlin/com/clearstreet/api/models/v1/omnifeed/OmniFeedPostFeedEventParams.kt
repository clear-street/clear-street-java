 ...
 *
 * Records one of the caller's interactions with a feed item: the item rendered on screen (`seen`),
 * expanded from its headline to its summary (`click`), or voted on (`upvote`, `downvote`). Marking
 * an item `seen` excludes it from the caller's next feed response.
 *
 * Each request records a new event, so a request that is retried after a failure of unknown outcome
 * may be recorded twice. That is harmless for `seen` and for votes — the first is a yes-or-no
 * exclusion and the latest vote is the one that counts — so retry freely for those. The event is
 * wrapped in an `event` field so that a future request may carry several at once without breaking
 * this one.
 */
class OmniFeedPostFeedEventParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OmniFeedPostFeedEventParams].
         *
    ...
    /** A builder for [OmniFeedPostFeedEventParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(omniFeedPostFeedEventParams: OmniFeedPostFeedEventParams) = apply {
            body = omniFeedPostFeedEventParams.body.toBuilder()
            additionalHeaders = omniFeedPostFeedEventParams.additionalHeaders.toBuilder()
            additionalQueryParams = omniFeedPostFeedEventParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OmniFeedPostFeedEventParams].
         *
         ...
         */
        fun build(): OmniFeedPostFeedEventParams =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("event", event), additionalProperties.toMutableMap())
        }
    ...
    private constructor(
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                @JvmField val UPVOTE = of("upvote")

                @JvmField val DOWNVOTE = of("downvote")
        ...
        private val hashCode: Int by lazy { Objects.hash(itemId, type, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Event{itemId=$itemId, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OmniFeedPostFeedEventParams &&
            body == other.body &&
    ...
    override fun toString() =
        "OmniFeedPostFeedEventParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
