...
class Schedule @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmField val EVERY_1M = of("every_1m")

        @JvmStatic fun of(value: String) = Schedule(JsonField.of(value))
    }
    ...
    fun known(): Known =
        when (this) {
            EVERY_1M -> Known.EVERY_1M
            else -> throw ClearStreetInvalidDataException("Unknown Schedule: $value")
        }
