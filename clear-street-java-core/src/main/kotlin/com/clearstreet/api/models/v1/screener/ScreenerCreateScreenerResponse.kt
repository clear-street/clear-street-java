...
private constructor(
    ...
    /** A builder for [ScreenerCreateScreenerResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(screenerCreateScreenerResponse: ScreenerCreateScreenerResponse) = apply {
            metadata = screenerCreateScreenerResponse.metadata
            error = screenerCreateScreenerResponse.error
            data = screenerCreateScreenerResponse.data
            additionalProperties =
                screenerCreateScreenerResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ScreenerCreateScreenerResponse].
         *
         ...
         */
        fun build(): ScreenerCreateScreenerResponse =
            ScreenerCreateScreenerResponse(
     ...
     *   expected type.
     */
    fun validate(): ScreenerCreateScreenerResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScreenerCreateScreenerResponse &&
    ...
    override fun toString() =
        "ScreenerCreateScreenerResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
