...
private constructor(
    ...
    /** A builder for [ScreenerReplaceScreenerResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(screenerReplaceScreenerResponse: ScreenerReplaceScreenerResponse) =
            apply {
                metadata = screenerReplaceScreenerResponse.metadata
                error = screenerReplaceScreenerResponse.error
                data = screenerReplaceScreenerResponse.data
                additionalProperties =
                    screenerReplaceScreenerResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ScreenerReplaceScreenerResponse].
         *
         ...
         */
        fun build(): ScreenerReplaceScreenerResponse =
            ScreenerReplaceScreenerResponse(
     ...
     *   expected type.
     */
    fun validate(): ScreenerReplaceScreenerResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScreenerReplaceScreenerResponse &&
    ...
    override fun toString() =
        "ScreenerReplaceScreenerResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
