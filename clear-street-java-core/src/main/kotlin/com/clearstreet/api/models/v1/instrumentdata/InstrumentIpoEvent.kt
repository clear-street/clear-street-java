...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InstrumentIpoEvent].
         *
    ...
    /** A builder for [InstrumentIpoEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(instrumentIpoEvent: InstrumentIpoEvent) = apply {
            date = instrumentIpoEvent.date
            actions = instrumentIpoEvent.actions
            announcedAt = instrumentIpoEvent.announcedAt
            company = instrumentIpoEvent.company
            exchange = instrumentIpoEvent.exchange
            marketCap = instrumentIpoEvent.marketCap
            priceRange = instrumentIpoEvent.priceRange
            shares = instrumentIpoEvent.shares
            additionalProperties = instrumentIpoEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InstrumentIpoEvent].
         *
     ...
     *   expected type.
     */
    fun validate(): InstrumentIpoEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentIpoEvent &&
            date == other.date &&
    ...
    override fun toString() =
        "InstrumentIpoEvent{date=$date, actions=$actions, announcedAt=$announcedAt, company=$company, exchange=$exchange, marketCap=$marketCap, priceRange=$priceRange, shares=$shares, additionalProperties=$additionalProperties}"
}
