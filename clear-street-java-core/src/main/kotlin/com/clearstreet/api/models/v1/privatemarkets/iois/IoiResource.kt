...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IoiResource].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(ioiResource: IoiResource) = apply {
            id = ioiResource.id
            accountId = ioiResource.accountId
            createdAt = ioiResource.createdAt
            currency = ioiResource.currency
            notionalAmount = ioiResource.notionalAmount
            offeringId = ioiResource.offeringId
            updatedAt = ioiResource.updatedAt
            ndaAcceptance = ioiResource.ndaAcceptance
            additionalProperties = ioiResource.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IoiResource].
         *
     ...
     *   expected type.
     */
    fun validate(): IoiResource = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "IoiResource{id=$id, accountId=$accountId, createdAt=$createdAt, currency=$currency, notionalAmount=$notionalAmount, offeringId=$offeringId, updatedAt=$updatedAt, ndaAcceptance=$ndaAcceptance, additionalProperties=$additionalProperties}"
}
