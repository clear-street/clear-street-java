...
private constructor(
    ...
    /** A builder for [ScreenerGetScreenerByIdResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(screenerGetScreenerByIdResponse: ScreenerGetScreenerByIdResponse) =
            apply {
                metadata = screenerGetScreenerByIdResponse.metadata
                error = screenerGetScreenerByIdResponse.error
                data = screenerGetScreenerByIdResponse.data
                additionalProperties =
                    screenerGetScreenerByIdResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ScreenerGetScreenerByIdResponse].
         *
         ...
         */
        fun build(): ScreenerGetScreenerByIdResponse =
            ScreenerGetScreenerByIdResponse(
     ...
     *   expected type.
     */
    fun validate(): ScreenerGetScreenerByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScreenerGetScreenerByIdResponse &&
    ...
    override fun toString() =
        "ScreenerGetScreenerByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
