...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<SpvDetail> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): SpvDetail = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<SpvDetail> = data
    ...
    /** A builder for [PrivateMarketGetSpvByIdResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<SpvDetail>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(privateMarketGetSpvByIdResponse: PrivateMarketGetSpvByIdResponse) =
            apply {
                metadata = privateMarketGetSpvByIdResponse.metadata
                error = privateMarketGetSpvByIdResponse.error
                data = privateMarketGetSpvByIdResponse.data
                additionalProperties =
                    privateMarketGetSpvByIdResponse.additionalProperties.toMutableMap()
            }
        ...
        /** An OPEN SPV's identity, exact economics, and typed fee schedule. */
        fun data(data: SpvDetail) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [SpvDetail] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<SpvDetail>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [PrivateMarketGetSpvByIdResponse].
         *
         ...
         */
        fun build(): PrivateMarketGetSpvByIdResponse =
            PrivateMarketGetSpvByIdResponse(
     ...
     *   expected type.
     */
    fun validate(): PrivateMarketGetSpvByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PrivateMarketGetSpvByIdResponse &&
    ...
    override fun toString() =
        "PrivateMarketGetSpvByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
