...
interface ScreenerService {
     ...
     */
    fun getScreenerCatalog(): ScreenerGetScreenerCatalogResponse =
    ...
    fun getScreenerCatalog(
        params: ScreenerGetScreenerCatalogParams = ScreenerGetScreenerCatalogParams.none()
    ): ScreenerGetScreenerCatalogResponse = getScreenerCatalog(params, RequestOptions.none())

    /** @see getScreenerCatalog */
    fun getScreenerCatalog(requestOptions: RequestOptions): ScreenerGetScreenerCatalogResponse =
    ...
    interface WithRawResponse {
         ...
         * [ScreenerService.getScreenerCatalog].
         */
        @MustBeClosed
        fun getScreenerCatalog(): HttpResponseFor<ScreenerGetScreenerCatalogResponse> =
            getScreenerCatalog(ScreenerGetScreenerCatalogParams.none())
