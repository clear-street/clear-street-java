...
package com.clear_street.api.core.http

import com.clear_street.api.core.JsonArray
import com.clear_street.api.core.JsonBoolean
import com.clear_street.api.core.JsonMissing
import com.clear_street.api.core.JsonNull
import com.clear_street.api.core.JsonNumber
import com.clear_street.api.core.JsonObject
import com.clear_street.api.core.JsonString
    ...
    class Builder internal constructor() {
        ...
        fun put(key: String, value: JsonValue): Builder = apply {
            when (value) {
                ...
                is JsonArray ->
                    value.values.forEachIndexed { index, value -> put("$key[$index]", value) }
                is JsonObject ->
