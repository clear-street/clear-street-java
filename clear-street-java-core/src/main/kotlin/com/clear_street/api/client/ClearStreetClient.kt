...
/**
 * A client for interacting with the Clear Street REST API synchronously. You can also switch to
...
interface ClearStreetClient {
     ...
     * this client.
     */
    fun async(): ClearStreetClientAsync
    ...
    /** A view of [ClearStreetClient] that provides access to raw HTTP responses for each method. */
