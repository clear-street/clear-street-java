...
import com.clear_street.api.models.v1.instruments.events.EventGetAllInstrumentEventsResponse
import com.clear_street.api.models.v1.instruments.events.EventGetInstrumentEventsParams
import com.clear_street.api.models.v1.instruments.events.EventGetInstrumentEventsResponse
...
interface EventService {
     ...
     */
    fun getInstrumentEvents(instrumentId: String): EventGetInstrumentEventsResponse =
        getInstrumentEvents(instrumentId, EventGetInstrumentEventsParams.none())

    /** @see getInstrumentEvents */
    fun getInstrumentEvents(
        instrumentId: String,
        params: EventGetInstrumentEventsParams = EventGetInstrumentEventsParams.none(),
        requestOptions: RequestOptions = RequestOptions.none(),
    ...
    fun getInstrumentEvents(
        ...
        getInstrumentEvents(instrumentId, EventGetInstrumentEventsParams.none(), requestOptions)
    ...
    interface WithRawResponse {
         ...
         * as [EventService.getAllInstrumentEvents].
         */
        @MustBeClosed
         ...
         * otherwise the same as [EventService.getInstrumentEvents].
         */
        @MustBeClosed
        fun getInstrumentEvents(
            instrumentId: String
