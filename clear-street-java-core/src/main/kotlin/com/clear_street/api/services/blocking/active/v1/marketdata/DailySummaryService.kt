...
interface DailySummaryService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): DailySummaryService
    ...
    ): DailySummaryGetDailySummariesResponse = getDailySummaries(params, RequestOptions.none())
    ...
    /**
     * A view of [DailySummaryService] that provides access to raw HTTP responses for each method.
     */
    interface WithRawResponse {
         ...
         * otherwise the same as [DailySummaryService.getDailySummaries].
         */
        @MustBeClosed
        fun getDailySummaries(
            params: DailySummaryGetDailySummariesParams
