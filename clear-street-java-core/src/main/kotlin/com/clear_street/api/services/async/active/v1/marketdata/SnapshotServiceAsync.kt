...
import com.clear_street.api.models.active.v1.marketdata.snapshot.SnapshotGetSnapshotsResponse
...
interface SnapshotServiceAsync {
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `get /active/v1/market-data/snapshot`, but is otherwise
         * the same as [SnapshotServiceAsync.getSnapshots].
         */
