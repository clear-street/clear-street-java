...
interface MessageService {
    ...
    ): MessageCreateMessageResponse = createMessage(threadId, params, RequestOptions.none())
    ...
    /** @see createMessage */
    fun createMessage(params: MessageCreateMessageParams): MessageCreateMessageResponse =
    ...
    interface WithRawResponse {
         ...
         * but is otherwise the same as [MessageService.createMessage].
         */
        @MustBeClosed
        fun createMessage(
            threadId: String,
