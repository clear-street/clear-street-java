...
class ResponseServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun cancelResponse(
        ...
        // delete /active/v1/omni-ai/responses/{response_id}
    ...
    override fun getResponse(
        ...
        // get /active/v1/omni-ai/responses/{response_id}
        ...
        override fun cancelResponse(
            ...
            val request =
                HttpRequest.builder()
                    ...
                    .addPathSegments("active", "v1", "omni-ai", "responses", params._pathParam(0))
