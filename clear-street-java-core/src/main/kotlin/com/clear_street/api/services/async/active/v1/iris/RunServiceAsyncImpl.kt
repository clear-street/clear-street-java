...
class RunServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun cancelRunDeprecated(
        ...
        withRawResponse().cancelRunDeprecated(params, requestOptions).thenApply { it.parse() }
    ...
    override fun getRunDeprecated(
        ...
        withRawResponse().getRunDeprecated(params, requestOptions).thenApply { it.parse() }
    ...
    override fun startRunDeprecated(
        ...
        withRawResponse().startRunDeprecated(params, requestOptions).thenApply { it.parse() }
