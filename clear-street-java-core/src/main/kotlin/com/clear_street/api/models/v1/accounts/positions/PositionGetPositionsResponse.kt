...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Position>> = JsonMissing.of(),
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Position>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PositionGetPositionsResponse].
         *
    ...
    /** A builder for [PositionGetPositionsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<Position>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(positionGetPositionsResponse: PositionGetPositionsResponse) = apply {
            metadata = positionGetPositionsResponse.metadata
            error = positionGetPositionsResponse.error
            data = positionGetPositionsResponse.data.map { it.toMutableList() }
            additionalProperties = positionGetPositionsResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Position>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Position>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Position] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Position) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [PositionGetPositionsResponse].
         *
         ...
         */
        fun build(): PositionGetPositionsResponse =
    ...
    fun validate(): PositionGetPositionsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PositionGetPositionsResponse &&
    ...
    override fun toString() =
        "PositionGetPositionsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
