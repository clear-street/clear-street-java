...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [TwapStrategy]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TwapStrategy]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(twapStrategy: TwapStrategy) = apply {
            endAt = twapStrategy.endAt
            startAt = twapStrategy.startAt
            urgency = twapStrategy.urgency
            maxPercent = twapStrategy.maxPercent
            minPercent = twapStrategy.minPercent
            additionalProperties = twapStrategy.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TwapStrategy].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TwapStrategy =
            TwapStrategy(
                endAt,
                startAt,
                urgency,
    ...
    fun validate(): TwapStrategy = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "TwapStrategy{endAt=$endAt, startAt=$startAt, urgency=$urgency, maxPercent=$maxPercent, minPercent=$minPercent, additionalProperties=$additionalProperties}"
}
