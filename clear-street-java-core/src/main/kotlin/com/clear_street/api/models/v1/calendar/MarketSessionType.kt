...
class MarketSessionType @JsonCreator private constructor(private val value: JsonField<String>) :
    Enum {
    ...
    companion object {
        ...
        @JvmField val AFTER_HOURS = of("after_hours")

        @JvmStatic fun of(value: String) = MarketSessionType(JsonField.of(value))
    }
    ...
    /**
     * An enum containing [MarketSessionType]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [MarketSessionType] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        AFTER_HOURS,
        /**
         * An enum member indicating that [MarketSessionType] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw ClearStreetInvalidDataException("Unknown MarketSessionType: $value")
        }
     ...
     *   expected type.
     */
    fun validate(): MarketSessionType = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MarketSessionType && value == other.value
    }
