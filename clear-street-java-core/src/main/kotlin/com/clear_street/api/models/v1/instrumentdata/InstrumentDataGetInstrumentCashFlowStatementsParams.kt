 ...
 */
class InstrumentDataGetInstrumentCashFlowStatementsParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): InstrumentDataGetInstrumentCashFlowStatementsParams = builder().build()
    ...
    /** A builder for [InstrumentDataGetInstrumentCashFlowStatementsParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            instrumentId = instrumentDataGetInstrumentCashFlowStatementsParams.instrumentId
            fromDate = instrumentDataGetInstrumentCashFlowStatementsParams.fromDate
            pageSize = instrumentDataGetInstrumentCashFlowStatementsParams.pageSize
            pageToken = instrumentDataGetInstrumentCashFlowStatementsParams.pageToken
            toDate = instrumentDataGetInstrumentCashFlowStatementsParams.toDate
            additionalHeaders =
                instrumentDataGetInstrumentCashFlowStatementsParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                instrumentDataGetInstrumentCashFlowStatementsParams.additionalQueryParams
                    .toBuilder()
        }
         ...
         */
        fun build(): InstrumentDataGetInstrumentCashFlowStatementsParams =
            InstrumentDataGetInstrumentCashFlowStatementsParams(
                instrumentId,
                fromDate,
                pageSize,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentDataGetInstrumentCashFlowStatementsParams &&
    ...
    override fun toString() =
        "InstrumentDataGetInstrumentCashFlowStatementsParams{instrumentId=$instrumentId, fromDate=$fromDate, pageSize=$pageSize, pageToken=$pageToken, toDate=$toDate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
