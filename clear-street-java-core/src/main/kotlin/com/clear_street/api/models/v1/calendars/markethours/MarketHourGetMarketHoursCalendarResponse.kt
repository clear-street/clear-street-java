...
class MarketHourGetMarketHoursCalendarResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<List<MarketHoursDetail>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<MarketHoursDetail>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<MarketHoursDetail> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<MarketHoursDetail>> = data
    ...
    /** A builder for [MarketHourGetMarketHoursCalendarResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<MarketHoursDetail>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            marketHourGetMarketHoursCalendarResponse: MarketHourGetMarketHoursCalendarResponse
        ) = apply {
            metadata = marketHourGetMarketHoursCalendarResponse.metadata
            error = marketHourGetMarketHoursCalendarResponse.error
            data = marketHourGetMarketHoursCalendarResponse.data.map { it.toMutableList() }
            additionalProperties =
                marketHourGetMarketHoursCalendarResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<MarketHoursDetail>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<MarketHoursDetail>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<MarketHoursDetail>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [MarketHoursDetail] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: MarketHoursDetail) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [MarketHourGetMarketHoursCalendarResponse].
         *
         ...
         */
        fun build(): MarketHourGetMarketHoursCalendarResponse =
            MarketHourGetMarketHoursCalendarResponse(
     ...
     *   expected type.
     */
    fun validate(): MarketHourGetMarketHoursCalendarResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MarketHourGetMarketHoursCalendarResponse &&
    ...
    override fun toString() =
        "MarketHourGetMarketHoursCalendarResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
