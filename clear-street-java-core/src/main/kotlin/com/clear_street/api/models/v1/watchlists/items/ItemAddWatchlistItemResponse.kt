...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<AddWatchlistItemData> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): AddWatchlistItemData = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<AddWatchlistItemData> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ItemAddWatchlistItemResponse].
         *
    ...
    /** A builder for [ItemAddWatchlistItemResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<AddWatchlistItemData>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(itemAddWatchlistItemResponse: ItemAddWatchlistItemResponse) = apply {
            metadata = itemAddWatchlistItemResponse.metadata
            error = itemAddWatchlistItemResponse.error
            data = itemAddWatchlistItemResponse.data
            additionalProperties = itemAddWatchlistItemResponse.additionalProperties.toMutableMap()
        }
        ...
        /** Response data for adding a watchlist item */
        fun data(data: AddWatchlistItemData) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [AddWatchlistItemData] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<AddWatchlistItemData>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [ItemAddWatchlistItemResponse].
         *
         ...
         */
        fun build(): ItemAddWatchlistItemResponse =
     ...
     *   expected type.
     */
    fun validate(): ItemAddWatchlistItemResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ItemAddWatchlistItemResponse &&
    ...
    override fun toString() =
        "ItemAddWatchlistItemResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
