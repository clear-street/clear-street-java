...
class DividendGetDividendsCalendarResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<List<DividendCalendarEvent>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<DividendCalendarEvent>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<DividendCalendarEvent> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<DividendCalendarEvent>> = data
    ...
    /** A builder for [DividendGetDividendsCalendarResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<DividendCalendarEvent>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            dividendGetDividendsCalendarResponse: DividendGetDividendsCalendarResponse
        ) = apply {
            metadata = dividendGetDividendsCalendarResponse.metadata
            error = dividendGetDividendsCalendarResponse.error
            data = dividendGetDividendsCalendarResponse.data.map { it.toMutableList() }
            additionalProperties =
                dividendGetDividendsCalendarResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<DividendCalendarEvent>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<DividendCalendarEvent>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<DividendCalendarEvent>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [DividendCalendarEvent] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: DividendCalendarEvent) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [DividendGetDividendsCalendarResponse].
         *
         ...
         */
        fun build(): DividendGetDividendsCalendarResponse =
            DividendGetDividendsCalendarResponse(
    ...
    fun validate(): DividendGetDividendsCalendarResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DividendGetDividendsCalendarResponse &&
    ...
    override fun toString() =
        "DividendGetDividendsCalendarResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
