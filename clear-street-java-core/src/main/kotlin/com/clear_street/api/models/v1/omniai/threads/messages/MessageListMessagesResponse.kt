...
class MessageListMessagesResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageListMessagesResponse].
         *
    ...
    /** A builder for [MessageListMessagesResponse]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [MessageListMessagesResponse].
         *
         ...
         */
        fun build(): MessageListMessagesResponse =
    ...
    fun validate(): MessageListMessagesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageListMessagesResponse &&
    ...
    override fun toString() =
        "MessageListMessagesResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
