...
class ThreadListThreadsResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThreadListThreadsResponse].
         *
    ...
    /** A builder for [ThreadListThreadsResponse]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ThreadListThreadsResponse].
         *
         ...
         */
        fun build(): ThreadListThreadsResponse =
     ...
     *   expected type.
     */
    fun validate(): ThreadListThreadsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadListThreadsResponse &&
    ...
    override fun toString() =
        "ThreadListThreadsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
