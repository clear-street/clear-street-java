...
class MergersAcquisitionGetMergersAndAcquisitionsCalendarParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun none(): MergersAcquisitionGetMergersAndAcquisitionsCalendarParams = builder().build()
    ...
    /** A builder for [MergersAcquisitionGetMergersAndAcquisitionsCalendarParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            from = mergersAcquisitionGetMergersAndAcquisitionsCalendarParams.from
            to = mergersAcquisitionGetMergersAndAcquisitionsCalendarParams.to
            additionalHeaders =
                mergersAcquisitionGetMergersAndAcquisitionsCalendarParams.additionalHeaders
                    .toBuilder()
            additionalQueryParams =
                mergersAcquisitionGetMergersAndAcquisitionsCalendarParams.additionalQueryParams
                    .toBuilder()
        }
         ...
         */
        fun build(): MergersAcquisitionGetMergersAndAcquisitionsCalendarParams =
            MergersAcquisitionGetMergersAndAcquisitionsCalendarParams(
                from,
                to,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MergersAcquisitionGetMergersAndAcquisitionsCalendarParams &&
            from == other.from &&
            to == other.to &&
    ...
    override fun toString() =
        "MergersAcquisitionGetMergersAndAcquisitionsCalendarParams{from=$from, to=$to, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
