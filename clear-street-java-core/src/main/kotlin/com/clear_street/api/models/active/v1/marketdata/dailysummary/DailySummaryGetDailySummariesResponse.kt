...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<DailySummary>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<DailySummary> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<DailySummary>> = data
    ...
    /** A builder for [DailySummaryGetDailySummariesResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<DailySummary>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            dailySummaryGetDailySummariesResponse: DailySummaryGetDailySummariesResponse
        ) = apply {
            metadata = dailySummaryGetDailySummariesResponse.metadata
            error = dailySummaryGetDailySummariesResponse.error
            data = dailySummaryGetDailySummariesResponse.data.map { it.toMutableList() }
            additionalProperties =
                dailySummaryGetDailySummariesResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<DailySummary>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<DailySummary>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<DailySummary>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [DailySummary] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: DailySummary) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [DailySummaryGetDailySummariesResponse].
         *
         ...
         */
        fun build(): DailySummaryGetDailySummariesResponse =
            DailySummaryGetDailySummariesResponse(
    ...
    fun validate(): DailySummaryGetDailySummariesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DailySummaryGetDailySummariesResponse &&
    ...
    override fun toString() =
        "DailySummaryGetDailySummariesResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
