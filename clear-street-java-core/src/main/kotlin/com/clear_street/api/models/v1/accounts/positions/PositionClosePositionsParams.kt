...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PositionClosePositionsParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [PositionClosePositionsParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PositionClosePositionsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(positionClosePositionsParams: PositionClosePositionsParams) = apply {
            accountId = positionClosePositionsParams.accountId
            body = positionClosePositionsParams.body.toBuilder()
            additionalHeaders = positionClosePositionsParams.additionalHeaders.toBuilder()
            additionalQueryParams = positionClosePositionsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PositionClosePositionsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PositionClosePositionsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PositionClosePositionsParams &&
    ...
    override fun toString() =
        "PositionClosePositionsParams{accountId=$accountId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
