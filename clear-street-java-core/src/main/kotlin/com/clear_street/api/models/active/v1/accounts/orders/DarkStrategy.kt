...
private constructor(
    ...
    ) : this(endAt, startAt, urgency, maxPercent, mutableMapOf())
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [DarkStrategy]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DarkStrategy]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(darkStrategy: DarkStrategy) = apply {
            endAt = darkStrategy.endAt
            startAt = darkStrategy.startAt
            urgency = darkStrategy.urgency
            maxPercent = darkStrategy.maxPercent
            additionalProperties = darkStrategy.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DarkStrategy].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DarkStrategy =
            DarkStrategy(endAt, startAt, urgency, maxPercent, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): DarkStrategy = apply {
        if (validated) {
            return@apply
        }
    ...
    private val hashCode: Int by lazy {
        Objects.hash(endAt, startAt, urgency, maxPercent, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "DarkStrategy{endAt=$endAt, startAt=$startAt, urgency=$urgency, maxPercent=$maxPercent, additionalProperties=$additionalProperties}"
}
