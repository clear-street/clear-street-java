...
import com.clear_street.api.models.v1.omniai.ContentPartChartPayload
import com.clear_street.api.models.v1.omniai.ContentPartCustomPayload
import com.clear_street.api.models.v1.omniai.ContentPartStructuredActionPayload
import com.clear_street.api.models.v1.omniai.ContentPartSuggestedActionsPayload
import com.clear_street.api.models.v1.omniai.ContentPartTextPayload
import com.clear_street.api.models.v1.omniai.ContentPartThinkingPayload
...
private constructor(
    ...
    override fun toString(): String =
        when {
            unionMember0 != null -> "ResponseContentPart{unionMember0=$unionMember0}"
            unionMember1 != null -> "ResponseContentPart{unionMember1=$unionMember1}"
            unionMember2 != null -> "ResponseContentPart{unionMember2=$unionMember2}"
            unionMember3 != null -> "ResponseContentPart{unionMember3=$unionMember3}"
            unionMember4 != null -> "ResponseContentPart{unionMember4=$unionMember4}"
            unionMember5 != null -> "ResponseContentPart{unionMember5=$unionMember5}"
    ...
    companion object {
        ...
        fun ofUnionMember1(unionMember1: UnionMember1) =
            ResponseContentPart(unionMember1 = unionMember1)

        /** Structured action content part. */
        @JvmStatic
        fun ofUnionMember2(unionMember2: UnionMember2) =
            ResponseContentPart(unionMember2 = unionMember2)

        /** Chart payload content part. */
        @JvmStatic
        fun ofUnionMember3(unionMember3: UnionMember3) =
            ResponseContentPart(unionMember3 = unionMember3)

        /** Suggested actions payload content part. */
        @JvmStatic
        fun ofUnionMember4(unionMember4: UnionMember4) =
            ResponseContentPart(unionMember4 = unionMember4)

        /** Escape-hatch custom payload content part. */
        @JvmStatic
        fun ofUnionMember5(unionMember5: UnionMember5) =
            ResponseContentPart(unionMember5 = unionMember5)
    }
            ...
            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<UnionMember0>())?.let {
                            ResponseContentPart(unionMember0 = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<UnionMember1>())?.let {
                            ResponseContentPart(unionMember1 = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<UnionMember2>())?.let {
                            ResponseContentPart(unionMember2 = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<UnionMember3>())?.let {
                            ResponseContentPart(unionMember3 = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<UnionMember4>())?.let {
                            ResponseContentPart(unionMember4 = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<UnionMember5>())?.let {
                            ResponseContentPart(unionMember5 = it, _json = json)
                        },
                    )
                    .filterNotNull()
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(unionMember1: UnionMember1) = apply {
                thoughts = unionMember1.thoughts.map { it.toMutableList() }
        ...
        override fun toString() =
            "UnionMember1{thoughts=$thoughts, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(unionMember2: UnionMember2) = apply {
                action = unionMember2.action
                actionId = unionMember2.actionId
        ...
        override fun toString() =
            "UnionMember2{action=$action, actionId=$actionId, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
         ...
         * ```java
         * MyClass myObject = unionMember5.payload().convert(MyClass.class);
         * ```
         */
        ...
        override fun toString() =
            "UnionMember5{payload=$payload, type=$type, additionalProperties=$additionalProperties}"
    }
}
