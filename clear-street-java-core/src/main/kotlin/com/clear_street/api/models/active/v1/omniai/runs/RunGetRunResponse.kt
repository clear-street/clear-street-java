...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RunGetRunResponse].
         *
    ...
    /** A builder for [RunGetRunResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(runGetRunResponse: RunGetRunResponse) = apply {
            metadata = runGetRunResponse.metadata
            error = runGetRunResponse.error
            data = runGetRunResponse.data
            additionalProperties = runGetRunResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RunGetRunResponse].
         *
    ...
    fun validate(): RunGetRunResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunGetRunResponse &&
    ...
    override fun toString() =
        "RunGetRunResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
