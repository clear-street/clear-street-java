...
private constructor(
    ...
    /** A builder for [ClockGetClockResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(clockGetClockResponse: ClockGetClockResponse) = apply {
            metadata = clockGetClockResponse.metadata
            error = clockGetClockResponse.error
            data = clockGetClockResponse.data
            additionalProperties = clockGetClockResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ClockGetClockResponse].
         *
         ...
         */
        fun build(): ClockGetClockResponse =
    ...
    fun validate(): ClockGetClockResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClockGetClockResponse &&
    ...
    override fun toString() =
        "ClockGetClockResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
