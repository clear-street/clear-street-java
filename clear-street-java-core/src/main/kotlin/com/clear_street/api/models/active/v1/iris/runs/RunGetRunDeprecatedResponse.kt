...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<GetRunResponse> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): GetRunResponse = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<GetRunResponse> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RunGetRunDeprecatedResponse].
         *
    ...
    /** A builder for [RunGetRunDeprecatedResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<GetRunResponse>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(runGetRunDeprecatedResponse: RunGetRunDeprecatedResponse) = apply {
            metadata = runGetRunDeprecatedResponse.metadata
            error = runGetRunDeprecatedResponse.error
            data = runGetRunDeprecatedResponse.data
            additionalProperties = runGetRunDeprecatedResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: GetRunResponse) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [GetRunResponse] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<GetRunResponse>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [RunGetRunDeprecatedResponse].
         *
         ...
         */
        fun build(): RunGetRunDeprecatedResponse =
    ...
    fun validate(): RunGetRunDeprecatedResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunGetRunDeprecatedResponse &&
    ...
    override fun toString() =
        "RunGetRunDeprecatedResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
