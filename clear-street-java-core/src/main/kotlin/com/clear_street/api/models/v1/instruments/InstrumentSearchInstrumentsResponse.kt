...
private constructor(
    ...
    private val data: JsonField<List<InstrumentCore>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<InstrumentCore>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<InstrumentCore> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<InstrumentCore>> = data
    ...
    /** A builder for [InstrumentSearchInstrumentsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<InstrumentCore>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            instrumentSearchInstrumentsResponse: InstrumentSearchInstrumentsResponse
        ) = apply {
            metadata = instrumentSearchInstrumentsResponse.metadata
            error = instrumentSearchInstrumentsResponse.error
            data = instrumentSearchInstrumentsResponse.data.map { it.toMutableList() }
            additionalProperties =
                instrumentSearchInstrumentsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<InstrumentCore>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<InstrumentCore>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<InstrumentCore>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [InstrumentCore] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: InstrumentCore) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [InstrumentSearchInstrumentsResponse].
         *
         ...
         */
        fun build(): InstrumentSearchInstrumentsResponse =
            InstrumentSearchInstrumentsResponse(
     ...
     *   expected type.
     */
    fun validate(): InstrumentSearchInstrumentsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentSearchInstrumentsResponse &&
    ...
    override fun toString() =
        "InstrumentSearchInstrumentsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
