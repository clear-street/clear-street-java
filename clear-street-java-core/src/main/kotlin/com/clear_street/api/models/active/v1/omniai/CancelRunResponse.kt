...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CancelRunResponse].
         *
    ...
    /** A builder for [CancelRunResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(cancelRunResponse: CancelRunResponse) = apply {
            canceled = cancelRunResponse.canceled
            additionalProperties = cancelRunResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CancelRunResponse].
         *
    ...
    fun validate(): CancelRunResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CancelRunResponse &&
    ...
    override fun toString() =
        "CancelRunResponse{canceled=$canceled, additionalProperties=$additionalProperties}"
}
