...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageGetMessagesParams].
         *
    ...
    /** A builder for [MessageGetMessagesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageGetMessagesParams: MessageGetMessagesParams) = apply {
            threadId = messageGetMessagesParams.threadId
            accountId = messageGetMessagesParams.accountId
            pageSize = messageGetMessagesParams.pageSize
            pageToken = messageGetMessagesParams.pageToken
            additionalHeaders = messageGetMessagesParams.additionalHeaders.toBuilder()
            additionalQueryParams = messageGetMessagesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MessageGetMessagesParams].
         *
         ...
         */
        fun build(): MessageGetMessagesParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageGetMessagesParams &&
    ...
    override fun toString() =
        "MessageGetMessagesParams{threadId=$threadId, accountId=$accountId, pageSize=$pageSize, pageToken=$pageToken, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
