...
class EventGetInstrumentEventsResponse
...
private constructor(
    ...
    /** A builder for [EventGetInstrumentEventsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eventGetInstrumentEventsResponse: EventGetInstrumentEventsResponse) =
            apply {
                metadata = eventGetInstrumentEventsResponse.metadata
                error = eventGetInstrumentEventsResponse.error
                data = eventGetInstrumentEventsResponse.data
                additionalProperties =
                    eventGetInstrumentEventsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EventGetInstrumentEventsResponse].
         *
         ...
         */
        fun build(): EventGetInstrumentEventsResponse =
            EventGetInstrumentEventsResponse(
    ...
    fun validate(): EventGetInstrumentEventsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventGetInstrumentEventsResponse &&
    ...
    override fun toString() =
        "EventGetInstrumentEventsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
