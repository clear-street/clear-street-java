...
class FeedbackCreateFeedbackDeprecatedResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<CreateFeedbackResponse>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<CreateFeedbackResponse> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): CreateFeedbackResponse = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CreateFeedbackResponse> = data
    ...
    /** A builder for [FeedbackCreateFeedbackDeprecatedResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<CreateFeedbackResponse>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            feedbackCreateFeedbackDeprecatedResponse: FeedbackCreateFeedbackDeprecatedResponse
        ) = apply {
            metadata = feedbackCreateFeedbackDeprecatedResponse.metadata
            error = feedbackCreateFeedbackDeprecatedResponse.error
            data = feedbackCreateFeedbackDeprecatedResponse.data
            additionalProperties =
                feedbackCreateFeedbackDeprecatedResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: CreateFeedbackResponse) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [CreateFeedbackResponse] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<CreateFeedbackResponse>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [FeedbackCreateFeedbackDeprecatedResponse].
         *
         ...
         */
        fun build(): FeedbackCreateFeedbackDeprecatedResponse =
            FeedbackCreateFeedbackDeprecatedResponse(
    ...
    fun validate(): FeedbackCreateFeedbackDeprecatedResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeedbackCreateFeedbackDeprecatedResponse &&
    ...
    override fun toString() =
        "FeedbackCreateFeedbackDeprecatedResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
