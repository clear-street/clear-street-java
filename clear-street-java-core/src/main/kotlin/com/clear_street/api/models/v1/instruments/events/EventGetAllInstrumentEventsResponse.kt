...
class EventGetAllInstrumentEventsResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<InstrumentAllEventsData>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<InstrumentAllEventsData> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): InstrumentAllEventsData = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<InstrumentAllEventsData> = data
    ...
    /** A builder for [EventGetAllInstrumentEventsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<InstrumentAllEventsData>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            eventGetAllInstrumentEventsResponse: EventGetAllInstrumentEventsResponse
        ) = apply {
            metadata = eventGetAllInstrumentEventsResponse.metadata
            error = eventGetAllInstrumentEventsResponse.error
            data = eventGetAllInstrumentEventsResponse.data
            additionalProperties =
                eventGetAllInstrumentEventsResponse.additionalProperties.toMutableMap()
        }
        ...
        /** All-events payload grouped by date. */
        fun data(data: InstrumentAllEventsData) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [InstrumentAllEventsData] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<InstrumentAllEventsData>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [EventGetAllInstrumentEventsResponse].
         *
         ...
         */
        fun build(): EventGetAllInstrumentEventsResponse =
            EventGetAllInstrumentEventsResponse(
    ...
    fun validate(): EventGetAllInstrumentEventsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventGetAllInstrumentEventsResponse &&
    ...
    override fun toString() =
        "EventGetAllInstrumentEventsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
