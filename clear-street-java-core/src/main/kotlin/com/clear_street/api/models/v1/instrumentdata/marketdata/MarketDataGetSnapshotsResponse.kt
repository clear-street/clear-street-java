...
private constructor(
    ...
    /** A builder for [MarketDataGetSnapshotsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(marketDataGetSnapshotsResponse: MarketDataGetSnapshotsResponse) = apply {
            metadata = marketDataGetSnapshotsResponse.metadata
            error = marketDataGetSnapshotsResponse.error
            data = marketDataGetSnapshotsResponse.data.map { it.toMutableList() }
            additionalProperties =
                marketDataGetSnapshotsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MarketDataGetSnapshotsResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): MarketDataGetSnapshotsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MarketDataGetSnapshotsResponse &&
    ...
    override fun toString() =
        "MarketDataGetSnapshotsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
