...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<AccountBalances> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): AccountBalances = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<AccountBalances> = data
    ...
    /** A builder for [BalanceGetAccountBalancesResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<AccountBalances>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(balanceGetAccountBalancesResponse: BalanceGetAccountBalancesResponse) =
            apply {
                metadata = balanceGetAccountBalancesResponse.metadata
                error = balanceGetAccountBalancesResponse.error
                data = balanceGetAccountBalancesResponse.data
                additionalProperties =
                    balanceGetAccountBalancesResponse.additionalProperties.toMutableMap()
            }
        ...
        /** Represents the balance details for a trading account */
        fun data(data: AccountBalances) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [AccountBalances] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<AccountBalances>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [BalanceGetAccountBalancesResponse].
         *
         ...
         */
        fun build(): BalanceGetAccountBalancesResponse =
            BalanceGetAccountBalancesResponse(
    ...
    fun validate(): BalanceGetAccountBalancesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BalanceGetAccountBalancesResponse &&
    ...
    override fun toString() =
        "BalanceGetAccountBalancesResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
