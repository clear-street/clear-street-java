...
private constructor(
    ...
    /** A builder for [InstrumentDataGetInstrumentAnalystConsensusResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            metadata = instrumentDataGetInstrumentAnalystConsensusResponse.metadata
            error = instrumentDataGetInstrumentAnalystConsensusResponse.error
            data = instrumentDataGetInstrumentAnalystConsensusResponse.data
            additionalProperties =
                instrumentDataGetInstrumentAnalystConsensusResponse.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InstrumentDataGetInstrumentAnalystConsensusResponse].
         *
         ...
         */
        fun build(): InstrumentDataGetInstrumentAnalystConsensusResponse =
            InstrumentDataGetInstrumentAnalystConsensusResponse(
     ...
     *   expected type.
     */
    fun validate(): InstrumentDataGetInstrumentAnalystConsensusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentDataGetInstrumentAnalystConsensusResponse &&
    ...
    override fun toString() =
        "InstrumentDataGetInstrumentAnalystConsensusResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
