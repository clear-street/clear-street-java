...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThreadGetThreadsResponse].
         *
    ...
    /** A builder for [ThreadGetThreadsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(threadGetThreadsResponse: ThreadGetThreadsResponse) = apply {
            metadata = threadGetThreadsResponse.metadata
            error = threadGetThreadsResponse.error
            data = threadGetThreadsResponse.data.map { it.toMutableList() }
            additionalProperties = threadGetThreadsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ThreadGetThreadsResponse].
         *
         ...
         */
        fun build(): ThreadGetThreadsResponse =
     ...
     *   expected type.
     */
    fun validate(): ThreadGetThreadsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadGetThreadsResponse &&
    ...
    override fun toString() =
        "ThreadGetThreadsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
