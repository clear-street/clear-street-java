...
class MessageListMessagesDeprecatedResponse
...
private constructor(
    ...
    /** A builder for [MessageListMessagesDeprecatedResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            messageListMessagesDeprecatedResponse: MessageListMessagesDeprecatedResponse
        ) = apply {
            metadata = messageListMessagesDeprecatedResponse.metadata
            error = messageListMessagesDeprecatedResponse.error
            data = messageListMessagesDeprecatedResponse.data
            additionalProperties =
                messageListMessagesDeprecatedResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageListMessagesDeprecatedResponse].
         *
         ...
         */
        fun build(): MessageListMessagesDeprecatedResponse =
            MessageListMessagesDeprecatedResponse(
    ...
    fun validate(): MessageListMessagesDeprecatedResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageListMessagesDeprecatedResponse &&
    ...
    override fun toString() =
        "MessageListMessagesDeprecatedResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
