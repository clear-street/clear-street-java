...
private constructor(
    ...
    private val data: JsonField<WatchlistEntry>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<WatchlistEntry> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): WatchlistEntry = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<WatchlistEntry> = data
    ...
    /** A builder for [WatchlistCreateWatchlistResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<WatchlistEntry>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(watchlistCreateWatchlistResponse: WatchlistCreateWatchlistResponse) =
            apply {
                metadata = watchlistCreateWatchlistResponse.metadata
                error = watchlistCreateWatchlistResponse.error
                data = watchlistCreateWatchlistResponse.data
                additionalProperties =
                    watchlistCreateWatchlistResponse.additionalProperties.toMutableMap()
            }
        ...
        /** Represents a user watchlist. */
        fun data(data: WatchlistEntry) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [WatchlistEntry] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<WatchlistEntry>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [WatchlistCreateWatchlistResponse].
         *
         ...
         */
        fun build(): WatchlistCreateWatchlistResponse =
            WatchlistCreateWatchlistResponse(
     ...
     *   expected type.
     */
    fun validate(): WatchlistCreateWatchlistResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WatchlistCreateWatchlistResponse &&
    ...
    override fun toString() =
        "WatchlistCreateWatchlistResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
