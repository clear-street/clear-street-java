...
class LocateGetLocateRequestsResponse
...
private constructor(
    ...
    /** A builder for [LocateGetLocateRequestsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(locateGetLocateRequestsResponse: LocateGetLocateRequestsResponse) =
            apply {
                metadata = locateGetLocateRequestsResponse.metadata
                error = locateGetLocateRequestsResponse.error
                data = locateGetLocateRequestsResponse.data.map { it.toMutableList() }
                additionalProperties =
                    locateGetLocateRequestsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [LocateGetLocateRequestsResponse].
         *
         ...
         */
        fun build(): LocateGetLocateRequestsResponse =
            LocateGetLocateRequestsResponse(
    ...
    fun validate(): LocateGetLocateRequestsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LocateGetLocateRequestsResponse &&
    ...
    override fun toString() =
        "LocateGetLocateRequestsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
