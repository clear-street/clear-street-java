...
private constructor(
    ...
    /** A builder for [MarketDataGetDailySummariesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            marketDataGetDailySummariesResponse: MarketDataGetDailySummariesResponse
        ) = apply {
            metadata = marketDataGetDailySummariesResponse.metadata
            error = marketDataGetDailySummariesResponse.error
            data = marketDataGetDailySummariesResponse.data.map { it.toMutableList() }
            additionalProperties =
                marketDataGetDailySummariesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MarketDataGetDailySummariesResponse].
         *
         ...
         */
        fun build(): MarketDataGetDailySummariesResponse =
            MarketDataGetDailySummariesResponse(
     ...
     *   expected type.
     */
    fun validate(): MarketDataGetDailySummariesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MarketDataGetDailySummariesResponse &&
    ...
    override fun toString() =
        "MarketDataGetDailySummariesResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
