...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThreadResponseResponse].
         *
    ...
    /** A builder for [ThreadResponseResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(threadResponseResponse: ThreadResponseResponse) = apply {
            metadata = threadResponseResponse.metadata
            error = threadResponseResponse.error
            data = threadResponseResponse.data
            additionalProperties = threadResponseResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ThreadResponseResponse].
         *
         ...
         */
        fun build(): ThreadResponseResponse =
    ...
    fun validate(): ThreadResponseResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadResponseResponse &&
    ...
    override fun toString() =
        "ThreadResponseResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
