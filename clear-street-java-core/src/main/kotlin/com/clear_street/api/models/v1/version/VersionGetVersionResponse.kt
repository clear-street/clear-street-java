...
class VersionGetVersionResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VersionGetVersionResponse].
         *
    ...
    /** A builder for [VersionGetVersionResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(versionGetVersionResponse: VersionGetVersionResponse) = apply {
            metadata = versionGetVersionResponse.metadata
            error = versionGetVersionResponse.error
            data = versionGetVersionResponse.data
            additionalProperties = versionGetVersionResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VersionGetVersionResponse].
         *
         ...
         */
        fun build(): VersionGetVersionResponse =
     ...
     *   expected type.
     */
    fun validate(): VersionGetVersionResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VersionGetVersionResponse &&
    ...
    override fun toString() =
        "VersionGetVersionResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
