...
class VersionUpdateVersionResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VersionUpdateVersionResponse].
         *
    ...
    /** A builder for [VersionUpdateVersionResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(versionUpdateVersionResponse: VersionUpdateVersionResponse) = apply {
            metadata = versionUpdateVersionResponse.metadata
            error = versionUpdateVersionResponse.error
            data = versionUpdateVersionResponse.data
            additionalProperties = versionUpdateVersionResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [VersionUpdateVersionResponse].
         *
         ...
         */
        fun build(): VersionUpdateVersionResponse =
    ...
    fun validate(): VersionUpdateVersionResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VersionUpdateVersionResponse &&
    ...
    override fun toString() =
        "VersionUpdateVersionResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
