...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [SorStrategy]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SorStrategy]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(sorStrategy: SorStrategy) = apply {
            endAt = sorStrategy.endAt
            startAt = sorStrategy.startAt
            urgency = sorStrategy.urgency
            additionalProperties = sorStrategy.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SorStrategy].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SorStrategy =
            SorStrategy(endAt, startAt, urgency, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): SorStrategy = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "SorStrategy{endAt=$endAt, startAt=$startAt, urgency=$urgency, additionalProperties=$additionalProperties}"
}
