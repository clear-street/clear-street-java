...
private constructor(
    ...
    private val data: JsonField<ClockDetail>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<ClockDetail> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): ClockDetail = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<ClockDetail> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CalendarGetClockResponse].
         *
    ...
    /** A builder for [CalendarGetClockResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<ClockDetail>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(calendarGetClockResponse: CalendarGetClockResponse) = apply {
            metadata = calendarGetClockResponse.metadata
            error = calendarGetClockResponse.error
            data = calendarGetClockResponse.data
            additionalProperties = calendarGetClockResponse.additionalProperties.toMutableMap()
        }
        ...
        /** Current server time and market clock information */
        fun data(data: ClockDetail) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [ClockDetail] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<ClockDetail>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [CalendarGetClockResponse].
         *
         ...
         */
        fun build(): CalendarGetClockResponse =
     ...
     *   expected type.
     */
    fun validate(): CalendarGetClockResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CalendarGetClockResponse &&
    ...
    override fun toString() =
        "CalendarGetClockResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
