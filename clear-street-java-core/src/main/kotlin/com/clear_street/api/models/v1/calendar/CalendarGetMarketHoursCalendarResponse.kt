...
private constructor(
    ...
    /** A builder for [CalendarGetMarketHoursCalendarResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            calendarGetMarketHoursCalendarResponse: CalendarGetMarketHoursCalendarResponse
        ) = apply {
            metadata = calendarGetMarketHoursCalendarResponse.metadata
            error = calendarGetMarketHoursCalendarResponse.error
            data = calendarGetMarketHoursCalendarResponse.data.map { it.toMutableList() }
            additionalProperties =
                calendarGetMarketHoursCalendarResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CalendarGetMarketHoursCalendarResponse].
         *
         ...
         */
        fun build(): CalendarGetMarketHoursCalendarResponse =
            CalendarGetMarketHoursCalendarResponse(
     ...
     *   expected type.
     */
    fun validate(): CalendarGetMarketHoursCalendarResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CalendarGetMarketHoursCalendarResponse &&
    ...
    override fun toString() =
        "CalendarGetMarketHoursCalendarResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
