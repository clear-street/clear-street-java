...
private constructor(
    ...
    private val data: JsonField<InstrumentEventsData>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<InstrumentEventsData> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): InstrumentEventsData = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<InstrumentEventsData> = data
    ...
    /** A builder for [InstrumentDataGetInstrumentEventsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<InstrumentEventsData>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            instrumentDataGetInstrumentEventsResponse: InstrumentDataGetInstrumentEventsResponse
        ) = apply {
            metadata = instrumentDataGetInstrumentEventsResponse.metadata
            error = instrumentDataGetInstrumentEventsResponse.error
            data = instrumentDataGetInstrumentEventsResponse.data
            additionalProperties =
                instrumentDataGetInstrumentEventsResponse.additionalProperties.toMutableMap()
        }
        ...
        /** Grouped instrument events by type */
        fun data(data: InstrumentEventsData) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [InstrumentEventsData] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<InstrumentEventsData>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [InstrumentDataGetInstrumentEventsResponse].
         *
         ...
         */
        fun build(): InstrumentDataGetInstrumentEventsResponse =
            InstrumentDataGetInstrumentEventsResponse(
     ...
     *   expected type.
     */
    fun validate(): InstrumentDataGetInstrumentEventsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentDataGetInstrumentEventsResponse &&
    ...
    override fun toString() =
        "InstrumentDataGetInstrumentEventsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
