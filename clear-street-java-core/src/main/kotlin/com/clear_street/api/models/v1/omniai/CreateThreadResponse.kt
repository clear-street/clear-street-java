...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreateThreadResponse].
         *
    ...
    /** A builder for [CreateThreadResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(createThreadResponse: CreateThreadResponse) = apply {
            responseId = createThreadResponse.responseId
            threadId = createThreadResponse.threadId
            userMessageId = createThreadResponse.userMessageId
            additionalProperties = createThreadResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CreateThreadResponse].
         *
         ...
         */
        fun build(): CreateThreadResponse =
     ...
     *   expected type.
     */
    fun validate(): CreateThreadResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreateThreadResponse &&
    ...
    override fun toString() =
        "CreateThreadResponse{responseId=$responseId, threadId=$threadId, userMessageId=$userMessageId, additionalProperties=$additionalProperties}"
}
