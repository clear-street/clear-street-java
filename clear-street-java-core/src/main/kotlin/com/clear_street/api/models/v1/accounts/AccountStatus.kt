...
/** Account status */
class AccountStatus @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    enum class Value {
        ...
        CLOSED,
        /**
         * An enum member indicating that [AccountStatus] was instantiated with an unknown value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            CLOSED -> Known.CLOSED
            else -> throw ClearStreetInvalidDataException("Unknown AccountStatus: $value")
        }
