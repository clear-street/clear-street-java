...
class MarketType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmStatic fun of(value: String) = MarketType(JsonField.of(value))
    }

    /** An enum containing [MarketType]'s known values. */
    enum class Known {
        US_EQUITIES,
        US_OPTIONS,
    }
    ...
    /**
     * An enum containing [MarketType]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [MarketType] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        US_EQUITIES,
        US_OPTIONS,
        /** An enum member indicating that [MarketType] was instantiated with an unknown value. */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw ClearStreetInvalidDataException("Unknown MarketType: $value")
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MarketType && value == other.value
    }
