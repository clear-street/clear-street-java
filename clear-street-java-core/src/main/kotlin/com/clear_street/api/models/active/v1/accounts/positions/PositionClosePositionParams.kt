...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(positionClosePositionParams: PositionClosePositionParams) = apply {
            ...
            securityIdSource = positionClosePositionParams.securityIdSource
            securityId = positionClosePositionParams.securityId
    ...
    override fun toString() =
        "PositionClosePositionParams{accountId=$accountId, securityIdSource=$securityIdSource, securityId=$securityId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
