...
private constructor(
    ...
    /** A builder for [InstrumentDataGetInstrumentIncomeStatementsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            metadata = instrumentDataGetInstrumentIncomeStatementsResponse.metadata
            error = instrumentDataGetInstrumentIncomeStatementsResponse.error
            data =
                instrumentDataGetInstrumentIncomeStatementsResponse.data.map { it.toMutableList() }
            additionalProperties =
                instrumentDataGetInstrumentIncomeStatementsResponse.additionalProperties
                    .toMutableMap()
        }
     ...
     *   expected type.
     */
    fun validate(): InstrumentDataGetInstrumentIncomeStatementsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentDataGetInstrumentIncomeStatementsResponse &&
    ...
    override fun toString() =
        "InstrumentDataGetInstrumentIncomeStatementsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
