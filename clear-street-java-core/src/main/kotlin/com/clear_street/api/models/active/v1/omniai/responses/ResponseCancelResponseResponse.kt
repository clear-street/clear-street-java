...
package com.clear_street.api.models.active.v1.omniai.responses
...
import com.clear_street.api.models.active.v1.omniai.CancelResponsePayload
...
private constructor(
    ...
    private val data: JsonField<CancelResponsePayload>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<CancelResponsePayload> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): CancelResponsePayload = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CancelResponsePayload> = data
    ...
    /** A builder for [ResponseCancelResponseResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<CancelResponsePayload>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(responseCancelResponseResponse: ResponseCancelResponseResponse) = apply {
            metadata = responseCancelResponseResponse.metadata
            error = responseCancelResponseResponse.error
            data = responseCancelResponseResponse.data
            additionalProperties =
                responseCancelResponseResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: CancelResponsePayload) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [CancelResponsePayload] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<CancelResponsePayload>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [ResponseCancelResponseResponse].
         *
         ...
         */
        fun build(): ResponseCancelResponseResponse =
            ResponseCancelResponseResponse(
    ...
    fun validate(): ResponseCancelResponseResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseCancelResponseResponse &&
    ...
    override fun toString() =
        "ResponseCancelResponseResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
