...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<CancelRunResponse> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): CancelRunResponse = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CancelRunResponse> = data
    ...
    /** A builder for [RunCancelRunDeprecatedResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<CancelRunResponse>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(runCancelRunDeprecatedResponse: RunCancelRunDeprecatedResponse) = apply {
            metadata = runCancelRunDeprecatedResponse.metadata
            error = runCancelRunDeprecatedResponse.error
            data = runCancelRunDeprecatedResponse.data
            additionalProperties =
                runCancelRunDeprecatedResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: CancelRunResponse) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [CancelRunResponse] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<CancelRunResponse>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [RunCancelRunDeprecatedResponse].
         *
         ...
         */
        fun build(): RunCancelRunDeprecatedResponse =
            RunCancelRunDeprecatedResponse(
    ...
    fun validate(): RunCancelRunDeprecatedResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunCancelRunDeprecatedResponse &&
    ...
    override fun toString() =
        "RunCancelRunDeprecatedResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
