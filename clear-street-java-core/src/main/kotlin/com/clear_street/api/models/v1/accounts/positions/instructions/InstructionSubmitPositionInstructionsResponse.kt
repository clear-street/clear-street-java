...
class InstructionSubmitPositionInstructionsResponse
...
private constructor(
    ...
    /** A builder for [InstructionSubmitPositionInstructionsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            metadata = instructionSubmitPositionInstructionsResponse.metadata
            error = instructionSubmitPositionInstructionsResponse.error
            data = instructionSubmitPositionInstructionsResponse.data.map { it.toMutableList() }
            additionalProperties =
                instructionSubmitPositionInstructionsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InstructionSubmitPositionInstructionsResponse].
         *
         ...
         */
        fun build(): InstructionSubmitPositionInstructionsResponse =
            InstructionSubmitPositionInstructionsResponse(
     ...
     *   expected type.
     */
    fun validate(): InstructionSubmitPositionInstructionsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstructionSubmitPositionInstructionsResponse &&
    ...
    override fun toString() =
        "InstructionSubmitPositionInstructionsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
