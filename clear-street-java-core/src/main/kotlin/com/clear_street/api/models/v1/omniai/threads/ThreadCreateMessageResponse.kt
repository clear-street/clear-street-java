...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThreadCreateMessageResponse].
         *
    ...
    /** A builder for [ThreadCreateMessageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(threadCreateMessageResponse: ThreadCreateMessageResponse) = apply {
            metadata = threadCreateMessageResponse.metadata
            error = threadCreateMessageResponse.error
            data = threadCreateMessageResponse.data
            additionalProperties = threadCreateMessageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ThreadCreateMessageResponse].
         *
         ...
         */
        fun build(): ThreadCreateMessageResponse =
     ...
     *   expected type.
     */
    fun validate(): ThreadCreateMessageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadCreateMessageResponse &&
    ...
    override fun toString() =
        "ThreadCreateMessageResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
