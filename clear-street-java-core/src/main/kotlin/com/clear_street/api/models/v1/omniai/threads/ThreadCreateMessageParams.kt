...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThreadCreateMessageParams].
         *
    ...
    /** A builder for [ThreadCreateMessageParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(threadCreateMessageParams: ThreadCreateMessageParams) = apply {
            threadId = threadCreateMessageParams.threadId
            body = threadCreateMessageParams.body.toBuilder()
            additionalHeaders = threadCreateMessageParams.additionalHeaders.toBuilder()
            additionalQueryParams = threadCreateMessageParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ThreadCreateMessageParams].
         *
         ...
         */
        fun build(): ThreadCreateMessageParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadCreateMessageParams &&
    ...
    override fun toString() =
        "ThreadCreateMessageParams{threadId=$threadId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
