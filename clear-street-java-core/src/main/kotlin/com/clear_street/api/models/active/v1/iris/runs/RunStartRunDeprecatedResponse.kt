...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<StartRunResponse> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): StartRunResponse = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<StartRunResponse> = data
    ...
    /** A builder for [RunStartRunDeprecatedResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<StartRunResponse>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(runStartRunDeprecatedResponse: RunStartRunDeprecatedResponse) = apply {
            metadata = runStartRunDeprecatedResponse.metadata
            error = runStartRunDeprecatedResponse.error
            data = runStartRunDeprecatedResponse.data
            additionalProperties = runStartRunDeprecatedResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: StartRunResponse) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [StartRunResponse] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<StartRunResponse>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [RunStartRunDeprecatedResponse].
         *
         ...
         */
        fun build(): RunStartRunDeprecatedResponse =
            RunStartRunDeprecatedResponse(
    ...
    fun validate(): RunStartRunDeprecatedResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunStartRunDeprecatedResponse &&
    ...
    override fun toString() =
        "RunStartRunDeprecatedResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
