...
class SummaryGetCalendarSummaryParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SummaryGetCalendarSummaryParams = builder().build()
    ...
    /** A builder for [SummaryGetCalendarSummaryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(summaryGetCalendarSummaryParams: SummaryGetCalendarSummaryParams) =
            apply {
                from = summaryGetCalendarSummaryParams.from
                to = summaryGetCalendarSummaryParams.to
                additionalHeaders = summaryGetCalendarSummaryParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    summaryGetCalendarSummaryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SummaryGetCalendarSummaryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SummaryGetCalendarSummaryParams =
            SummaryGetCalendarSummaryParams(
                from,
                to,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SummaryGetCalendarSummaryParams &&
            from == other.from &&
            to == other.to &&
    ...
    override fun toString() =
        "SummaryGetCalendarSummaryParams{from=$from, to=$to, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
