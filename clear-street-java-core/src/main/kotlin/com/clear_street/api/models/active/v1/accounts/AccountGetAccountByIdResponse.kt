...
private constructor(
    ...
    /** A builder for [AccountGetAccountByIdResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(accountGetAccountByIdResponse: AccountGetAccountByIdResponse) = apply {
            metadata = accountGetAccountByIdResponse.metadata
            error = accountGetAccountByIdResponse.error
            data = accountGetAccountByIdResponse.data
            additionalProperties = accountGetAccountByIdResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AccountGetAccountByIdResponse].
         *
         ...
         */
        fun build(): AccountGetAccountByIdResponse =
            AccountGetAccountByIdResponse(
    ...
    fun validate(): AccountGetAccountByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountGetAccountByIdResponse &&
    ...
    override fun toString() =
        "AccountGetAccountByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
