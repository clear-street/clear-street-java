...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Venue>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<Venue> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Venue>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [VenueGetVenuesResponse].
         *
    ...
    /** A builder for [VenueGetVenuesResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<Venue>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(venueGetVenuesResponse: VenueGetVenuesResponse) = apply {
            metadata = venueGetVenuesResponse.metadata
            error = venueGetVenuesResponse.error
            data = venueGetVenuesResponse.data.map { it.toMutableList() }
            additionalProperties = venueGetVenuesResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<Venue>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Venue>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Venue>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Venue] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Venue) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [VenueGetVenuesResponse].
         *
         ...
         */
        fun build(): VenueGetVenuesResponse =
    ...
    fun validate(): VenueGetVenuesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VenueGetVenuesResponse &&
    ...
    override fun toString() =
        "VenueGetVenuesResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
