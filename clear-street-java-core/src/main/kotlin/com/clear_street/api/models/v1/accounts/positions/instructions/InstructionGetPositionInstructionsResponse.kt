...
class InstructionGetPositionInstructionsResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<List<PositionInstruction>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<PositionInstruction>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<PositionInstruction> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<PositionInstruction>> = data
    ...
    /** A builder for [InstructionGetPositionInstructionsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<PositionInstruction>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            instructionGetPositionInstructionsResponse: InstructionGetPositionInstructionsResponse
        ) = apply {
            metadata = instructionGetPositionInstructionsResponse.metadata
            error = instructionGetPositionInstructionsResponse.error
            data = instructionGetPositionInstructionsResponse.data.map { it.toMutableList() }
            additionalProperties =
                instructionGetPositionInstructionsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<PositionInstruction>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<PositionInstruction>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<PositionInstruction>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [PositionInstruction] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: PositionInstruction) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [InstructionGetPositionInstructionsResponse].
         *
         ...
         */
        fun build(): InstructionGetPositionInstructionsResponse =
            InstructionGetPositionInstructionsResponse(
     ...
     *   expected type.
     */
    fun validate(): InstructionGetPositionInstructionsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstructionGetPositionInstructionsResponse &&
    ...
    override fun toString() =
        "InstructionGetPositionInstructionsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
