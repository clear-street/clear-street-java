...
private constructor(
    ...
    private val structuredAction: StructuredAction? = null,
    private val thinking: Thinking? = null,
    private val chart: Chart? = null,
    private val suggestedActions: SuggestedActions? = null,
    ...
    fun structuredAction(): Optional<StructuredAction> = Optional.ofNullable(structuredAction)
    ...
    fun chart(): Optional<Chart> = Optional.ofNullable(chart)

    /** Message-level follow-up action buttons */
    fun suggestedActions(): Optional<SuggestedActions> = Optional.ofNullable(suggestedActions)
    ...
    fun isStructuredAction(): Boolean = structuredAction != null

    fun isThinking(): Boolean = thinking != null

    fun isChart(): Boolean = chart != null

    fun isSuggestedActions(): Boolean = suggestedActions != null
    ...
    /** Structured action for the client to execute */
    fun asStructuredAction(): StructuredAction = structuredAction.getOrThrow("structuredAction")

    /** Model reasoning/thinking content and tool call status indicators */
    fun asThinking(): Thinking = thinking.getOrThrow("thinking")

    /** Typed inline chart (symbol or data-driven) */
    fun asChart(): Chart = chart.getOrThrow("chart")

    /** Message-level follow-up action buttons */
    fun asSuggestedActions(): SuggestedActions = suggestedActions.getOrThrow("suggestedActions")
    ...
    fun <T> accept(visitor: Visitor<T>): T =
        when {
            ...
            structuredAction != null -> visitor.visitStructuredAction(structuredAction)
            thinking != null -> visitor.visitThinking(thinking)
            chart != null -> visitor.visitChart(chart)
            suggestedActions != null -> visitor.visitSuggestedActions(suggestedActions)
    ...
    fun validate(): ContentPart = apply {
        ...
        accept(
            object : Visitor<Unit> {
                ...
                override fun visitStructuredAction(structuredAction: StructuredAction) {
                    structuredAction.validate()
                }
                ...
                override fun visitChart(chart: Chart) {
                    chart.validate()
                }

                override fun visitSuggestedActions(suggestedActions: SuggestedActions) {
                    suggestedActions.validate()
                }
    ...
    internal fun validity(): Int =
        accept(
            object : Visitor<Int> {
                ...
                override fun visitStructuredAction(structuredAction: StructuredAction) =
                    structuredAction.validity()

                override fun visitThinking(thinking: Thinking) = thinking.validity()

                override fun visitChart(chart: Chart) = chart.validity()

                override fun visitSuggestedActions(suggestedActions: SuggestedActions) =
                    suggestedActions.validity()
    ...
    override fun hashCode(): Int =
        Objects.hash(text, structuredAction, thinking, chart, suggestedActions, type)

    override fun toString(): String =
        when {
            text != null -> "ContentPart{text=$text}"
            structuredAction != null -> "ContentPart{structuredAction=$structuredAction}"
            thinking != null -> "ContentPart{thinking=$thinking}"
            chart != null -> "ContentPart{chart=$chart}"
            suggestedActions != null -> "ContentPart{suggestedActions=$suggestedActions}"
            type != null -> "ContentPart{type=$type}"
    ...
    companion object {
        ...
        /** Plain text content */
        @JvmStatic fun ofText(text: Text) = ContentPart(text = text)

        /** Structured action for the client to execute */
        @JvmStatic
        fun ofStructuredAction(structuredAction: StructuredAction) =
            ContentPart(structuredAction = structuredAction)

        /** Model reasoning/thinking content and tool call status indicators */
        @JvmStatic fun ofThinking(thinking: Thinking) = ContentPart(thinking = thinking)

        /** Typed inline chart (symbol or data-driven) */
        @JvmStatic fun ofChart(chart: Chart) = ContentPart(chart = chart)

        /** Message-level follow-up action buttons */
        @JvmStatic
        fun ofSuggestedActions(suggestedActions: SuggestedActions) =
            ContentPart(suggestedActions = suggestedActions)

        /** Custom/extensible content */
        @JvmStatic fun ofType(type: Type) = ContentPart(type = type)
    }

    /**
     * An interface that defines how to map each variant of [ContentPart] to a value of type [T].
     */
    interface Visitor<out T> {
        ...
        /** Structured action for the client to execute */
        fun visitStructuredAction(structuredAction: StructuredAction): T

        /** Model reasoning/thinking content and tool call status indicators */
        fun visitThinking(thinking: Thinking): T

        /** Typed inline chart (symbol or data-driven) */
        fun visitChart(chart: Chart): T

        /** Message-level follow-up action buttons */
        fun visitSuggestedActions(suggestedActions: SuggestedActions): T
         ...
         *
         * An instance of [ContentPart] can contain an unknown variant if it was deserialized from
        ...
        fun unknown(json: JsonValue?): T {
            throw ClearStreetInvalidDataException("Unknown ContentPart: $json")
        }
    }
    ...
    internal class Deserializer : BaseDeserializer<ContentPart>(ContentPart::class) {
        ...
        override fun ObjectCodec.deserialize(node: JsonNode): ContentPart {
            ...
            val bestMatches =
                sequenceOf(
                        tryDeserialize(node, jacksonTypeRef<Text>())?.let {
                            ContentPart(text = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<StructuredAction>())?.let {
                            ContentPart(structuredAction = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<Thinking>())?.let {
                            ContentPart(thinking = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<Chart>())?.let {
                            ContentPart(chart = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<SuggestedActions>())?.let {
                            ContentPart(suggestedActions = it, _json = json)
                        },
                        tryDeserialize(node, jacksonTypeRef<Type>())?.let {
                            ContentPart(type = it, _json = json)
                        },
                    )
                    .filterNotNull()
    ...
    internal class Serializer : BaseSerializer<ContentPart>(ContentPart::class) {
        ...
        override fun serialize(
            ...
            when {
                ...
                value.structuredAction != null -> generator.writeObject(value.structuredAction)
                value.thinking != null -> generator.writeObject(value.thinking)
                value.chart != null -> generator.writeObject(value.chart)
                value.suggestedActions != null -> generator.writeObject(value.suggestedActions)
    ...
    private constructor(
        ...
        fun toContentPartText(): ContentPartText = ContentPartText.builder().text(text).build()
    ...
    private constructor(
        ...
        companion object {
            ...
            /** Open a chart for a symbol */
            @JvmStatic
            fun ofOpenChart(openChart: OpenChart) = StructuredAction(openChart = openChart)
        ...
        /**
         * An interface that defines how to map each variant of [StructuredAction] to a value of
         * type [T].
         */
        interface Visitor<out T> {
             ...
             *
             * An instance of [StructuredAction] can contain an unknown variant if it was
        ...
        private constructor(
            ...
            private constructor(
                ...
                @JsonProperty("type") @ExcludeMissing type: JsonField<Type> = JsonMissing.of(),
            ) : this(orders, accountId, actionType, type, mutableMapOf())
            ...
            @JsonProperty("account_id")
            @ExcludeMissing
            fun _accountId(): JsonField<Long> = accountId
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.orders] with a well-typed `List<OrderPayload>`
                 ...
                 *
                 * You should usually call [Builder.accountId] with a well-typed [Long] value
            ...
            private val hashCode: Int by lazy {
                Objects.hash(orders, accountId, actionType, type, additionalProperties)
            }

            override fun hashCode(): Int = hashCode

            override fun toString() =
                "PrefillOrder{orders=$orders, accountId=$accountId, actionType=$actionType, type=$type, additionalProperties=$additionalProperties}"
        }
        ...
        private constructor(
            ...
            private constructor(
                ...
                actionType: JsonField<ActionType> = JsonMissing.of(),
                @JsonProperty("type") @ExcludeMissing type: JsonField<Type> = JsonMissing.of(),
            ) : this(symbol, extras, timeframe, actionType, type, mutableMapOf())
             ...
             *
             * Unlike [timeframe], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("timeframe")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.timeframe] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            private val hashCode: Int by lazy {
                Objects.hash(symbol, extras, timeframe, actionType, type, additionalProperties)
            }

            override fun hashCode(): Int = hashCode

            override fun toString() =
                "OpenChart{symbol=$symbol, extras=$extras, timeframe=$timeframe, actionType=$actionType, type=$type, additionalProperties=$additionalProperties}"
        }
        ...
        private constructor(
            ...
            private constructor(
                ...
                @ExcludeMissing
                sortBy: JsonField<String> = JsonMissing.of(),
             ...
             *
             * Unlike [fieldFilter], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("field_filter")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 * `List<ScreenerFilter>` value instead. This method is primarily for setting the
                 ...
                 *
                 * You should usually call [Builder.fieldFilter] with a well-typed `List<String>`
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.sortBy] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
            ...
            override fun toString() =
                "OpenScreener{filters=$filters, fieldFilter=$fieldFilter, pageSize=$pageSize, sortBy=$sortBy, sortDirection=$sortDirection, actionType=$actionType, type=$type, additionalProperties=$additionalProperties}"
        }
        ...
        private constructor(
            ...
            private constructor(
                ...
                actionType: JsonField<ActionType> = JsonMissing.of(),
                @JsonProperty("type") @ExcludeMissing type: JsonField<Type> = JsonMissing.of(),
            ) : this(extras, threadId, title, actionType, type, mutableMapOf())
            ...
            private val hashCode: Int by lazy {
                Objects.hash(extras, threadId, title, actionType, type, additionalProperties)
            }

            override fun hashCode(): Int = hashCode

            override fun toString() =
                "OpenChatWindow{extras=$extras, threadId=$threadId, title=$title, actionType=$actionType, type=$type, additionalProperties=$additionalProperties}"
        }
        ...
        private constructor(
            ...
            private constructor(
                ...
                actionType: JsonField<ActionType> = JsonMissing.of(),
                @JsonProperty("type") @ExcludeMissing type: JsonField<Type> = JsonMissing.of(),
            ) : this(route, params, actionType, type, mutableMapOf())
            ...
            private val hashCode: Int by lazy {
                Objects.hash(route, params, actionType, type, additionalProperties)
            }

            override fun hashCode(): Int = hashCode

            override fun toString() =
                "Navigate{route=$route, params=$params, actionType=$actionType, type=$type, additionalProperties=$additionalProperties}"
        }
    }
    ...
    private constructor(
        ...
        fun toContentPartThinking(): ContentPartThinking =
            ContentPartThinking.builder().thoughts(thoughts).build()
        ...
        class Builder internal constructor() {
            ...
            internal fun from(thinking: Thinking) = apply {
                thoughts = thinking.thoughts.map { it.toMutableList() }
                type = thinking.type
        ...
        override fun toString() =
            "Thinking{thoughts=$thoughts, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("type") @ExcludeMissing type: JsonField<Type> = JsonMissing.of(),
        ) : this(chartId, actionButtons, chartKind, type, mutableMapOf())

        fun toContentPartChart(): ContentPartChart =
         ...
         */
        fun actionButtons(): Optional<List<ActionButton>> =
            actionButtons.getOptional("action_buttons")
         ...
         *
         * Unlike [actionButtons], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("action_buttons")
        @ExcludeMissing
        ...
        @JsonProperty("chart_kind")
        @ExcludeMissing
        fun _chartKind(): JsonField<ChartKind> = chartKind
        ...
        class Builder internal constructor() {
            ...
            internal fun from(chart: Chart) = apply {
                ...
                actionButtons = chart.actionButtons.map { it.toMutableList() }
             ...
             *
             * You should usually call [Builder.chartId] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.actionButtons] with a well-typed
             * `List<ActionButton>` value instead. This method is primarily for setting the field to
             ...
             *
             * You should usually call [Builder.chartKind] with a well-typed [ChartKind] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            fun chartKind(dataChart: ChartKind.DataChart) =
                chartKind(ChartKind.ofDataChart(dataChart))
        ...
        private val hashCode: Int by lazy {
            Objects.hash(chartId, actionButtons, chartKind, type, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Chart{chartId=$chartId, actionButtons=$actionButtons, chartKind=$chartKind, type=$type, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        private constructor(
            ...
            actionButtons: JsonField<List<ActionButton>> = JsonMissing.of(),
            @JsonProperty("type") @ExcludeMissing type: JsonField<Type> = JsonMissing.of(),
        ) : this(actionButtons, type, mutableMapOf())

        fun toContentPartSuggestedActions(): ContentPartSuggestedActions =
            ContentPartSuggestedActions.builder().actionButtons(actionButtons).build()
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [SuggestedActions].
             *
             * The following fields are required:
             * ```java
             * .actionButtons()
        ...
        /** A builder for [SuggestedActions]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(suggestedActions: SuggestedActions) = apply {
                actionButtons = suggestedActions.actionButtons.map { it.toMutableList() }
                type = suggestedActions.type
                additionalProperties = suggestedActions.additionalProperties.toMutableMap()
            }
            ...
            /**
             * Returns an immutable instance of [SuggestedActions].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
        ...
        fun validate(): SuggestedActions = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is SuggestedActions &&
                actionButtons == other.actionButtons &&
                type == other.type &&
                additionalProperties == other.additionalProperties
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(actionButtons, type, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "SuggestedActions{actionButtons=$actionButtons, type=$type, additionalProperties=$additionalProperties}"
    }
