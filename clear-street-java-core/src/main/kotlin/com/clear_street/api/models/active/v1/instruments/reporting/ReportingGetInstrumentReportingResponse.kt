...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<InstrumentEarnings> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): InstrumentEarnings = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<InstrumentEarnings> = data
    ...
    /** A builder for [ReportingGetInstrumentReportingResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<InstrumentEarnings>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            reportingGetInstrumentReportingResponse: ReportingGetInstrumentReportingResponse
        ) = apply {
            metadata = reportingGetInstrumentReportingResponse.metadata
            error = reportingGetInstrumentReportingResponse.error
            data = reportingGetInstrumentReportingResponse.data
            additionalProperties =
                reportingGetInstrumentReportingResponse.additionalProperties.toMutableMap()
        }
        ...
        /** Represents instrument earnings data */
        fun data(data: InstrumentEarnings) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [InstrumentEarnings] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<InstrumentEarnings>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [ReportingGetInstrumentReportingResponse].
         *
         ...
         */
        fun build(): ReportingGetInstrumentReportingResponse =
            ReportingGetInstrumentReportingResponse(
    ...
    fun validate(): ReportingGetInstrumentReportingResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReportingGetInstrumentReportingResponse &&
    ...
    override fun toString() =
        "ReportingGetInstrumentReportingResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
