...
class FundamentalGetInstrumentFundamentalsResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<InstrumentFundamentals>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<InstrumentFundamentals> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): InstrumentFundamentals = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<InstrumentFundamentals> = data
    ...
    /** A builder for [FundamentalGetInstrumentFundamentalsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<InstrumentFundamentals>? = null
        ...
        internal fun from(
            ...
            metadata = fundamentalGetInstrumentFundamentalsResponse.metadata
            error = fundamentalGetInstrumentFundamentalsResponse.error
            data = fundamentalGetInstrumentFundamentalsResponse.data
            additionalProperties =
                fundamentalGetInstrumentFundamentalsResponse.additionalProperties.toMutableMap()
        }
        ...
        /** Supplemental fundamentals and company profile data for an instrument. */
        fun data(data: InstrumentFundamentals) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [InstrumentFundamentals] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<InstrumentFundamentals>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [FundamentalGetInstrumentFundamentalsResponse].
         *
         ...
         */
        fun build(): FundamentalGetInstrumentFundamentalsResponse =
            FundamentalGetInstrumentFundamentalsResponse(
    ...
    fun validate(): FundamentalGetInstrumentFundamentalsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FundamentalGetInstrumentFundamentalsResponse &&
    ...
    override fun toString() =
        "FundamentalGetInstrumentFundamentalsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
