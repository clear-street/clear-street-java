...
private constructor(
    ...
    /** A builder for [EntitlementGetEntitlementAgreementsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            metadata = entitlementGetEntitlementAgreementsResponse.metadata
            error = entitlementGetEntitlementAgreementsResponse.error
            data = entitlementGetEntitlementAgreementsResponse.data.map { it.toMutableList() }
            additionalProperties =
                entitlementGetEntitlementAgreementsResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): EntitlementGetEntitlementAgreementsResponse =
            EntitlementGetEntitlementAgreementsResponse(
     ...
     *   expected type.
     */
    fun validate(): EntitlementGetEntitlementAgreementsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntitlementGetEntitlementAgreementsResponse &&
    ...
    override fun toString() =
        "EntitlementGetEntitlementAgreementsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
