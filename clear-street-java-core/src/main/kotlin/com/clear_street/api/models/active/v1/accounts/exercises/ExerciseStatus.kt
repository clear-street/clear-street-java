 ...
 * values.
 */
class ExerciseStatus @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmStatic fun of(value: String) = ExerciseStatus(JsonField.of(value))
    }

    /** An enum containing [ExerciseStatus]'s known values. */
    enum class Known {
        SENT,
        ACCEPTED,
        REJECTED,
    ...
    /**
     * An enum containing [ExerciseStatus]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [ExerciseStatus] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        UNKNOWN,
        /**
         * An enum member indicating that [ExerciseStatus] was instantiated with an unknown value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw ClearStreetInvalidDataException("Unknown ExerciseStatus: $value")
        }
     ...
     *   expected type.
     */
    fun validate(): ExerciseStatus = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExerciseStatus && value == other.value
    }
