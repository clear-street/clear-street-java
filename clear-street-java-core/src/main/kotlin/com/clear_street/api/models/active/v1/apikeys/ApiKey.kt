...
private constructor(
    ...
    ) : this(id, apiKey, createdAt, expiresAt, name, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, apiKey, createdAt, expiresAt, name, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ApiKey{id=$id, apiKey=$apiKey, createdAt=$createdAt, expiresAt=$expiresAt, name=$name, additionalProperties=$additionalProperties}"
}
