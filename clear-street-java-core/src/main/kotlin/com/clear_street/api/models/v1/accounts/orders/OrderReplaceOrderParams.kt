...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun timeInForce(): Optional<RequestTimeInForce> = body.timeInForce()
     ...
     */
    fun _timeInForce(): JsonField<RequestTimeInForce> = body._timeInForce()
    ...
    class Builder internal constructor() {
        ...
        /** New time in force for the order */
        fun timeInForce(timeInForce: RequestTimeInForce) = apply { body.timeInForce(timeInForce) }
    ...
    private constructor(
         ...
         *   the server responded with an unexpected value).
         */
        fun timeInForce(): Optional<RequestTimeInForce> = timeInForce.getOptional("time_in_force")
        ...
        class Builder internal constructor() {
            ...
            private var timeInForce: JsonField<RequestTimeInForce> = JsonMissing.of()
