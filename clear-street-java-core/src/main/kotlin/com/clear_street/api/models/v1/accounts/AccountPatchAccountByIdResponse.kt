...
private constructor(
    ...
    private val data: JsonField<AccountSettings>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<AccountSettings> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): AccountSettings = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<AccountSettings> = data
    ...
    /** A builder for [AccountPatchAccountByIdResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<AccountSettings>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(accountPatchAccountByIdResponse: AccountPatchAccountByIdResponse) =
            apply {
                metadata = accountPatchAccountByIdResponse.metadata
                error = accountPatchAccountByIdResponse.error
                data = accountPatchAccountByIdResponse.data
                additionalProperties =
                    accountPatchAccountByIdResponse.additionalProperties.toMutableMap()
            }
        ...
        fun data(data: AccountSettings) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [AccountSettings] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<AccountSettings>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [AccountPatchAccountByIdResponse].
         *
         ...
         */
        fun build(): AccountPatchAccountByIdResponse =
            AccountPatchAccountByIdResponse(
     ...
     *   expected type.
     */
    fun validate(): AccountPatchAccountByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountPatchAccountByIdResponse &&
    ...
    override fun toString() =
        "AccountPatchAccountByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
