 ...
 */
class ExerciseAction @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmStatic fun of(value: String) = ExerciseAction(JsonField.of(value))
    }

    /** An enum containing [ExerciseAction]'s known values. */
    enum class Known {
        EXERCISE,
        DO_NOT_EXERCISE,
        CONTRARY_EXERCISE,
    ...
    /**
     * An enum containing [ExerciseAction]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [ExerciseAction] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        CONTRARY_EXERCISE,
        /**
         * An enum member indicating that [ExerciseAction] was instantiated with an unknown value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw ClearStreetInvalidDataException("Unknown ExerciseAction: $value")
        }
     ...
     *   expected type.
     */
    fun validate(): ExerciseAction = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExerciseAction && value == other.value
    }
