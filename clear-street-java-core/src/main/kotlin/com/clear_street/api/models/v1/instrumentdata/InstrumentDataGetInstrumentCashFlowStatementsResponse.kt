...
private constructor(
    ...
    /** A builder for [InstrumentDataGetInstrumentCashFlowStatementsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            metadata = instrumentDataGetInstrumentCashFlowStatementsResponse.metadata
            error = instrumentDataGetInstrumentCashFlowStatementsResponse.error
            data =
                instrumentDataGetInstrumentCashFlowStatementsResponse.data.map {
                    it.toMutableList()
                }
            additionalProperties =
                instrumentDataGetInstrumentCashFlowStatementsResponse.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InstrumentDataGetInstrumentCashFlowStatementsResponse].
         *
         ...
         */
        fun build(): InstrumentDataGetInstrumentCashFlowStatementsResponse =
            InstrumentDataGetInstrumentCashFlowStatementsResponse(
     ...
     *   expected type.
     */
    fun validate(): InstrumentDataGetInstrumentCashFlowStatementsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentDataGetInstrumentCashFlowStatementsResponse &&
    ...
    override fun toString() =
        "InstrumentDataGetInstrumentCashFlowStatementsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
