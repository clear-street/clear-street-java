...
class EntitlementAgreementGetEntitlementAgreementsResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<List<EntitlementAgreementResource>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<EntitlementAgreementResource>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<EntitlementAgreementResource> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<EntitlementAgreementResource>> = data
    ...
    /** A builder for [EntitlementAgreementGetEntitlementAgreementsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<EntitlementAgreementResource>>? = null
        ...
        internal fun from(
            ...
            metadata = entitlementAgreementGetEntitlementAgreementsResponse.metadata
            error = entitlementAgreementGetEntitlementAgreementsResponse.error
            data =
                entitlementAgreementGetEntitlementAgreementsResponse.data.map { it.toMutableList() }
            additionalProperties =
                entitlementAgreementGetEntitlementAgreementsResponse.additionalProperties
                    .toMutableMap()
        }
        ...
        fun data(data: List<EntitlementAgreementResource>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<EntitlementAgreementResource>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<EntitlementAgreementResource>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [EntitlementAgreementResource] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: EntitlementAgreementResource) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [EntitlementAgreementGetEntitlementAgreementsResponse].
         *
         ...
         */
        fun build(): EntitlementAgreementGetEntitlementAgreementsResponse =
            EntitlementAgreementGetEntitlementAgreementsResponse(
     ...
     *   expected type.
     */
    fun validate(): EntitlementAgreementGetEntitlementAgreementsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntitlementAgreementGetEntitlementAgreementsResponse &&
    ...
    override fun toString() =
        "EntitlementAgreementGetEntitlementAgreementsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
