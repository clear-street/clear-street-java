...
private constructor(
    ...
    /** A builder for [InstrumentDataGetInstrumentFundamentalsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            metadata = instrumentDataGetInstrumentFundamentalsResponse.metadata
            error = instrumentDataGetInstrumentFundamentalsResponse.error
            data = instrumentDataGetInstrumentFundamentalsResponse.data
            additionalProperties =
                instrumentDataGetInstrumentFundamentalsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InstrumentDataGetInstrumentFundamentalsResponse].
         *
         ...
         */
        fun build(): InstrumentDataGetInstrumentFundamentalsResponse =
            InstrumentDataGetInstrumentFundamentalsResponse(
     ...
     *   expected type.
     */
    fun validate(): InstrumentDataGetInstrumentFundamentalsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentDataGetInstrumentFundamentalsResponse &&
    ...
    override fun toString() =
        "InstrumentDataGetInstrumentFundamentalsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
