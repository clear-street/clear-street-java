...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RunStartRunResponse].
         *
    ...
    /** A builder for [RunStartRunResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(runStartRunResponse: RunStartRunResponse) = apply {
            metadata = runStartRunResponse.metadata
            error = runStartRunResponse.error
            data = runStartRunResponse.data
            additionalProperties = runStartRunResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RunStartRunResponse].
         *
    ...
    fun validate(): RunStartRunResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunStartRunResponse &&
    ...
    override fun toString() =
        "RunStartRunResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
