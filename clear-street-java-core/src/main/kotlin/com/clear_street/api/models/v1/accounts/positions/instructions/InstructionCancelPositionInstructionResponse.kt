...
class InstructionCancelPositionInstructionResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<PositionInstruction>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<PositionInstruction> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): PositionInstruction = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<PositionInstruction> = data
    ...
    /** A builder for [InstructionCancelPositionInstructionResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<PositionInstruction>? = null
        ...
        internal fun from(
            ...
            metadata = instructionCancelPositionInstructionResponse.metadata
            error = instructionCancelPositionInstructionResponse.error
            data = instructionCancelPositionInstructionResponse.data
            additionalProperties =
                instructionCancelPositionInstructionResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.data] with a well-typed [PositionInstruction] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<PositionInstruction>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [InstructionCancelPositionInstructionResponse].
         *
         ...
         */
        fun build(): InstructionCancelPositionInstructionResponse =
            InstructionCancelPositionInstructionResponse(
     ...
     *   expected type.
     */
    fun validate(): InstructionCancelPositionInstructionResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstructionCancelPositionInstructionResponse &&
    ...
    override fun toString() =
        "InstructionCancelPositionInstructionResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
