 ...
 *
 * Retrieves historical cash flow statements for the specified instrument. Cash flow statements show
 * cash inflows and outflows from operating, investing, and financing activities.
 */
class CashFlowStatementGetInstrumentCashFlowStatementsParams
private constructor(
    ...
    /** A builder for [CashFlowStatementGetInstrumentCashFlowStatementsParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            securityIdSource =
                cashFlowStatementGetInstrumentCashFlowStatementsParams.securityIdSource
            securityId = cashFlowStatementGetInstrumentCashFlowStatementsParams.securityId
            fromDate = cashFlowStatementGetInstrumentCashFlowStatementsParams.fromDate
            pageSize = cashFlowStatementGetInstrumentCashFlowStatementsParams.pageSize
            pageToken = cashFlowStatementGetInstrumentCashFlowStatementsParams.pageToken
            toDate = cashFlowStatementGetInstrumentCashFlowStatementsParams.toDate
            additionalHeaders =
                cashFlowStatementGetInstrumentCashFlowStatementsParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                cashFlowStatementGetInstrumentCashFlowStatementsParams.additionalQueryParams
                    .toBuilder()
        }
         ...
         */
        fun build(): CashFlowStatementGetInstrumentCashFlowStatementsParams =
            CashFlowStatementGetInstrumentCashFlowStatementsParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CashFlowStatementGetInstrumentCashFlowStatementsParams &&
    ...
    override fun toString() =
        "CashFlowStatementGetInstrumentCashFlowStatementsParams{securityIdSource=$securityIdSource, securityId=$securityId, fromDate=$fromDate, pageSize=$pageSize, pageToken=$pageToken, toDate=$toDate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
