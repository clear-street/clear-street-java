...
class EarningGetEarningsCalendarResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<List<EarningsCalendarEvent>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<EarningsCalendarEvent>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<EarningsCalendarEvent> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<EarningsCalendarEvent>> = data
    ...
    /** A builder for [EarningGetEarningsCalendarResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<EarningsCalendarEvent>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(earningGetEarningsCalendarResponse: EarningGetEarningsCalendarResponse) =
            apply {
                metadata = earningGetEarningsCalendarResponse.metadata
                error = earningGetEarningsCalendarResponse.error
                data = earningGetEarningsCalendarResponse.data.map { it.toMutableList() }
                additionalProperties =
                    earningGetEarningsCalendarResponse.additionalProperties.toMutableMap()
            }
        ...
        fun data(data: List<EarningsCalendarEvent>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<EarningsCalendarEvent>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<EarningsCalendarEvent>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [EarningsCalendarEvent] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: EarningsCalendarEvent) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [EarningGetEarningsCalendarResponse].
         *
         ...
         */
        fun build(): EarningGetEarningsCalendarResponse =
            EarningGetEarningsCalendarResponse(
    ...
    fun validate(): EarningGetEarningsCalendarResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EarningGetEarningsCalendarResponse &&
    ...
    override fun toString() =
        "EarningGetEarningsCalendarResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
