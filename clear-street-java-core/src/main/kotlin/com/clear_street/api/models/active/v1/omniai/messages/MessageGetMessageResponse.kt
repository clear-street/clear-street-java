...
class MessageGetMessageResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageGetMessageResponse].
         *
    ...
    /** A builder for [MessageGetMessageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageGetMessageResponse: MessageGetMessageResponse) = apply {
            metadata = messageGetMessageResponse.metadata
            error = messageGetMessageResponse.error
            data = messageGetMessageResponse.data
            additionalProperties = messageGetMessageResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.data] with a well-typed [Message] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        ...
        /**
         * Returns an immutable instance of [MessageGetMessageResponse].
         *
         ...
         */
        fun build(): MessageGetMessageResponse =
    ...
    fun validate(): MessageGetMessageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageGetMessageResponse &&
    ...
    override fun toString() =
        "MessageGetMessageResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
