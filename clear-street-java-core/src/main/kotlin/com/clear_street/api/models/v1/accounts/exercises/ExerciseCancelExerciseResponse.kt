...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<ExerciseInstruction> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): ExerciseInstruction = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<ExerciseInstruction> = data
    ...
    /** A builder for [ExerciseCancelExerciseResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<ExerciseInstruction>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(exerciseCancelExerciseResponse: ExerciseCancelExerciseResponse) = apply {
            metadata = exerciseCancelExerciseResponse.metadata
            error = exerciseCancelExerciseResponse.error
            data = exerciseCancelExerciseResponse.data
            additionalProperties =
                exerciseCancelExerciseResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun data(data: ExerciseInstruction) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [ExerciseInstruction] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<ExerciseInstruction>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [ExerciseCancelExerciseResponse].
         *
         ...
         */
        fun build(): ExerciseCancelExerciseResponse =
            ExerciseCancelExerciseResponse(
     ...
     *   expected type.
     */
    fun validate(): ExerciseCancelExerciseResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExerciseCancelExerciseResponse &&
    ...
    override fun toString() =
        "ExerciseCancelExerciseResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
