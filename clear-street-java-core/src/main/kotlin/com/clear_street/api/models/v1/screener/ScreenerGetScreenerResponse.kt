...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<ScreenerItem>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<ScreenerItem> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ScreenerItem>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ScreenerGetScreenerResponse].
         *
    ...
    /** A builder for [ScreenerGetScreenerResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<ScreenerItem>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(screenerGetScreenerResponse: ScreenerGetScreenerResponse) = apply {
            metadata = screenerGetScreenerResponse.metadata
            error = screenerGetScreenerResponse.error
            data = screenerGetScreenerResponse.data.map { it.toMutableList() }
            additionalProperties = screenerGetScreenerResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<ScreenerItem>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<ScreenerItem>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<ScreenerItem>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ScreenerItem] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ScreenerItem) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [ScreenerGetScreenerResponse].
         *
         ...
         */
        fun build(): ScreenerGetScreenerResponse =
     ...
     *   expected type.
     */
    fun validate(): ScreenerGetScreenerResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScreenerGetScreenerResponse &&
    ...
    override fun toString() =
        "ScreenerGetScreenerResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
