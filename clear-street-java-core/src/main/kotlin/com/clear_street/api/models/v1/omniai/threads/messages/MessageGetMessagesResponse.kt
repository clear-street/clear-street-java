...
class MessageGetMessagesResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageGetMessagesResponse].
         *
    ...
    /** A builder for [MessageGetMessagesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageGetMessagesResponse: MessageGetMessagesResponse) = apply {
            metadata = messageGetMessagesResponse.metadata
            error = messageGetMessagesResponse.error
            data = messageGetMessagesResponse.data.map { it.toMutableList() }
            additionalProperties = messageGetMessagesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageGetMessagesResponse].
         *
         ...
         */
        fun build(): MessageGetMessagesResponse =
     ...
     *   expected type.
     */
    fun validate(): MessageGetMessagesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageGetMessagesResponse &&
    ...
    override fun toString() =
        "MessageGetMessagesResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
