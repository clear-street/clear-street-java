...
class CashFlowStatementGetInstrumentCashFlowStatementsResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<List<InstrumentCashFlowStatement>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<InstrumentCashFlowStatement>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<InstrumentCashFlowStatement> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<InstrumentCashFlowStatement>> = data
    ...
    /** A builder for [CashFlowStatementGetInstrumentCashFlowStatementsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<InstrumentCashFlowStatement>>? = null
        ...
        internal fun from(
            ...
            metadata = cashFlowStatementGetInstrumentCashFlowStatementsResponse.metadata
            error = cashFlowStatementGetInstrumentCashFlowStatementsResponse.error
            data =
                cashFlowStatementGetInstrumentCashFlowStatementsResponse.data.map {
                    it.toMutableList()
                }
            additionalProperties =
                cashFlowStatementGetInstrumentCashFlowStatementsResponse.additionalProperties
                    .toMutableMap()
        }
        ...
        fun data(data: List<InstrumentCashFlowStatement>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<InstrumentCashFlowStatement>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<InstrumentCashFlowStatement>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [InstrumentCashFlowStatement] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: InstrumentCashFlowStatement) = apply {
            this.data =
         ...
         */
        fun build(): CashFlowStatementGetInstrumentCashFlowStatementsResponse =
            CashFlowStatementGetInstrumentCashFlowStatementsResponse(
    ...
    fun validate(): CashFlowStatementGetInstrumentCashFlowStatementsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CashFlowStatementGetInstrumentCashFlowStatementsResponse &&
    ...
    override fun toString() =
        "CashFlowStatementGetInstrumentCashFlowStatementsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
