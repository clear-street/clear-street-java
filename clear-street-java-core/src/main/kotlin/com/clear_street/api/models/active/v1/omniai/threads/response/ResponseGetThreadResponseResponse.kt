...
class ResponseGetThreadResponseResponse
...
private constructor(
    ...
    /** A builder for [ResponseGetThreadResponseResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(responseGetThreadResponseResponse: ResponseGetThreadResponseResponse) =
            apply {
                metadata = responseGetThreadResponseResponse.metadata
                error = responseGetThreadResponseResponse.error
                data = responseGetThreadResponseResponse.data
                additionalProperties =
                    responseGetThreadResponseResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ResponseGetThreadResponseResponse].
         *
         ...
         */
        fun build(): ResponseGetThreadResponseResponse =
            ResponseGetThreadResponseResponse(
    ...
    fun validate(): ResponseGetThreadResponseResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseGetThreadResponseResponse &&
    ...
    override fun toString() =
        "ResponseGetThreadResponseResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
