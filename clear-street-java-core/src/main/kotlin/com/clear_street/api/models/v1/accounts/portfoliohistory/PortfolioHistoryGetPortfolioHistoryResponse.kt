...
class PortfolioHistoryGetPortfolioHistoryResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<PortfolioHistoryResponse>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<PortfolioHistoryResponse> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): PortfolioHistoryResponse = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<PortfolioHistoryResponse> = data
    ...
    /** A builder for [PortfolioHistoryGetPortfolioHistoryResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<PortfolioHistoryResponse>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            portfolioHistoryGetPortfolioHistoryResponse: PortfolioHistoryGetPortfolioHistoryResponse
        ) = apply {
            metadata = portfolioHistoryGetPortfolioHistoryResponse.metadata
            error = portfolioHistoryGetPortfolioHistoryResponse.error
            data = portfolioHistoryGetPortfolioHistoryResponse.data
            additionalProperties =
                portfolioHistoryGetPortfolioHistoryResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: PortfolioHistoryResponse) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [PortfolioHistoryResponse] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<PortfolioHistoryResponse>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [PortfolioHistoryGetPortfolioHistoryResponse].
         *
         ...
         */
        fun build(): PortfolioHistoryGetPortfolioHistoryResponse =
            PortfolioHistoryGetPortfolioHistoryResponse(
    ...
    fun validate(): PortfolioHistoryGetPortfolioHistoryResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PortfolioHistoryGetPortfolioHistoryResponse &&
    ...
    override fun toString() =
        "PortfolioHistoryGetPortfolioHistoryResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
