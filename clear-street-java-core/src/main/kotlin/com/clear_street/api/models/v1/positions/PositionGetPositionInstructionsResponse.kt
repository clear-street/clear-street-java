...
private constructor(
    ...
    /** A builder for [PositionGetPositionInstructionsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            positionGetPositionInstructionsResponse: PositionGetPositionInstructionsResponse
        ) = apply {
            metadata = positionGetPositionInstructionsResponse.metadata
            error = positionGetPositionInstructionsResponse.error
            data = positionGetPositionInstructionsResponse.data.map { it.toMutableList() }
            additionalProperties =
                positionGetPositionInstructionsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PositionGetPositionInstructionsResponse].
         *
         ...
         */
        fun build(): PositionGetPositionInstructionsResponse =
            PositionGetPositionInstructionsResponse(
     ...
     *   expected type.
     */
    fun validate(): PositionGetPositionInstructionsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PositionGetPositionInstructionsResponse &&
    ...
    override fun toString() =
        "PositionGetPositionInstructionsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
