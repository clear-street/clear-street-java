...
class LocateCreateLocateRequestResponse
...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<LocateOrder>> = JsonMissing.of(),
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<LocateOrder>> = data
    ...
    /** A builder for [LocateCreateLocateRequestResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<LocateOrder>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(locateCreateLocateRequestResponse: LocateCreateLocateRequestResponse) =
            apply {
                metadata = locateCreateLocateRequestResponse.metadata
                error = locateCreateLocateRequestResponse.error
                data = locateCreateLocateRequestResponse.data.map { it.toMutableList() }
                additionalProperties =
                    locateCreateLocateRequestResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<LocateOrder>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<LocateOrder>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [LocateOrder] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: LocateOrder) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [LocateCreateLocateRequestResponse].
         *
         ...
         */
        fun build(): LocateCreateLocateRequestResponse =
            LocateCreateLocateRequestResponse(
    ...
    fun validate(): LocateCreateLocateRequestResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LocateCreateLocateRequestResponse &&
    ...
    override fun toString() =
        "LocateCreateLocateRequestResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
