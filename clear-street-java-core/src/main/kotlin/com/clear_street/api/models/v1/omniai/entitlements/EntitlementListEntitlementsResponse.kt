...
class EntitlementListEntitlementsResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<List<EntitlementResource>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<EntitlementResource>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<EntitlementResource> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<EntitlementResource>> = data
    ...
    /** A builder for [EntitlementListEntitlementsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<EntitlementResource>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            entitlementListEntitlementsResponse: EntitlementListEntitlementsResponse
        ) = apply {
            metadata = entitlementListEntitlementsResponse.metadata
            error = entitlementListEntitlementsResponse.error
            data = entitlementListEntitlementsResponse.data.map { it.toMutableList() }
            additionalProperties =
                entitlementListEntitlementsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<EntitlementResource>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<EntitlementResource>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<EntitlementResource>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [EntitlementResource] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: EntitlementResource) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [EntitlementListEntitlementsResponse].
         *
         ...
         */
        fun build(): EntitlementListEntitlementsResponse =
            EntitlementListEntitlementsResponse(
    ...
    fun validate(): EntitlementListEntitlementsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntitlementListEntitlementsResponse &&
    ...
    override fun toString() =
        "EntitlementListEntitlementsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
