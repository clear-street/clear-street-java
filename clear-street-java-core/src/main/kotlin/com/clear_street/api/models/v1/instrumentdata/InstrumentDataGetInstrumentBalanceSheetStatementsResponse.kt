...
private constructor(
    ...
    /** A builder for [InstrumentDataGetInstrumentBalanceSheetStatementsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            metadata = instrumentDataGetInstrumentBalanceSheetStatementsResponse.metadata
            error = instrumentDataGetInstrumentBalanceSheetStatementsResponse.error
            data =
                instrumentDataGetInstrumentBalanceSheetStatementsResponse.data.map {
                    it.toMutableList()
                }
            additionalProperties =
                instrumentDataGetInstrumentBalanceSheetStatementsResponse.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): InstrumentDataGetInstrumentBalanceSheetStatementsResponse =
            InstrumentDataGetInstrumentBalanceSheetStatementsResponse(
     ...
     *   expected type.
     */
    fun validate(): InstrumentDataGetInstrumentBalanceSheetStatementsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentDataGetInstrumentBalanceSheetStatementsResponse &&
    ...
    override fun toString() =
        "InstrumentDataGetInstrumentBalanceSheetStatementsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
