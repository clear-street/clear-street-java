...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<MarketDataSnapshot>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<MarketDataSnapshot> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<MarketDataSnapshot>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SnapshotGetSnapshotsResponse].
         *
    ...
    /** A builder for [SnapshotGetSnapshotsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<MarketDataSnapshot>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(snapshotGetSnapshotsResponse: SnapshotGetSnapshotsResponse) = apply {
            metadata = snapshotGetSnapshotsResponse.metadata
            error = snapshotGetSnapshotsResponse.error
            data = snapshotGetSnapshotsResponse.data.map { it.toMutableList() }
            additionalProperties = snapshotGetSnapshotsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<MarketDataSnapshot>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<MarketDataSnapshot>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<MarketDataSnapshot>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [MarketDataSnapshot] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: MarketDataSnapshot) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [SnapshotGetSnapshotsResponse].
         *
         ...
         */
        fun build(): SnapshotGetSnapshotsResponse =
    ...
    fun validate(): SnapshotGetSnapshotsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SnapshotGetSnapshotsResponse &&
    ...
    override fun toString() =
        "SnapshotGetSnapshotsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
