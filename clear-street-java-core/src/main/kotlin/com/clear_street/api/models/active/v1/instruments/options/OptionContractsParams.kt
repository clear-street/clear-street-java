...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): OptionContractsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [OptionContractsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [OptionContractsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(optionContractsParams: OptionContractsParams) = apply {
            contractType = optionContractsParams.contractType
            expiry = optionContractsParams.expiry
            pageSize = optionContractsParams.pageSize
            pageToken = optionContractsParams.pageToken
            underlier = optionContractsParams.underlier
            underlierInstrumentId = optionContractsParams.underlierInstrumentId
            underlierSecurityId = optionContractsParams.underlierSecurityId
            underlierSecurityIdSource = optionContractsParams.underlierSecurityIdSource
            additionalHeaders = optionContractsParams.additionalHeaders.toBuilder()
            additionalQueryParams = optionContractsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OptionContractsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): OptionContractsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OptionContractsParams &&
    ...
    override fun toString() =
        "OptionContractsParams{contractType=$contractType, expiry=$expiry, pageSize=$pageSize, pageToken=$pageToken, underlier=$underlier, underlierInstrumentId=$underlierInstrumentId, underlierSecurityId=$underlierSecurityId, underlierSecurityIdSource=$underlierSecurityIdSource, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
