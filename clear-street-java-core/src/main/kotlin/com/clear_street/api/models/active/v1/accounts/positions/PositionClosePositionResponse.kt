...
import com.clear_street.api.models.active.v1.accounts.orders.Order
...
private constructor(
    ...
    /** A builder for [PositionClosePositionResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(positionClosePositionResponse: PositionClosePositionResponse) = apply {
            metadata = positionClosePositionResponse.metadata
            error = positionClosePositionResponse.error
            data = positionClosePositionResponse.data.map { it.toMutableList() }
            additionalProperties = positionClosePositionResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PositionClosePositionResponse].
         *
         ...
         */
        fun build(): PositionClosePositionResponse =
            PositionClosePositionResponse(
    ...
    fun validate(): PositionClosePositionResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PositionClosePositionResponse &&
    ...
    override fun toString() =
        "PositionClosePositionResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
