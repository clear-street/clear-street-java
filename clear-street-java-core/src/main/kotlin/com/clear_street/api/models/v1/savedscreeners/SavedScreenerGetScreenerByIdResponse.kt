...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<ScreenerEntry> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): ScreenerEntry = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<ScreenerEntry> = data
    ...
    /** A builder for [SavedScreenerGetScreenerByIdResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<ScreenerEntry>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            savedScreenerGetScreenerByIdResponse: SavedScreenerGetScreenerByIdResponse
        ) = apply {
            metadata = savedScreenerGetScreenerByIdResponse.metadata
            error = savedScreenerGetScreenerByIdResponse.error
            data = savedScreenerGetScreenerByIdResponse.data
            additionalProperties =
                savedScreenerGetScreenerByIdResponse.additionalProperties.toMutableMap()
        }
        ...
        /** A saved screener configuration entry */
        fun data(data: ScreenerEntry) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [ScreenerEntry] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<ScreenerEntry>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [SavedScreenerGetScreenerByIdResponse].
         *
         ...
         */
        fun build(): SavedScreenerGetScreenerByIdResponse =
            SavedScreenerGetScreenerByIdResponse(
     ...
     *   expected type.
     */
    fun validate(): SavedScreenerGetScreenerByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SavedScreenerGetScreenerByIdResponse &&
    ...
    override fun toString() =
        "SavedScreenerGetScreenerByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
