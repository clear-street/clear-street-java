...
private constructor(
    ...
    private val data: JsonField<ApiKey>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<ApiKey> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): ApiKey = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<ApiKey> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<ApiKey>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(apiKeyCreateResponse: ApiKeyCreateResponse) = apply {
            metadata = apiKeyCreateResponse.metadata
            error = apiKeyCreateResponse.error
        ...
        fun data(data: ApiKey) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [ApiKey] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<ApiKey>) = apply { this.data = data }
    ...
    override fun toString() =
        "ApiKeyCreateResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
