...
class MergersAcquisitionGetMergersAndAcquisitionsCalendarResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<List<MergersAcquisitionsEvent>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<MergersAcquisitionsEvent>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<MergersAcquisitionsEvent> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<MergersAcquisitionsEvent>> = data
    ...
    /** A builder for [MergersAcquisitionGetMergersAndAcquisitionsCalendarResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<MergersAcquisitionsEvent>>? = null
        ...
        internal fun from(
            ...
            metadata = mergersAcquisitionGetMergersAndAcquisitionsCalendarResponse.metadata
            error = mergersAcquisitionGetMergersAndAcquisitionsCalendarResponse.error
            data =
                mergersAcquisitionGetMergersAndAcquisitionsCalendarResponse.data.map {
                    it.toMutableList()
                }
            additionalProperties =
                mergersAcquisitionGetMergersAndAcquisitionsCalendarResponse.additionalProperties
                    .toMutableMap()
        }
        ...
        fun data(data: List<MergersAcquisitionsEvent>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<MergersAcquisitionsEvent>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<MergersAcquisitionsEvent>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [MergersAcquisitionsEvent] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: MergersAcquisitionsEvent) = apply {
            this.data =
         ...
         */
        fun build(): MergersAcquisitionGetMergersAndAcquisitionsCalendarResponse =
            MergersAcquisitionGetMergersAndAcquisitionsCalendarResponse(
    ...
    fun validate(): MergersAcquisitionGetMergersAndAcquisitionsCalendarResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MergersAcquisitionGetMergersAndAcquisitionsCalendarResponse &&
    ...
    override fun toString() =
        "MergersAcquisitionGetMergersAndAcquisitionsCalendarResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
