...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Revocation>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<Revocation> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Revocation>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ApiKeyRevokeAllResponse].
         *
    ...
    /** A builder for [ApiKeyRevokeAllResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<Revocation>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(apiKeyRevokeAllResponse: ApiKeyRevokeAllResponse) = apply {
            metadata = apiKeyRevokeAllResponse.metadata
            error = apiKeyRevokeAllResponse.error
            data = apiKeyRevokeAllResponse.data.map { it.toMutableList() }
            additionalProperties = apiKeyRevokeAllResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<Revocation>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Revocation>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<Revocation>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Revocation] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Revocation) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [ApiKeyRevokeAllResponse].
         *
         ...
         */
        fun build(): ApiKeyRevokeAllResponse =
    ...
    fun validate(): ApiKeyRevokeAllResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiKeyRevokeAllResponse &&
    ...
    override fun toString() =
        "ApiKeyRevokeAllResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
