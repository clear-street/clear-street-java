...
class TrailingOffsetType @JsonCreator private constructor(private val value: JsonField<String>) :
    Enum {
    ...
    /**
     * An enum containing [TrailingOffsetType]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [TrailingOffsetType] can contain an unknown value in a couple of cases:
    ...
    fun validate(): TrailingOffsetType = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TrailingOffsetType && value == other.value
    }
