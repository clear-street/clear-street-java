...
import com.clear_street.api.models.active.v1.omniai.CreateMessageResponse
...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<CreateMessageResponse> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): CreateMessageResponse = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CreateMessageResponse> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageCreateMessageResponse].
         *
    ...
    /** A builder for [MessageCreateMessageResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<CreateMessageResponse>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(messageCreateMessageResponse: MessageCreateMessageResponse) = apply {
            metadata = messageCreateMessageResponse.metadata
            error = messageCreateMessageResponse.error
            data = messageCreateMessageResponse.data
            additionalProperties = messageCreateMessageResponse.additionalProperties.toMutableMap()
        }
        ...
        /** Response payload for continuing a thread with a new message. */
        fun data(data: CreateMessageResponse) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [CreateMessageResponse] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<CreateMessageResponse>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [MessageCreateMessageResponse].
         *
         ...
         */
        fun build(): MessageCreateMessageResponse =
    ...
    fun validate(): MessageCreateMessageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageCreateMessageResponse &&
    ...
    override fun toString() =
        "MessageCreateMessageResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
