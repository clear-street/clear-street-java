...
private constructor(
    ...
    /** A builder for [MessageSubmitFeedbackResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageSubmitFeedbackResponse: MessageSubmitFeedbackResponse) = apply {
            metadata = messageSubmitFeedbackResponse.metadata
            error = messageSubmitFeedbackResponse.error
            data = messageSubmitFeedbackResponse.data
            additionalProperties = messageSubmitFeedbackResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageSubmitFeedbackResponse].
         *
         ...
         */
        fun build(): MessageSubmitFeedbackResponse =
            MessageSubmitFeedbackResponse(
     ...
     *   expected type.
     */
    fun validate(): MessageSubmitFeedbackResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageSubmitFeedbackResponse &&
    ...
    override fun toString() =
        "MessageSubmitFeedbackResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
