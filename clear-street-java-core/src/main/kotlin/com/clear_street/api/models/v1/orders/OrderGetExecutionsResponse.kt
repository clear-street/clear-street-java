...
import com.clear_street.api.models.v1.executions.Execution
...
private constructor(
    ...
    private val data: JsonField<List<Execution>>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Execution>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<Execution> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Execution>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrderGetExecutionsResponse].
         *
    ...
    /** A builder for [OrderGetExecutionsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<Execution>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(orderGetExecutionsResponse: OrderGetExecutionsResponse) = apply {
            metadata = orderGetExecutionsResponse.metadata
            error = orderGetExecutionsResponse.error
            data = orderGetExecutionsResponse.data.map { it.toMutableList() }
            additionalProperties = orderGetExecutionsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<Execution>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Execution>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Execution>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Execution] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Execution) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [OrderGetExecutionsResponse].
         *
         ...
         */
        fun build(): OrderGetExecutionsResponse =
     ...
     *   expected type.
     */
    fun validate(): OrderGetExecutionsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrderGetExecutionsResponse &&
    ...
    override fun toString() =
        "OrderGetExecutionsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
