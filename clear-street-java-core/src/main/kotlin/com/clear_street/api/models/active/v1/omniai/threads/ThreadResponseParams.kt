...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThreadResponseParams].
         *
    ...
    /** A builder for [ThreadResponseParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(threadResponseParams: ThreadResponseParams) = apply {
            threadId = threadResponseParams.threadId
            accountId = threadResponseParams.accountId
            additionalHeaders = threadResponseParams.additionalHeaders.toBuilder()
            additionalQueryParams = threadResponseParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ThreadResponseParams].
         *
         ...
         */
        fun build(): ThreadResponseParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadResponseParams &&
    ...
    override fun toString() =
        "ThreadResponseParams{threadId=$threadId, accountId=$accountId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
