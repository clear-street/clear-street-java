...
private constructor(
     ...
     * ```java
     * MyClass myObject = messageSubmitFeedbackParams.metadata().convert(MyClass.class);
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageSubmitFeedbackParams].
         *
    ...
    /** A builder for [MessageSubmitFeedbackParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageSubmitFeedbackParams: MessageSubmitFeedbackParams) = apply {
            messageId = messageSubmitFeedbackParams.messageId
            body = messageSubmitFeedbackParams.body.toBuilder()
            additionalHeaders = messageSubmitFeedbackParams.additionalHeaders.toBuilder()
            additionalQueryParams = messageSubmitFeedbackParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MessageSubmitFeedbackParams].
         *
         ...
         */
        fun build(): MessageSubmitFeedbackParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageSubmitFeedbackParams &&
    ...
    override fun toString() =
        "MessageSubmitFeedbackParams{messageId=$messageId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
