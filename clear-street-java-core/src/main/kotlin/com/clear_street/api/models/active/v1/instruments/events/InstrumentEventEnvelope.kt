...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(instrumentEventEnvelope: InstrumentEventEnvelope) = apply {
            securityId = instrumentEventEnvelope.securityId
            securityIdSource = instrumentEventEnvelope.securityIdSource
    ...
    override fun toString() =
        "InstrumentEventEnvelope{securityId=$securityId, securityIdSource=$securityIdSource, symbol=$symbol, type=$type, dividendEventData=$dividendEventData, earningsEventData=$earningsEventData, instrumentId=$instrumentId, ipoEventData=$ipoEventData, name=$name, stockSplitEventData=$stockSplitEventData, additionalProperties=$additionalProperties}"
}
