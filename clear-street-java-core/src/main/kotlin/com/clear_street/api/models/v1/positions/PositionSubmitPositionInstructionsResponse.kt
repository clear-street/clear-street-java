...
private constructor(
    ...
    /** A builder for [PositionSubmitPositionInstructionsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            positionSubmitPositionInstructionsResponse: PositionSubmitPositionInstructionsResponse
        ) = apply {
            metadata = positionSubmitPositionInstructionsResponse.metadata
            error = positionSubmitPositionInstructionsResponse.error
            data = positionSubmitPositionInstructionsResponse.data.map { it.toMutableList() }
            additionalProperties =
                positionSubmitPositionInstructionsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PositionSubmitPositionInstructionsResponse].
         *
         ...
         */
        fun build(): PositionSubmitPositionInstructionsResponse =
            PositionSubmitPositionInstructionsResponse(
     ...
     *   expected type.
     */
    fun validate(): PositionSubmitPositionInstructionsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PositionSubmitPositionInstructionsResponse &&
    ...
    override fun toString() =
        "PositionSubmitPositionInstructionsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
