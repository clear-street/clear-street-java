...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AccountGetAccountsResponse].
         *
    ...
    /** A builder for [AccountGetAccountsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(accountGetAccountsResponse: AccountGetAccountsResponse) = apply {
            metadata = accountGetAccountsResponse.metadata
            error = accountGetAccountsResponse.error
            data = accountGetAccountsResponse.data.map { it.toMutableList() }
            additionalProperties = accountGetAccountsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AccountGetAccountsResponse].
         *
         ...
         */
        fun build(): AccountGetAccountsResponse =
    ...
    fun validate(): AccountGetAccountsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountGetAccountsResponse &&
    ...
    override fun toString() =
        "AccountGetAccountsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
