...
class InventoryGetLocateInventoryResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<List<LocateInventoryItem>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<LocateInventoryItem>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<LocateInventoryItem> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<LocateInventoryItem>> = data
    ...
    /** A builder for [InventoryGetLocateInventoryResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<LocateInventoryItem>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            inventoryGetLocateInventoryResponse: InventoryGetLocateInventoryResponse
        ) = apply {
            metadata = inventoryGetLocateInventoryResponse.metadata
            error = inventoryGetLocateInventoryResponse.error
            data = inventoryGetLocateInventoryResponse.data.map { it.toMutableList() }
            additionalProperties =
                inventoryGetLocateInventoryResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<LocateInventoryItem>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<LocateInventoryItem>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<LocateInventoryItem>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [LocateInventoryItem] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: LocateInventoryItem) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [InventoryGetLocateInventoryResponse].
         *
         ...
         */
        fun build(): InventoryGetLocateInventoryResponse =
            InventoryGetLocateInventoryResponse(
    ...
    fun validate(): InventoryGetLocateInventoryResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InventoryGetLocateInventoryResponse &&
    ...
    override fun toString() =
        "InventoryGetLocateInventoryResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
