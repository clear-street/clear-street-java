...
private constructor(
    ...
    /** A builder for [PositionClosePositionsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(positionClosePositionsResponse: PositionClosePositionsResponse) = apply {
            metadata = positionClosePositionsResponse.metadata
            error = positionClosePositionsResponse.error
            data = positionClosePositionsResponse.data.map { it.toMutableList() }
            additionalProperties =
                positionClosePositionsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PositionClosePositionsResponse].
         *
         ...
         */
        fun build(): PositionClosePositionsResponse =
            PositionClosePositionsResponse(
    ...
    fun validate(): PositionClosePositionsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PositionClosePositionsResponse &&
    ...
    override fun toString() =
        "PositionClosePositionsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
