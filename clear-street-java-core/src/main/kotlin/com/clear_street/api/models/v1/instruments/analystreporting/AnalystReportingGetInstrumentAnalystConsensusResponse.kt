...
class AnalystReportingGetInstrumentAnalystConsensusResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<InstrumentAnalystConsensus>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<InstrumentAnalystConsensus> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): InstrumentAnalystConsensus = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<InstrumentAnalystConsensus> = data
    ...
    /** A builder for [AnalystReportingGetInstrumentAnalystConsensusResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<InstrumentAnalystConsensus>? = null
        ...
        internal fun from(
            ...
            metadata = analystReportingGetInstrumentAnalystConsensusResponse.metadata
            error = analystReportingGetInstrumentAnalystConsensusResponse.error
            data = analystReportingGetInstrumentAnalystConsensusResponse.data
            additionalProperties =
                analystReportingGetInstrumentAnalystConsensusResponse.additionalProperties
                    .toMutableMap()
        }
        ...
        /** Aggregated analyst consensus metrics */
        fun data(data: InstrumentAnalystConsensus) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [InstrumentAnalystConsensus]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<InstrumentAnalystConsensus>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [AnalystReportingGetInstrumentAnalystConsensusResponse].
         *
         ...
         */
        fun build(): AnalystReportingGetInstrumentAnalystConsensusResponse =
            AnalystReportingGetInstrumentAnalystConsensusResponse(
    ...
    fun validate(): AnalystReportingGetInstrumentAnalystConsensusResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AnalystReportingGetInstrumentAnalystConsensusResponse &&
    ...
    override fun toString() =
        "AnalystReportingGetInstrumentAnalystConsensusResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
