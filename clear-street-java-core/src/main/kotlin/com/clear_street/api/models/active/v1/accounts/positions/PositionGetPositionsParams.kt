...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(positionGetPositionsParams: PositionGetPositionsParams) = apply {
            ...
            securityId = positionGetPositionsParams.securityId?.toMutableList()
            securityIdSource = positionGetPositionsParams.securityIdSource?.toMutableList()
    ...
    override fun toString() =
        "PositionGetPositionsParams{accountId=$accountId, pageSize=$pageSize, pageToken=$pageToken, securityId=$securityId, securityIdSource=$securityIdSource, sortBy=$sortBy, sortDirection=$sortDirection, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
