...
import com.clear_street.api.models.v1.omniai.threads.Message
...
private constructor(
    ...
    /** A builder for [MessageGetMessageByIdResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageGetMessageByIdResponse: MessageGetMessageByIdResponse) = apply {
            metadata = messageGetMessageByIdResponse.metadata
            error = messageGetMessageByIdResponse.error
            data = messageGetMessageByIdResponse.data
            additionalProperties = messageGetMessageByIdResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageGetMessageByIdResponse].
         *
         ...
         */
        fun build(): MessageGetMessageByIdResponse =
            MessageGetMessageByIdResponse(
     ...
     *   expected type.
     */
    fun validate(): MessageGetMessageByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageGetMessageByIdResponse &&
    ...
    override fun toString() =
        "MessageGetMessageByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
