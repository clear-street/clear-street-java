...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RunCancelRunResponse].
         *
    ...
    /** A builder for [RunCancelRunResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(runCancelRunResponse: RunCancelRunResponse) = apply {
            metadata = runCancelRunResponse.metadata
            error = runCancelRunResponse.error
            data = runCancelRunResponse.data
            additionalProperties = runCancelRunResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RunCancelRunResponse].
         *
         ...
         */
        fun build(): RunCancelRunResponse =
    ...
    fun validate(): RunCancelRunResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunCancelRunResponse &&
    ...
    override fun toString() =
        "RunCancelRunResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
