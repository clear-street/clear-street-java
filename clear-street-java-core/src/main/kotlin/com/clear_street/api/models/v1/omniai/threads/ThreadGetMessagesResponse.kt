...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThreadGetMessagesResponse].
         *
    ...
    /** A builder for [ThreadGetMessagesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(threadGetMessagesResponse: ThreadGetMessagesResponse) = apply {
            metadata = threadGetMessagesResponse.metadata
            error = threadGetMessagesResponse.error
            data = threadGetMessagesResponse.data.map { it.toMutableList() }
            additionalProperties = threadGetMessagesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ThreadGetMessagesResponse].
         *
         ...
         */
        fun build(): ThreadGetMessagesResponse =
     ...
     *   expected type.
     */
    fun validate(): ThreadGetMessagesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadGetMessagesResponse &&
    ...
    override fun toString() =
        "ThreadGetMessagesResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
