...
private constructor(
    ...
    /** A builder for [AccountGetAccountBalancesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(accountGetAccountBalancesResponse: AccountGetAccountBalancesResponse) =
            apply {
                metadata = accountGetAccountBalancesResponse.metadata
                error = accountGetAccountBalancesResponse.error
                data = accountGetAccountBalancesResponse.data
                additionalProperties =
                    accountGetAccountBalancesResponse.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): AccountGetAccountBalancesResponse =
            AccountGetAccountBalancesResponse(
     ...
     *   expected type.
     */
    fun validate(): AccountGetAccountBalancesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountGetAccountBalancesResponse &&
    ...
    override fun toString() =
        "AccountGetAccountBalancesResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
