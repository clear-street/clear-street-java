...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InstrumentSearchResponse].
         *
    ...
    /** A builder for [InstrumentSearchResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(instrumentSearchResponse: InstrumentSearchResponse) = apply {
            metadata = instrumentSearchResponse.metadata
            error = instrumentSearchResponse.error
            data = instrumentSearchResponse.data.map { it.toMutableList() }
            additionalProperties = instrumentSearchResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InstrumentSearchResponse].
         *
         ...
         */
        fun build(): InstrumentSearchResponse =
     ...
     *   expected type.
     */
    fun validate(): InstrumentSearchResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentSearchResponse &&
    ...
    override fun toString() =
        "InstrumentSearchResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
