...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<OptionsContract>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<OptionsContract> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<OptionsContract>> = data
    ...
    /** A builder for [ContractGetOptionContractsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<OptionsContract>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(contractGetOptionContractsResponse: ContractGetOptionContractsResponse) =
            apply {
                metadata = contractGetOptionContractsResponse.metadata
                error = contractGetOptionContractsResponse.error
                data = contractGetOptionContractsResponse.data.map { it.toMutableList() }
                additionalProperties =
                    contractGetOptionContractsResponse.additionalProperties.toMutableMap()
            }
        ...
        fun data(data: List<OptionsContract>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<OptionsContract>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<OptionsContract>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [OptionsContract] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: OptionsContract) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [ContractGetOptionContractsResponse].
         *
         ...
         */
        fun build(): ContractGetOptionContractsResponse =
            ContractGetOptionContractsResponse(
    ...
    fun validate(): ContractGetOptionContractsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContractGetOptionContractsResponse &&
    ...
    override fun toString() =
        "ContractGetOptionContractsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
