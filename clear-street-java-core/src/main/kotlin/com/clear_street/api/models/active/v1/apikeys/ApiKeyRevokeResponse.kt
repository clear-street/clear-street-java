...
private constructor(
    ...
    private val data: JsonField<Revocation>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<Revocation> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): Revocation = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<Revocation> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<Revocation>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(apiKeyRevokeResponse: ApiKeyRevokeResponse) = apply {
            metadata = apiKeyRevokeResponse.metadata
            error = apiKeyRevokeResponse.error
        ...
        fun data(data: Revocation) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [Revocation] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<Revocation>) = apply { this.data = data }
    ...
    override fun toString() =
        "ApiKeyRevokeResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
