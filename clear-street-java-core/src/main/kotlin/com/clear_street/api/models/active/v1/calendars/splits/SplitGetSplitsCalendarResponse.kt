...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<StockSplitEvent>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<StockSplitEvent> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<StockSplitEvent>> = data
    ...
    /** A builder for [SplitGetSplitsCalendarResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<StockSplitEvent>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(splitGetSplitsCalendarResponse: SplitGetSplitsCalendarResponse) = apply {
            metadata = splitGetSplitsCalendarResponse.metadata
            error = splitGetSplitsCalendarResponse.error
            data = splitGetSplitsCalendarResponse.data.map { it.toMutableList() }
            additionalProperties =
                splitGetSplitsCalendarResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<StockSplitEvent>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<StockSplitEvent>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<StockSplitEvent>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [StockSplitEvent] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: StockSplitEvent) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [SplitGetSplitsCalendarResponse].
         *
         ...
         */
        fun build(): SplitGetSplitsCalendarResponse =
            SplitGetSplitsCalendarResponse(
    ...
    fun validate(): SplitGetSplitsCalendarResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SplitGetSplitsCalendarResponse &&
    ...
    override fun toString() =
        "SplitGetSplitsCalendarResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
