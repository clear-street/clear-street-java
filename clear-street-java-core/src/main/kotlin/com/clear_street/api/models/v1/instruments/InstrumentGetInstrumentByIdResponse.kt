...
private constructor(
    ...
    private val data: JsonField<Instrument>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<Instrument> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): Instrument = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<Instrument> = data
    ...
    /** A builder for [InstrumentGetInstrumentByIdResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<Instrument>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            instrumentGetInstrumentByIdResponse: InstrumentGetInstrumentByIdResponse
        ) = apply {
            metadata = instrumentGetInstrumentByIdResponse.metadata
            error = instrumentGetInstrumentByIdResponse.error
            data = instrumentGetInstrumentByIdResponse.data
            additionalProperties =
                instrumentGetInstrumentByIdResponse.additionalProperties.toMutableMap()
        }
        ...
        /** Represents a tradable financial instrument. */
        fun data(data: Instrument) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [Instrument] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<Instrument>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [InstrumentGetInstrumentByIdResponse].
         *
         ...
         */
        fun build(): InstrumentGetInstrumentByIdResponse =
            InstrumentGetInstrumentByIdResponse(
     ...
     *   expected type.
     */
    fun validate(): InstrumentGetInstrumentByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentGetInstrumentByIdResponse &&
    ...
    override fun toString() =
        "InstrumentGetInstrumentByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
