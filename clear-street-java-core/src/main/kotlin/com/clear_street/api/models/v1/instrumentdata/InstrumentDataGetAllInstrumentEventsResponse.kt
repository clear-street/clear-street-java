...
private constructor(
    ...
    /** A builder for [InstrumentDataGetAllInstrumentEventsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            metadata = instrumentDataGetAllInstrumentEventsResponse.metadata
            error = instrumentDataGetAllInstrumentEventsResponse.error
            data = instrumentDataGetAllInstrumentEventsResponse.data
            additionalProperties =
                instrumentDataGetAllInstrumentEventsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InstrumentDataGetAllInstrumentEventsResponse].
         *
         ...
         */
        fun build(): InstrumentDataGetAllInstrumentEventsResponse =
            InstrumentDataGetAllInstrumentEventsResponse(
     ...
     *   expected type.
     */
    fun validate(): InstrumentDataGetAllInstrumentEventsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentDataGetAllInstrumentEventsResponse &&
    ...
    override fun toString() =
        "InstrumentDataGetAllInstrumentEventsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
