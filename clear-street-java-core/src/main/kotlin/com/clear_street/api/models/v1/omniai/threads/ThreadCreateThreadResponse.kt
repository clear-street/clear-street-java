...
import com.clear_street.api.models.v1.omniai.CreateThreadResponse
...
private constructor(
    ...
    private val data: JsonField<CreateThreadResponse>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<CreateThreadResponse> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): CreateThreadResponse = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<CreateThreadResponse> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThreadCreateThreadResponse].
         *
    ...
    /** A builder for [ThreadCreateThreadResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<CreateThreadResponse>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(threadCreateThreadResponse: ThreadCreateThreadResponse) = apply {
            metadata = threadCreateThreadResponse.metadata
            error = threadCreateThreadResponse.error
            data = threadCreateThreadResponse.data
            additionalProperties = threadCreateThreadResponse.additionalProperties.toMutableMap()
        }
        ...
        /** Response payload for thread creation. */
        fun data(data: CreateThreadResponse) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [CreateThreadResponse] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<CreateThreadResponse>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [ThreadCreateThreadResponse].
         *
         ...
         */
        fun build(): ThreadCreateThreadResponse =
     ...
     *   expected type.
     */
    fun validate(): ThreadCreateThreadResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadCreateThreadResponse &&
    ...
    override fun toString() =
        "ThreadCreateThreadResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
