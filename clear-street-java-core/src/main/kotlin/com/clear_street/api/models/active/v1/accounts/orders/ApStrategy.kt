...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ApStrategy]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ApStrategy]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(apStrategy: ApStrategy) = apply {
            endAt = apStrategy.endAt
            startAt = apStrategy.startAt
            urgency = apStrategy.urgency
            maxPercent = apStrategy.maxPercent
            minPercent = apStrategy.minPercent
            additionalProperties = apStrategy.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ApStrategy].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ApStrategy =
            ApStrategy(
                endAt,
                startAt,
                urgency,
    ...
    override fun toString() =
        "ApStrategy{endAt=$endAt, startAt=$startAt, urgency=$urgency, maxPercent=$maxPercent, minPercent=$minPercent, additionalProperties=$additionalProperties}"
}
