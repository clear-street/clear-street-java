...
private constructor(
    ...
    ) : this(metadata, error, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BaseResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(baseResponse: BaseResponse) = apply {
            metadata = baseResponse.metadata
            error = baseResponse.error
            additionalProperties = baseResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BaseResponse].
         *
    ...
    fun validate(): BaseResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private val hashCode: Int by lazy { Objects.hash(metadata, error, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BaseResponse{metadata=$metadata, error=$error, additionalProperties=$additionalProperties}"
}
