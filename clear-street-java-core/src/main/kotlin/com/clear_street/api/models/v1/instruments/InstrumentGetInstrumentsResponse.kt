...
private constructor(
    ...
    /** A builder for [InstrumentGetInstrumentsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(instrumentGetInstrumentsResponse: InstrumentGetInstrumentsResponse) =
            apply {
                metadata = instrumentGetInstrumentsResponse.metadata
                error = instrumentGetInstrumentsResponse.error
                data = instrumentGetInstrumentsResponse.data.map { it.toMutableList() }
                additionalProperties =
                    instrumentGetInstrumentsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [InstrumentGetInstrumentsResponse].
         *
         ...
         */
        fun build(): InstrumentGetInstrumentsResponse =
            InstrumentGetInstrumentsResponse(
    ...
    fun validate(): InstrumentGetInstrumentsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentGetInstrumentsResponse &&
    ...
    override fun toString() =
        "InstrumentGetInstrumentsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
