...
private constructor(
    ...
    /** A builder for [ResponseGetResponseByIdResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(responseGetResponseByIdResponse: ResponseGetResponseByIdResponse) =
            apply {
                metadata = responseGetResponseByIdResponse.metadata
                error = responseGetResponseByIdResponse.error
                data = responseGetResponseByIdResponse.data
                additionalProperties =
                    responseGetResponseByIdResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ResponseGetResponseByIdResponse].
         *
         ...
         */
        fun build(): ResponseGetResponseByIdResponse =
            ResponseGetResponseByIdResponse(
     ...
     *   expected type.
     */
    fun validate(): ResponseGetResponseByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResponseGetResponseByIdResponse &&
    ...
    override fun toString() =
        "ResponseGetResponseByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
