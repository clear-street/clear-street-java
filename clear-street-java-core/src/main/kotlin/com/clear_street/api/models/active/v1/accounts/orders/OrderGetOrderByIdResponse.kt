...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrderGetOrderByIdResponse].
         *
    ...
    /** A builder for [OrderGetOrderByIdResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orderGetOrderByIdResponse: OrderGetOrderByIdResponse) = apply {
            metadata = orderGetOrderByIdResponse.metadata
            error = orderGetOrderByIdResponse.error
            data = orderGetOrderByIdResponse.data
            additionalProperties = orderGetOrderByIdResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrderGetOrderByIdResponse].
         *
         ...
         */
        fun build(): OrderGetOrderByIdResponse =
    ...
    fun validate(): OrderGetOrderByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrderGetOrderByIdResponse &&
    ...
    override fun toString() =
        "OrderGetOrderByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
