...
class OptionGetOptionContractsResponse
...
private constructor(
    ...
    /** A builder for [OptionGetOptionContractsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(optionGetOptionContractsResponse: OptionGetOptionContractsResponse) =
            apply {
                metadata = optionGetOptionContractsResponse.metadata
                error = optionGetOptionContractsResponse.error
                data = optionGetOptionContractsResponse.data.map { it.toMutableList() }
                additionalProperties =
                    optionGetOptionContractsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [OptionGetOptionContractsResponse].
         *
         ...
         */
        fun build(): OptionGetOptionContractsResponse =
            OptionGetOptionContractsResponse(
     ...
     *   expected type.
     */
    fun validate(): OptionGetOptionContractsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OptionGetOptionContractsResponse &&
    ...
    override fun toString() =
        "OptionGetOptionContractsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
