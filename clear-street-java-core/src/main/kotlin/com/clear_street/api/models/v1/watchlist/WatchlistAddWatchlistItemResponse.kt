...
private constructor(
    ...
    /** A builder for [WatchlistAddWatchlistItemResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(watchlistAddWatchlistItemResponse: WatchlistAddWatchlistItemResponse) =
            apply {
                metadata = watchlistAddWatchlistItemResponse.metadata
                error = watchlistAddWatchlistItemResponse.error
                data = watchlistAddWatchlistItemResponse.data
                additionalProperties =
                    watchlistAddWatchlistItemResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [WatchlistAddWatchlistItemResponse].
         *
         ...
         */
        fun build(): WatchlistAddWatchlistItemResponse =
            WatchlistAddWatchlistItemResponse(
     ...
     *   expected type.
     */
    fun validate(): WatchlistAddWatchlistItemResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WatchlistAddWatchlistItemResponse &&
    ...
    override fun toString() =
        "WatchlistAddWatchlistItemResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
