...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CalendarDateSummary>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<CalendarDateSummary> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<CalendarDateSummary>> = data
    ...
    /** A builder for [SummaryGetCalendarSummaryResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<CalendarDateSummary>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(summaryGetCalendarSummaryResponse: SummaryGetCalendarSummaryResponse) =
            apply {
                metadata = summaryGetCalendarSummaryResponse.metadata
                error = summaryGetCalendarSummaryResponse.error
                data = summaryGetCalendarSummaryResponse.data.map { it.toMutableList() }
                additionalProperties =
                    summaryGetCalendarSummaryResponse.additionalProperties.toMutableMap()
            }
        ...
        fun data(data: List<CalendarDateSummary>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<CalendarDateSummary>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<CalendarDateSummary>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CalendarDateSummary] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CalendarDateSummary) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [SummaryGetCalendarSummaryResponse].
         *
         ...
         */
        fun build(): SummaryGetCalendarSummaryResponse =
            SummaryGetCalendarSummaryResponse(
    ...
    fun validate(): SummaryGetCalendarSummaryResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SummaryGetCalendarSummaryResponse &&
    ...
    override fun toString() =
        "SummaryGetCalendarSummaryResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
