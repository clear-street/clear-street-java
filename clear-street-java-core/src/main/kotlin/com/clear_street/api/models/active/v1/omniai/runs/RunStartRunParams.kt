...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RunStartRunParams].
         *
    ...
    /** A builder for [RunStartRunParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(runStartRunParams: RunStartRunParams) = apply {
            body = runStartRunParams.body.toBuilder()
            additionalHeaders = runStartRunParams.additionalHeaders.toBuilder()
            additionalQueryParams = runStartRunParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RunStartRunParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RunStartRunParams &&
            body == other.body &&
    ...
    override fun toString() =
        "RunStartRunParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
