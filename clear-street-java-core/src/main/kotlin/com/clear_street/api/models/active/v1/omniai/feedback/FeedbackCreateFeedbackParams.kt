...
private constructor(
     ...
     * ```java
     * MyClass myObject = feedbackCreateFeedbackParams.metadata().convert(MyClass.class);
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FeedbackCreateFeedbackParams].
         *
    ...
    /** A builder for [FeedbackCreateFeedbackParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(feedbackCreateFeedbackParams: FeedbackCreateFeedbackParams) = apply {
            body = feedbackCreateFeedbackParams.body.toBuilder()
            additionalHeaders = feedbackCreateFeedbackParams.additionalHeaders.toBuilder()
            additionalQueryParams = feedbackCreateFeedbackParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FeedbackCreateFeedbackParams].
         *
         ...
         */
        fun build(): FeedbackCreateFeedbackParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeedbackCreateFeedbackParams &&
            body == other.body &&
    ...
    override fun toString() =
        "FeedbackCreateFeedbackParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
