...
class SavedScreenerCreateScreenerResponse
...
private constructor(
    ...
    /** A builder for [SavedScreenerCreateScreenerResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            savedScreenerCreateScreenerResponse: SavedScreenerCreateScreenerResponse
        ) = apply {
            metadata = savedScreenerCreateScreenerResponse.metadata
            error = savedScreenerCreateScreenerResponse.error
            data = savedScreenerCreateScreenerResponse.data
            additionalProperties =
                savedScreenerCreateScreenerResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SavedScreenerCreateScreenerResponse].
         *
         ...
         */
        fun build(): SavedScreenerCreateScreenerResponse =
            SavedScreenerCreateScreenerResponse(
    ...
    fun validate(): SavedScreenerCreateScreenerResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SavedScreenerCreateScreenerResponse &&
    ...
    override fun toString() =
        "SavedScreenerCreateScreenerResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
