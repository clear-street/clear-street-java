...
class FeedbackCreateFeedbackDeprecatedParams
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun threadId(): String = body.threadId()
     ...
     * ```java
     * MyClass myObject = feedbackCreateFeedbackDeprecatedParams.metadata().convert(MyClass.class);
     * ```
     */
    ...
    /** A builder for [FeedbackCreateFeedbackDeprecatedParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            feedbackCreateFeedbackDeprecatedParams: FeedbackCreateFeedbackDeprecatedParams
        ) = apply {
            body = feedbackCreateFeedbackDeprecatedParams.body.toBuilder()
            additionalHeaders = feedbackCreateFeedbackDeprecatedParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                feedbackCreateFeedbackDeprecatedParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FeedbackCreateFeedbackDeprecatedParams].
         *
         ...
         */
        fun build(): FeedbackCreateFeedbackDeprecatedParams =
            FeedbackCreateFeedbackDeprecatedParams(
                body.build(),
    ...
    private constructor(
        ...
        ) : this(accountId, messageId, score, threadId, comment, metadata, mutableMapOf())
        ...
        override fun toString() =
            "Body{accountId=$accountId, messageId=$messageId, score=$score, threadId=$threadId, comment=$comment, metadata=$metadata, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeedbackCreateFeedbackDeprecatedParams &&
            body == other.body &&
    ...
    override fun toString() =
        "FeedbackCreateFeedbackDeprecatedParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
