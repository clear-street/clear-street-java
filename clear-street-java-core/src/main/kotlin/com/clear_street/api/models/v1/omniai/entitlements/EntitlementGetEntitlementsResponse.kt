...
private constructor(
    ...
    /** A builder for [EntitlementGetEntitlementsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entitlementGetEntitlementsResponse: EntitlementGetEntitlementsResponse) =
            apply {
                metadata = entitlementGetEntitlementsResponse.metadata
                error = entitlementGetEntitlementsResponse.error
                data = entitlementGetEntitlementsResponse.data.map { it.toMutableList() }
                additionalProperties =
                    entitlementGetEntitlementsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [EntitlementGetEntitlementsResponse].
         *
         ...
         */
        fun build(): EntitlementGetEntitlementsResponse =
            EntitlementGetEntitlementsResponse(
     ...
     *   expected type.
     */
    fun validate(): EntitlementGetEntitlementsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntitlementGetEntitlementsResponse &&
    ...
    override fun toString() =
        "EntitlementGetEntitlementsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
