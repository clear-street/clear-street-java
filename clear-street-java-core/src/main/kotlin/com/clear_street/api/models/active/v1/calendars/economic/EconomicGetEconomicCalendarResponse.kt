...
class EconomicGetEconomicCalendarResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<List<EconomicCalendarEvent>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<EconomicCalendarEvent>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<EconomicCalendarEvent> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<EconomicCalendarEvent>> = data
    ...
    /** A builder for [EconomicGetEconomicCalendarResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<EconomicCalendarEvent>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            economicGetEconomicCalendarResponse: EconomicGetEconomicCalendarResponse
        ) = apply {
            metadata = economicGetEconomicCalendarResponse.metadata
            error = economicGetEconomicCalendarResponse.error
            data = economicGetEconomicCalendarResponse.data.map { it.toMutableList() }
            additionalProperties =
                economicGetEconomicCalendarResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<EconomicCalendarEvent>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<EconomicCalendarEvent>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<EconomicCalendarEvent>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [EconomicCalendarEvent] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: EconomicCalendarEvent) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [EconomicGetEconomicCalendarResponse].
         *
         ...
         */
        fun build(): EconomicGetEconomicCalendarResponse =
            EconomicGetEconomicCalendarResponse(
    ...
    fun validate(): EconomicGetEconomicCalendarResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EconomicGetEconomicCalendarResponse &&
    ...
    override fun toString() =
        "EconomicGetEconomicCalendarResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
