...
private constructor(
    ...
    private val data: JsonField<WatchlistDetail>,
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<WatchlistDetail> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): WatchlistDetail = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<WatchlistDetail> = data
    ...
    /** A builder for [WatchlistGetWatchlistByIdResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<WatchlistDetail>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(watchlistGetWatchlistByIdResponse: WatchlistGetWatchlistByIdResponse) =
            apply {
                metadata = watchlistGetWatchlistByIdResponse.metadata
                error = watchlistGetWatchlistByIdResponse.error
                data = watchlistGetWatchlistByIdResponse.data
                additionalProperties =
                    watchlistGetWatchlistByIdResponse.additionalProperties.toMutableMap()
            }
        ...
        /** Detailed watchlist with all items */
        fun data(data: WatchlistDetail) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [WatchlistDetail] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<WatchlistDetail>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [WatchlistGetWatchlistByIdResponse].
         *
         ...
         */
        fun build(): WatchlistGetWatchlistByIdResponse =
            WatchlistGetWatchlistByIdResponse(
    ...
    fun validate(): WatchlistGetWatchlistByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WatchlistGetWatchlistByIdResponse &&
    ...
    override fun toString() =
        "WatchlistGetWatchlistByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
