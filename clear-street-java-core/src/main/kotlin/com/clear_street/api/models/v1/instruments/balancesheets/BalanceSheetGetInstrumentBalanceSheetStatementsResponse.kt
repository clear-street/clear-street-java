...
package com.clear_street.api.models.v1.instruments.balancesheets
...
class BalanceSheetGetInstrumentBalanceSheetStatementsResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<List<InstrumentBalanceSheetStatement>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<InstrumentBalanceSheetStatement>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<InstrumentBalanceSheetStatement> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<InstrumentBalanceSheetStatement>> = data
    ...
    /** A builder for [BalanceSheetGetInstrumentBalanceSheetStatementsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<InstrumentBalanceSheetStatement>>? = null
        ...
        internal fun from(
            ...
            metadata = balanceSheetGetInstrumentBalanceSheetStatementsResponse.metadata
            error = balanceSheetGetInstrumentBalanceSheetStatementsResponse.error
            data =
                balanceSheetGetInstrumentBalanceSheetStatementsResponse.data.map {
                    it.toMutableList()
                }
            additionalProperties =
                balanceSheetGetInstrumentBalanceSheetStatementsResponse.additionalProperties
                    .toMutableMap()
        }
        ...
        fun data(data: List<InstrumentBalanceSheetStatement>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<InstrumentBalanceSheetStatement>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<InstrumentBalanceSheetStatement>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [InstrumentBalanceSheetStatement] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: InstrumentBalanceSheetStatement) = apply {
            this.data =
         ...
         */
        fun build(): BalanceSheetGetInstrumentBalanceSheetStatementsResponse =
            BalanceSheetGetInstrumentBalanceSheetStatementsResponse(
    ...
    fun validate(): BalanceSheetGetInstrumentBalanceSheetStatementsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BalanceSheetGetInstrumentBalanceSheetStatementsResponse &&
    ...
    override fun toString() =
        "BalanceSheetGetInstrumentBalanceSheetStatementsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
