...
class DividendGetDividendsCalendarParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DividendGetDividendsCalendarParams = builder().build()
    ...
    /** A builder for [DividendGetDividendsCalendarParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dividendGetDividendsCalendarParams: DividendGetDividendsCalendarParams) =
            apply {
                from = dividendGetDividendsCalendarParams.from
                to = dividendGetDividendsCalendarParams.to
                additionalHeaders = dividendGetDividendsCalendarParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    dividendGetDividendsCalendarParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [DividendGetDividendsCalendarParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DividendGetDividendsCalendarParams =
            DividendGetDividendsCalendarParams(
                from,
                to,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DividendGetDividendsCalendarParams &&
            from == other.from &&
            to == other.to &&
    ...
    override fun toString() =
        "DividendGetDividendsCalendarParams{from=$from, to=$to, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
