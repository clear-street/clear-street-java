...
class EconomicGetEconomicCalendarParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EconomicGetEconomicCalendarParams = builder().build()
    ...
    /** A builder for [EconomicGetEconomicCalendarParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(economicGetEconomicCalendarParams: EconomicGetEconomicCalendarParams) =
            apply {
                from = economicGetEconomicCalendarParams.from
                to = economicGetEconomicCalendarParams.to
                additionalHeaders = economicGetEconomicCalendarParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    economicGetEconomicCalendarParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EconomicGetEconomicCalendarParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EconomicGetEconomicCalendarParams =
            EconomicGetEconomicCalendarParams(
                from,
                to,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EconomicGetEconomicCalendarParams &&
            from == other.from &&
            to == other.to &&
    ...
    override fun toString() =
        "EconomicGetEconomicCalendarParams{from=$from, to=$to, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
