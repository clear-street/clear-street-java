 ...
 */
class MarketHourGetMarketHoursCalendarParams
private constructor(
    ...
    /** A builder for [MarketHourGetMarketHoursCalendarParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            marketHourGetMarketHoursCalendarParams: MarketHourGetMarketHoursCalendarParams
        ) = apply {
            date = marketHourGetMarketHoursCalendarParams.date
            market = marketHourGetMarketHoursCalendarParams.market
            additionalHeaders = marketHourGetMarketHoursCalendarParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                marketHourGetMarketHoursCalendarParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MarketHourGetMarketHoursCalendarParams].
         *
         ...
         */
        fun build(): MarketHourGetMarketHoursCalendarParams =
            MarketHourGetMarketHoursCalendarParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MarketHourGetMarketHoursCalendarParams &&
            date == other.date &&
            market == other.market &&
    ...
    override fun toString() =
        "MarketHourGetMarketHoursCalendarParams{date=$date, market=$market, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
