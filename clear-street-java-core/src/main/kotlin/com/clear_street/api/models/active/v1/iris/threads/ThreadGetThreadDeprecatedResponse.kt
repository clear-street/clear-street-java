...
class ThreadGetThreadDeprecatedResponse
...
private constructor(
    ...
    /** A builder for [ThreadGetThreadDeprecatedResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(threadGetThreadDeprecatedResponse: ThreadGetThreadDeprecatedResponse) =
            apply {
                metadata = threadGetThreadDeprecatedResponse.metadata
                error = threadGetThreadDeprecatedResponse.error
                data = threadGetThreadDeprecatedResponse.data
                additionalProperties =
                    threadGetThreadDeprecatedResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ThreadGetThreadDeprecatedResponse].
         *
         ...
         */
        fun build(): ThreadGetThreadDeprecatedResponse =
            ThreadGetThreadDeprecatedResponse(
    ...
    fun validate(): ThreadGetThreadDeprecatedResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadGetThreadDeprecatedResponse &&
    ...
    override fun toString() =
        "ThreadGetThreadDeprecatedResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
