...
class AccountType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    fun known(): Known =
        when (this) {
            ...
            OTHER -> Known.OTHER
            else -> throw ClearStreetInvalidDataException("Unknown AccountType: $value")
        }
