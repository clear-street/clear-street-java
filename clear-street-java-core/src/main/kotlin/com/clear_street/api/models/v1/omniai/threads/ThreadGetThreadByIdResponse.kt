...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ThreadGetThreadByIdResponse].
         *
    ...
    /** A builder for [ThreadGetThreadByIdResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(threadGetThreadByIdResponse: ThreadGetThreadByIdResponse) = apply {
            metadata = threadGetThreadByIdResponse.metadata
            error = threadGetThreadByIdResponse.error
            data = threadGetThreadByIdResponse.data
            additionalProperties = threadGetThreadByIdResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ThreadGetThreadByIdResponse].
         *
         ...
         */
        fun build(): ThreadGetThreadByIdResponse =
     ...
     *   expected type.
     */
    fun validate(): ThreadGetThreadByIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadGetThreadByIdResponse &&
    ...
    override fun toString() =
        "ThreadGetThreadByIdResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
