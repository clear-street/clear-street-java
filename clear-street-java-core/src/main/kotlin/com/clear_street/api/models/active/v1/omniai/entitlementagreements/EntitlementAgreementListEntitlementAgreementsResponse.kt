...
class EntitlementAgreementListEntitlementAgreementsResponse
...
private constructor(
    ...
    /** A builder for [EntitlementAgreementListEntitlementAgreementsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            metadata = entitlementAgreementListEntitlementAgreementsResponse.metadata
            error = entitlementAgreementListEntitlementAgreementsResponse.error
            data =
                entitlementAgreementListEntitlementAgreementsResponse.data.map {
                    it.toMutableList()
                }
            additionalProperties =
                entitlementAgreementListEntitlementAgreementsResponse.additionalProperties
                    .toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EntitlementAgreementListEntitlementAgreementsResponse].
         *
         ...
         */
        fun build(): EntitlementAgreementListEntitlementAgreementsResponse =
            EntitlementAgreementListEntitlementAgreementsResponse(
    ...
    fun validate(): EntitlementAgreementListEntitlementAgreementsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntitlementAgreementListEntitlementAgreementsResponse &&
    ...
    override fun toString() =
        "EntitlementAgreementListEntitlementAgreementsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
