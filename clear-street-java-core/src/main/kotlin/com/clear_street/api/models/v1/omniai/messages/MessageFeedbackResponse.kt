...
import com.clear_street.api.models.v1.omniai.CreateFeedbackResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageFeedbackResponse].
         *
    ...
    /** A builder for [MessageFeedbackResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageFeedbackResponse: MessageFeedbackResponse) = apply {
            metadata = messageFeedbackResponse.metadata
            error = messageFeedbackResponse.error
            data = messageFeedbackResponse.data
            additionalProperties = messageFeedbackResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageFeedbackResponse].
         *
         ...
         */
        fun build(): MessageFeedbackResponse =
     ...
     *   expected type.
     */
    fun validate(): MessageFeedbackResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageFeedbackResponse &&
    ...
    override fun toString() =
        "MessageFeedbackResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
