...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OptionContractsResponse].
         *
    ...
    /** A builder for [OptionContractsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(optionContractsResponse: OptionContractsResponse) = apply {
            metadata = optionContractsResponse.metadata
            error = optionContractsResponse.error
            data = optionContractsResponse.data.map { it.toMutableList() }
            additionalProperties = optionContractsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OptionContractsResponse].
         *
         ...
         */
        fun build(): OptionContractsResponse =
    ...
    fun validate(): OptionContractsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OptionContractsResponse &&
    ...
    override fun toString() =
        "OptionContractsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
