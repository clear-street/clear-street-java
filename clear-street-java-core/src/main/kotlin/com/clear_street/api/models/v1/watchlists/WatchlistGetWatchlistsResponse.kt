...
private constructor(
    ...
    private val data: JsonField<List<WatchlistEntry>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<WatchlistEntry>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<WatchlistEntry> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<WatchlistEntry>> = data
    ...
    /** A builder for [WatchlistGetWatchlistsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<WatchlistEntry>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(watchlistGetWatchlistsResponse: WatchlistGetWatchlistsResponse) = apply {
            metadata = watchlistGetWatchlistsResponse.metadata
            error = watchlistGetWatchlistsResponse.error
            data = watchlistGetWatchlistsResponse.data.map { it.toMutableList() }
            additionalProperties =
                watchlistGetWatchlistsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<WatchlistEntry>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<WatchlistEntry>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<WatchlistEntry>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [WatchlistEntry] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: WatchlistEntry) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [WatchlistGetWatchlistsResponse].
         *
         ...
         */
        fun build(): WatchlistGetWatchlistsResponse =
            WatchlistGetWatchlistsResponse(
     ...
     *   expected type.
     */
    fun validate(): WatchlistGetWatchlistsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WatchlistGetWatchlistsResponse &&
    ...
    override fun toString() =
        "WatchlistGetWatchlistsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
