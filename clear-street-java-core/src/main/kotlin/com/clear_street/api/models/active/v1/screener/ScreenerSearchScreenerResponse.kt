...
private constructor(
    ...
    private val data: JsonField<List<List<ScreenerColumn>>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<List<ScreenerColumn>>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<List<ScreenerColumn>> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<List<ScreenerColumn>>> = data
    ...
    /** A builder for [ScreenerSearchScreenerResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<List<ScreenerColumn>>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(screenerSearchScreenerResponse: ScreenerSearchScreenerResponse) = apply {
            metadata = screenerSearchScreenerResponse.metadata
            error = screenerSearchScreenerResponse.error
            data = screenerSearchScreenerResponse.data.map { it.toMutableList() }
            additionalProperties =
                screenerSearchScreenerResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: List<List<ScreenerColumn>>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<List<ScreenerColumn>>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<List<ScreenerColumn>>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [List<ScreenerColumn>] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: List<ScreenerColumn>) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [ScreenerSearchScreenerResponse].
         *
         ...
         */
        fun build(): ScreenerSearchScreenerResponse =
            ScreenerSearchScreenerResponse(
    ...
    fun validate(): ScreenerSearchScreenerResponse = apply {
        if (validated) {
            return@apply
        }
        ...
        data().forEach { it.forEach { it.validate() } }
        validated = true
    }
    ...
    internal fun validity(): Int =
        (metadata.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            (data.asKnown().getOrNull()?.sumOf { it.sumOf { it.validity().toInt() }.toInt() } ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ScreenerSearchScreenerResponse &&
    ...
    override fun toString() =
        "ScreenerSearchScreenerResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
