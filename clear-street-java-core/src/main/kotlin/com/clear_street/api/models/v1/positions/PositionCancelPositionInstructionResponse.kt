...
private constructor(
    ...
    /** A builder for [PositionCancelPositionInstructionResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            positionCancelPositionInstructionResponse: PositionCancelPositionInstructionResponse
        ) = apply {
            metadata = positionCancelPositionInstructionResponse.metadata
            error = positionCancelPositionInstructionResponse.error
            data = positionCancelPositionInstructionResponse.data
            additionalProperties =
                positionCancelPositionInstructionResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PositionCancelPositionInstructionResponse].
         *
     ...
     *   expected type.
     */
    fun validate(): PositionCancelPositionInstructionResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PositionCancelPositionInstructionResponse &&
    ...
    override fun toString() =
        "PositionCancelPositionInstructionResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
