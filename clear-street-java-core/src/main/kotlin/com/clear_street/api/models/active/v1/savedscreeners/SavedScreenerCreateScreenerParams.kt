...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): SavedScreenerCreateScreenerParams = builder().build()
    ...
    /** A builder for [SavedScreenerCreateScreenerParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(savedScreenerCreateScreenerParams: SavedScreenerCreateScreenerParams) =
            apply {
                body = savedScreenerCreateScreenerParams.body.toBuilder()
                additionalHeaders = savedScreenerCreateScreenerParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    savedScreenerCreateScreenerParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [SavedScreenerCreateScreenerParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SavedScreenerCreateScreenerParams =
            SavedScreenerCreateScreenerParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SavedScreenerCreateScreenerParams &&
            body == other.body &&
    ...
    override fun toString() =
        "SavedScreenerCreateScreenerParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
