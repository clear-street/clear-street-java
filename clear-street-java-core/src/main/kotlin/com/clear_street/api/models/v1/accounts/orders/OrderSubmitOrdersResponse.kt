...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrderSubmitOrdersResponse].
         *
    ...
    /** A builder for [OrderSubmitOrdersResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orderSubmitOrdersResponse: OrderSubmitOrdersResponse) = apply {
            metadata = orderSubmitOrdersResponse.metadata
            error = orderSubmitOrdersResponse.error
            data = orderSubmitOrdersResponse.data.map { it.toMutableList() }
            additionalProperties = orderSubmitOrdersResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrderSubmitOrdersResponse].
         *
         ...
         */
        fun build(): OrderSubmitOrdersResponse =
     ...
     *   expected type.
     */
    fun validate(): OrderSubmitOrdersResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrderSubmitOrdersResponse &&
    ...
    override fun toString() =
        "OrderSubmitOrdersResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
