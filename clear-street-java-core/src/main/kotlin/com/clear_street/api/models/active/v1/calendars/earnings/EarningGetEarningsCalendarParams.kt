...
class EarningGetEarningsCalendarParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EarningGetEarningsCalendarParams = builder().build()
    ...
    /** A builder for [EarningGetEarningsCalendarParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(earningGetEarningsCalendarParams: EarningGetEarningsCalendarParams) =
            apply {
                from = earningGetEarningsCalendarParams.from
                to = earningGetEarningsCalendarParams.to
                additionalHeaders = earningGetEarningsCalendarParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    earningGetEarningsCalendarParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [EarningGetEarningsCalendarParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EarningGetEarningsCalendarParams =
            EarningGetEarningsCalendarParams(
                from,
                to,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EarningGetEarningsCalendarParams &&
            from == other.from &&
            to == other.to &&
    ...
    override fun toString() =
        "EarningGetEarningsCalendarParams{from=$from, to=$to, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
