...
class IncomeStatementGetInstrumentIncomeStatementsResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val metadata: JsonField<ResponseMetadata>,
    private val error: JsonField<ApiError>,
    private val data: JsonField<List<InstrumentIncomeStatement>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<InstrumentIncomeStatement>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<InstrumentIncomeStatement> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<InstrumentIncomeStatement>> = data
    ...
    /** A builder for [IncomeStatementGetInstrumentIncomeStatementsResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<MutableList<InstrumentIncomeStatement>>? = null
        ...
        internal fun from(
            ...
            metadata = incomeStatementGetInstrumentIncomeStatementsResponse.metadata
            error = incomeStatementGetInstrumentIncomeStatementsResponse.error
            data =
                incomeStatementGetInstrumentIncomeStatementsResponse.data.map { it.toMutableList() }
            additionalProperties =
                incomeStatementGetInstrumentIncomeStatementsResponse.additionalProperties
                    .toMutableMap()
        }
        ...
        fun data(data: List<InstrumentIncomeStatement>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<InstrumentIncomeStatement>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<InstrumentIncomeStatement>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [InstrumentIncomeStatement] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: InstrumentIncomeStatement) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [IncomeStatementGetInstrumentIncomeStatementsResponse].
         *
         ...
         */
        fun build(): IncomeStatementGetInstrumentIncomeStatementsResponse =
            IncomeStatementGetInstrumentIncomeStatementsResponse(
    ...
    fun validate(): IncomeStatementGetInstrumentIncomeStatementsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IncomeStatementGetInstrumentIncomeStatementsResponse &&
    ...
    override fun toString() =
        "IncomeStatementGetInstrumentIncomeStatementsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
