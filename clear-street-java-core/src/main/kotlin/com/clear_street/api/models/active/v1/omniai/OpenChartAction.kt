...
private constructor(
     ...
     * ```java
     * MyClass myObject = openChartAction.extras().convert(MyClass.class);
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OpenChartAction].
         *
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [OpenChartAction].
         *
    ...
    fun validate(): OpenChartAction = apply {
        if (validated) {
            return@apply
        }
