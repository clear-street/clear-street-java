...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrderReplaceOrderResponse].
         *
    ...
    /** A builder for [OrderReplaceOrderResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orderReplaceOrderResponse: OrderReplaceOrderResponse) = apply {
            metadata = orderReplaceOrderResponse.metadata
            error = orderReplaceOrderResponse.error
            data = orderReplaceOrderResponse.data
            additionalProperties = orderReplaceOrderResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrderReplaceOrderResponse].
         *
         ...
         */
        fun build(): OrderReplaceOrderResponse =
     ...
     *   expected type.
     */
    fun validate(): OrderReplaceOrderResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrderReplaceOrderResponse &&
    ...
    override fun toString() =
        "OrderReplaceOrderResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
