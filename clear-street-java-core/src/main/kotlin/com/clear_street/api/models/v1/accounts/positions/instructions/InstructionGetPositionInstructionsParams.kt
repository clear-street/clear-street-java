 ...
 */
class InstructionGetPositionInstructionsParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): InstructionGetPositionInstructionsParams = builder().build()
    ...
    /** A builder for [InstructionGetPositionInstructionsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            instructionGetPositionInstructionsParams: InstructionGetPositionInstructionsParams
        ) = apply {
            accountId = instructionGetPositionInstructionsParams.accountId
            instrumentId = instructionGetPositionInstructionsParams.instrumentId
            additionalHeaders =
                instructionGetPositionInstructionsParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                instructionGetPositionInstructionsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [InstructionGetPositionInstructionsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InstructionGetPositionInstructionsParams =
            InstructionGetPositionInstructionsParams(
                accountId,
                instrumentId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstructionGetPositionInstructionsParams &&
    ...
    override fun toString() =
        "InstructionGetPositionInstructionsParams{accountId=$accountId, instrumentId=$instrumentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
