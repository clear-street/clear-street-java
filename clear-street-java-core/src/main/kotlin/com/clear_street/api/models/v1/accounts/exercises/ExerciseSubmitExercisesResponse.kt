...
class ExerciseSubmitExercisesResponse
...
private constructor(
    ...
    /** A builder for [ExerciseSubmitExercisesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(exerciseSubmitExercisesResponse: ExerciseSubmitExercisesResponse) =
            apply {
                metadata = exerciseSubmitExercisesResponse.metadata
                error = exerciseSubmitExercisesResponse.error
                data = exerciseSubmitExercisesResponse.data.map { it.toMutableList() }
                additionalProperties =
                    exerciseSubmitExercisesResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ExerciseSubmitExercisesResponse].
         *
         ...
         */
        fun build(): ExerciseSubmitExercisesResponse =
            ExerciseSubmitExercisesResponse(
     ...
     *   expected type.
     */
    fun validate(): ExerciseSubmitExercisesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExerciseSubmitExercisesResponse &&
    ...
    override fun toString() =
        "ExerciseSubmitExercisesResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
