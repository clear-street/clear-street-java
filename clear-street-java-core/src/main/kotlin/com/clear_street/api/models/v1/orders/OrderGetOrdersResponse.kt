...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrderGetOrdersResponse].
         *
    ...
    /** A builder for [OrderGetOrdersResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orderGetOrdersResponse: OrderGetOrdersResponse) = apply {
            metadata = orderGetOrdersResponse.metadata
            error = orderGetOrdersResponse.error
            data = orderGetOrdersResponse.data.map { it.toMutableList() }
            additionalProperties = orderGetOrdersResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrderGetOrdersResponse].
         *
         ...
         */
        fun build(): OrderGetOrdersResponse =
     ...
     *   expected type.
     */
    fun validate(): OrderGetOrdersResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrderGetOrdersResponse &&
    ...
    override fun toString() =
        "OrderGetOrdersResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
