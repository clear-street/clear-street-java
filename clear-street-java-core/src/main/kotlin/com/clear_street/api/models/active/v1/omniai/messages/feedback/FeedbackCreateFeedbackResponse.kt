...
package com.clear_street.api.models.active.v1.omniai.messages.feedback
...
class FeedbackCreateFeedbackResponse
...
private constructor(
    ...
    /** A builder for [FeedbackCreateFeedbackResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(feedbackCreateFeedbackResponse: FeedbackCreateFeedbackResponse) = apply {
            metadata = feedbackCreateFeedbackResponse.metadata
            error = feedbackCreateFeedbackResponse.error
            data = feedbackCreateFeedbackResponse.data
            additionalProperties =
                feedbackCreateFeedbackResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FeedbackCreateFeedbackResponse].
         *
         ...
         */
        fun build(): FeedbackCreateFeedbackResponse =
            FeedbackCreateFeedbackResponse(
    ...
    fun validate(): FeedbackCreateFeedbackResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeedbackCreateFeedbackResponse &&
    ...
    override fun toString() =
        "FeedbackCreateFeedbackResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
