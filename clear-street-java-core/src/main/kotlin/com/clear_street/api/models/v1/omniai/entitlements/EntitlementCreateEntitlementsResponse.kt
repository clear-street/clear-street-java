...
private constructor(
    ...
    /** A builder for [EntitlementCreateEntitlementsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            entitlementCreateEntitlementsResponse: EntitlementCreateEntitlementsResponse
        ) = apply {
            metadata = entitlementCreateEntitlementsResponse.metadata
            error = entitlementCreateEntitlementsResponse.error
            data = entitlementCreateEntitlementsResponse.data.map { it.toMutableList() }
            additionalProperties =
                entitlementCreateEntitlementsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EntitlementCreateEntitlementsResponse].
         *
         ...
         */
        fun build(): EntitlementCreateEntitlementsResponse =
            EntitlementCreateEntitlementsResponse(
    ...
    fun validate(): EntitlementCreateEntitlementsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntitlementCreateEntitlementsResponse &&
    ...
    override fun toString() =
        "EntitlementCreateEntitlementsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
