...
private constructor(
    ...
    private val data: JsonField<List<ApiKeyListEntry>>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<ApiKeyListEntry>> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): List<ApiKeyListEntry> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ApiKeyListEntry>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<ApiKeyListEntry>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(apiKeyListResponse: ApiKeyListResponse) = apply {
            metadata = apiKeyListResponse.metadata
            error = apiKeyListResponse.error
        ...
        fun data(data: List<ApiKeyListEntry>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<ApiKeyListEntry>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<ApiKeyListEntry>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ApiKeyListEntry] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ApiKeyListEntry) = apply {
            this.data =
    ...
    override fun toString() =
        "ApiKeyListResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
