...
private constructor(
    ...
    /** A builder for [InstrumentGetOptionContractsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            instrumentGetOptionContractsResponse: InstrumentGetOptionContractsResponse
        ) = apply {
            metadata = instrumentGetOptionContractsResponse.metadata
            error = instrumentGetOptionContractsResponse.error
            data = instrumentGetOptionContractsResponse.data.map { it.toMutableList() }
            additionalProperties =
                instrumentGetOptionContractsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InstrumentGetOptionContractsResponse].
         *
         ...
         */
        fun build(): InstrumentGetOptionContractsResponse =
            InstrumentGetOptionContractsResponse(
     ...
     *   expected type.
     */
    fun validate(): InstrumentGetOptionContractsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentGetOptionContractsResponse &&
    ...
    override fun toString() =
        "InstrumentGetOptionContractsResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
