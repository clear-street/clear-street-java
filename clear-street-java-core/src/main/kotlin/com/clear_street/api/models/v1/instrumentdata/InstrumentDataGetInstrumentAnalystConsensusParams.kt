...
class InstrumentDataGetInstrumentAnalystConsensusParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): InstrumentDataGetInstrumentAnalystConsensusParams = builder().build()
    ...
    /** A builder for [InstrumentDataGetInstrumentAnalystConsensusParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            instrumentId = instrumentDataGetInstrumentAnalystConsensusParams.instrumentId
            from = instrumentDataGetInstrumentAnalystConsensusParams.from
            to = instrumentDataGetInstrumentAnalystConsensusParams.to
            additionalHeaders =
                instrumentDataGetInstrumentAnalystConsensusParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                instrumentDataGetInstrumentAnalystConsensusParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [InstrumentDataGetInstrumentAnalystConsensusParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InstrumentDataGetInstrumentAnalystConsensusParams =
            InstrumentDataGetInstrumentAnalystConsensusParams(
                instrumentId,
                from,
                to,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InstrumentDataGetInstrumentAnalystConsensusParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(instrumentId, from, to, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "InstrumentDataGetInstrumentAnalystConsensusParams{instrumentId=$instrumentId, from=$from, to=$to, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
