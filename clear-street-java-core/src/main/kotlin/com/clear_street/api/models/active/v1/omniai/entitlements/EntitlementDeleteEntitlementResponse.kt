...
private constructor(
    ...
    private val data: JsonField<DeleteEntitlementResponse>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<DeleteEntitlementResponse> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): DeleteEntitlementResponse = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<DeleteEntitlementResponse> = data
    ...
    /** A builder for [EntitlementDeleteEntitlementResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<DeleteEntitlementResponse>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            entitlementDeleteEntitlementResponse: EntitlementDeleteEntitlementResponse
        ) = apply {
            metadata = entitlementDeleteEntitlementResponse.metadata
            error = entitlementDeleteEntitlementResponse.error
            data = entitlementDeleteEntitlementResponse.data
            additionalProperties =
                entitlementDeleteEntitlementResponse.additionalProperties.toMutableMap()
        }
        ...
        fun data(data: DeleteEntitlementResponse) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [DeleteEntitlementResponse]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<DeleteEntitlementResponse>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [EntitlementDeleteEntitlementResponse].
         *
         ...
         */
        fun build(): EntitlementDeleteEntitlementResponse =
            EntitlementDeleteEntitlementResponse(
    ...
    fun validate(): EntitlementDeleteEntitlementResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntitlementDeleteEntitlementResponse &&
    ...
    override fun toString() =
        "EntitlementDeleteEntitlementResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
