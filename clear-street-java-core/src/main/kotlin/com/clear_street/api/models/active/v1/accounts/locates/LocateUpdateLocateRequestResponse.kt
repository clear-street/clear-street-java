...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("data") @ExcludeMissing data: JsonField<LocateOrder> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): LocateOrder = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<LocateOrder> = data
    ...
    /** A builder for [LocateUpdateLocateRequestResponse]. */
    class Builder internal constructor() {

        private var metadata: JsonField<ResponseMetadata>? = null
        private var error: JsonField<ApiError> = JsonMissing.of()
        private var data: JsonField<LocateOrder>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(locateUpdateLocateRequestResponse: LocateUpdateLocateRequestResponse) =
            apply {
                metadata = locateUpdateLocateRequestResponse.metadata
                error = locateUpdateLocateRequestResponse.error
                data = locateUpdateLocateRequestResponse.data
                additionalProperties =
                    locateUpdateLocateRequestResponse.additionalProperties.toMutableMap()
            }
        ...
        /** Represents a single locate order and its status */
        fun data(data: LocateOrder) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [LocateOrder] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<LocateOrder>) = apply { this.data = data }
        ...
        /**
         * Returns an immutable instance of [LocateUpdateLocateRequestResponse].
         *
         ...
         */
        fun build(): LocateUpdateLocateRequestResponse =
            LocateUpdateLocateRequestResponse(
    ...
    fun validate(): LocateUpdateLocateRequestResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LocateUpdateLocateRequestResponse &&
    ...
    override fun toString() =
        "LocateUpdateLocateRequestResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
