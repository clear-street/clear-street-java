 ...
 */
class ExerciseGetExercisesParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ExerciseGetExercisesParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [ExerciseGetExercisesParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ExerciseGetExercisesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(exerciseGetExercisesParams: ExerciseGetExercisesParams) = apply {
            accountId = exerciseGetExercisesParams.accountId
            instrumentId = exerciseGetExercisesParams.instrumentId
            additionalHeaders = exerciseGetExercisesParams.additionalHeaders.toBuilder()
            additionalQueryParams = exerciseGetExercisesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ExerciseGetExercisesParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExerciseGetExercisesParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExerciseGetExercisesParams &&
    ...
    override fun toString() =
        "ExerciseGetExercisesParams{accountId=$accountId, instrumentId=$instrumentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
