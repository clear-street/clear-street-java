...
private constructor(
    ...
    /** A builder for [AccountGetPortfolioHistoryResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(accountGetPortfolioHistoryResponse: AccountGetPortfolioHistoryResponse) =
            apply {
                metadata = accountGetPortfolioHistoryResponse.metadata
                error = accountGetPortfolioHistoryResponse.error
                data = accountGetPortfolioHistoryResponse.data
                additionalProperties =
                    accountGetPortfolioHistoryResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AccountGetPortfolioHistoryResponse].
         *
         ...
         */
        fun build(): AccountGetPortfolioHistoryResponse =
            AccountGetPortfolioHistoryResponse(
     ...
     *   expected type.
     */
    fun validate(): AccountGetPortfolioHistoryResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountGetPortfolioHistoryResponse &&
    ...
    override fun toString() =
        "AccountGetPortfolioHistoryResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
