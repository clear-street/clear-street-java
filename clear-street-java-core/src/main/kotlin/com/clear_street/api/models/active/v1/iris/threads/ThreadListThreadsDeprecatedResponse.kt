...
class ThreadListThreadsDeprecatedResponse
...
private constructor(
    ...
    /** A builder for [ThreadListThreadsDeprecatedResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            threadListThreadsDeprecatedResponse: ThreadListThreadsDeprecatedResponse
        ) = apply {
            metadata = threadListThreadsDeprecatedResponse.metadata
            error = threadListThreadsDeprecatedResponse.error
            data = threadListThreadsDeprecatedResponse.data
            additionalProperties =
                threadListThreadsDeprecatedResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ThreadListThreadsDeprecatedResponse].
         *
         ...
         */
        fun build(): ThreadListThreadsDeprecatedResponse =
            ThreadListThreadsDeprecatedResponse(
    ...
    fun validate(): ThreadListThreadsDeprecatedResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadListThreadsDeprecatedResponse &&
    ...
    override fun toString() =
        "ThreadListThreadsDeprecatedResponse{metadata=$metadata, error=$error, data=$data, additionalProperties=$additionalProperties}"
}
