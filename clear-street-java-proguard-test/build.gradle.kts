...
dependencies {
    testImplementation(project(":clear-street-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../clear-street-java-core/src/main/resources/META-INF/proguard/clear-street-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.clear_street.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../clear-street-java-core/src/main/resources/META-INF/proguard/clear-street-java-core.pro",
