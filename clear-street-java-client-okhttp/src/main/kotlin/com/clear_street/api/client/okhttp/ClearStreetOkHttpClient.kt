...
/**
 * A class that allows building an instance of [ClearStreetClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class ClearStreetOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [ClearStreetClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): ClearStreetClient = builder().fromEnv().build()
    }

    /** A builder for [ClearStreetOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ClearStreetClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ClearStreetClient =
            ClearStreetClientImpl(
                clientOptions
                    .httpClient(
