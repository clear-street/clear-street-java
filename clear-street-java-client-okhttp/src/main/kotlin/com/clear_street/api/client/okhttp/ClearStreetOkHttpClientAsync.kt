...
/**
 * A class that allows building an instance of [ClearStreetClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class ClearStreetOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [ClearStreetClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): ClearStreetClientAsync = builder().fromEnv().build()
    }

    /** A builder for [ClearStreetOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [ClearStreetClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ClearStreetClientAsync =
            ClearStreetClientAsyncImpl(
                clientOptions
                    .httpClient(
